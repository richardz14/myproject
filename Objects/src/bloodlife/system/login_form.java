...
int[] _col = null;
 //BA.debugLineNum = 352;BA.debugLine="Public Sub all_settings_layout";
 //BA.debugLineNum = 353;BA.debugLine="Activity.SetBackgroundImage(LoadBitmap(File.DirAs";
mostCurrent._activity.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"bg.jpg").getObject()));
 //BA.debugLineNum = 354;BA.debugLine="ban_picture.SetBackgroundImage(LoadBitmap(File.Di";
...
mostCurrent._ban_tools.setTop((int) (mostCurrent._ban_panel.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))));
 //BA.debugLineNum = 397;BA.debugLine="ban_create.Top = ban_tools.Top + ban_tools.Heigh";
...
mostCurrent._label_forgot.setTop((int) (mostCurrent._text_password.getTop()+mostCurrent._text_password.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (3))));
 //BA.debugLineNum = 403;BA.debugLine="log_in_button.Top = label_forgot.Top + label_for";
mostCurrent._log_in_button.setTop((int) (mostCurrent._label_forgot.getTop()+mostCurrent._label_forgot.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (17))));
 //BA.debugLineNum = 404;BA.debugLine="Dim sums As Double";
_sums = 0;
 //BA.debugLineNum = 405;BA.debugLine="sums= ban_create.Height/2";
_sums = mostCurrent._ban_create.getHeight()/(double)2;
 //BA.debugLineNum = 406;BA.debugLine="new_acc_button.Top = sums - (sums/2)";
mostCurrent._new_acc_button.setTop((int) (_sums-(_sums/(double)2)));
 //BA.debugLineNum = 408;BA.debugLine="Dim left_sums,left As Double";
_left_sums = 0;
_left = 0;
 //BA.debugLineNum = 409;BA.debugLine="left_sums = (Activity.Width/2)";
_left_sums = (mostCurrent._activity.getWidth()/(double)2);
 //BA.debugLineNum = 410;BA.debugLine="left =  left_sums - (left_sums/2)";
_left = _left_sums-(_left_sums/(double)2);
 //BA.debugLineNum = 411;BA.debugLine="ban_panel.left = 0";
mostCurrent._ban_panel.setLeft((int) (0));
 //BA.debugLineNum = 412;BA.debugLine="ban_picture.left = ban_panel.left";
mostCurrent._ban_picture.setLeft(mostCurrent._ban_panel.getLeft());
 //BA.debugLineNum = 413;BA.debugLine="ban_create.left = 0";
mostCurrent._ban_create.setLeft((int) (0));
 //BA.debugLineNum = 414;BA.debugLine="ban_tools.left = 0";
mostCurrent._ban_tools.setLeft((int) (0));
 //BA.debugLineNum = 415;BA.debugLine="label_email.left = 5%x'left/2";
mostCurrent._label_email.setLeft(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA));
 //BA.debugLineNum = 416;BA.debugLine="label_password.left = 5%x'left/2";
mostCurrent._label_password.setLeft(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA));
 //BA.debugLineNum = 417;BA.debugLine="text_email.left =  label_email.left + label_emai";
mostCurrent._text_email.setLeft((int) (mostCurrent._label_email.getLeft()+mostCurrent._label_email.getWidth()));
 //BA.debugLineNum = 418;BA.debugLine="text_password.left = label_password.left + label";
mostCurrent._text_password.setLeft((int) (mostCurrent._label_password.getLeft()+mostCurrent._label_email.getWidth()));
 //BA.debugLineNum = 419;BA.debugLine="label_forgot.left = text_password.left '+ (text_";
mostCurrent._label_forgot.setLeft(mostCurrent._text_password.getLeft());
 //BA.debugLineNum = 420;BA.debugLine="log_in_button.left = 30%x 'text_password.left +";
mostCurrent._log_in_button.setLeft(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (30),mostCurrent.activityBA));
 //BA.debugLineNum = 421;BA.debugLine="new_acc_button.left = 18%x";
mostCurrent._new_acc_button.setLeft(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (18),mostCurrent.activityBA));
 //BA.debugLineNum = 423;BA.debugLine="Dim gradiant,log_grad As GradientDrawable";
...
_log_grad = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
 //BA.debugLineNum = 424;BA.debugLine="Dim col(2) As Int";
_col = new int[(int) (2)];
;
 //BA.debugLineNum = 425;BA.debugLine="col(0) = Colors.Red";
_col[(int) (0)] = anywheresoftware.b4a.keywords.Common.Colors.Red;
 //BA.debugLineNum = 426;BA.debugLine="col(1) = Colors.LightGray";
_col[(int) (1)] = anywheresoftware.b4a.keywords.Common.Colors.LightGray;
 //BA.debugLineNum = 427;BA.debugLine="gradiant.Initialize(\"TOP_BOTTOM\",col)";
_gradiant.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_col);
 //BA.debugLineNum = 428;BA.debugLine="log_grad.Initialize(\"TOP_BOTTOM\",col)";
_log_grad.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_col);
 //BA.debugLineNum = 429;BA.debugLine="gradiant.CornerRadius = 5dip";
_gradiant.setCornerRadius((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 430;BA.debugLine="log_grad.CornerRadius = 5dip";
_log_grad.setCornerRadius((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 432;BA.debugLine="new_acc_button.Background = gradiant";
mostCurrent._new_acc_button.setBackground((android.graphics.drawable.Drawable)(_gradiant.getObject()));
 //BA.debugLineNum = 433;BA.debugLine="log_in_button.Background = log_grad";
mostCurrent._log_in_button.setBackground((android.graphics.drawable.Drawable)(_log_grad.getObject()));
 //BA.debugLineNum = 434;BA.debugLine="log_in_button.Text = \"LOG IN\"";
mostCurrent._log_in_button.setText((Object)("LOG IN"));
 //BA.debugLineNum = 435;BA.debugLine="new_acc_button.Text = \"CREATE ACCOUNT\"";
mostCurrent._new_acc_button.setText((Object)("CREATE ACCOUNT"));
 //BA.debugLineNum = 436;BA.debugLine="End Sub";
return "";
}
public static String  _back_up_jobdone(bloodlife.system.httpjob _job) throws Exception{
int _dialogr = 0;
bloodlife.system.calculations _url_back = null;
String _forgot_string = "";
 //BA.debugLineNum = 221;BA.debugLine="Public Sub back_up_JobDone(job As HttpJob)";
 //BA.debugLineNum = 222;BA.debugLine="If job.Success Then";
if (_job._success) { 
 //BA.debugLineNum = 223;BA.debugLine="Select job.JobName";
...
case 0: {
 //BA.debugLineNum = 226;BA.debugLine="Email = job.GetString.Trim";
mostCurrent._email = _job._getstring().trim();
 break; }
case 1: {
 //BA.debugLineNum = 229;BA.debugLine="pass = job.GetString.Trim";
mostCurrent._pass = _job._getstring().trim();
 break; }
case 2: {
 //BA.debugLineNum = 232;BA.debugLine="name_query = job.GetString.Trim";
_name_query = _job._getstring().trim();
 //BA.debugLineNum = 233;BA.debugLine="name = job.GetString.Trim";
mostCurrent._name = _job._getstring().trim();
 break; }
case 3: {
 //BA.debugLineNum = 236;BA.debugLine="id_query = job.GetString.Trim";
_id_query = _job._getstring().trim();
 break; }
case 4: {
 //BA.debugLineNum = 241;BA.debugLine="calcs.name = job.GetString.Trim";
mostCurrent._calcs._name = _job._getstring().trim();
 break; }
case 5: {
 //BA.debugLineNum = 243;BA.debugLine="email_for = job.GetString.Trim";
mostCurrent._email_for = _job._getstring().trim();
 break; }
case 6: {
 //BA.debugLineNum = 245;BA.debugLine="nickName_for = job.GetString.Trim";
mostCurrent._nickname_for = _job._getstring().trim();
 break; }
}
;
 //BA.debugLineNum = 248;BA.debugLine="booleanforgotcount = booleanforgotcount + 1";
_booleanforgotcount = (int) (_booleanforgotcount+1);
 //BA.debugLineNum = 249;BA.debugLine="booleanCount = booleanCount+1";
_booleancount = (int) (_booleancount+1);
 //BA.debugLineNum = 251;BA.debugLine="If log_click == True Then";
if (_log_click==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 252;BA.debugLine="If booleanCount = 4 Then '''''''' 1st statement";
if (_booleancount==4) { 
 //BA.debugLineNum = 253;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 254;BA.debugLine="If text_email.Text == \"\" Or text_password.Text";
if ((mostCurrent._text_email.getText()).equals("") || (mostCurrent._text_password.getText()).equals("")) { 
 //BA.debugLineNum = 255;BA.debugLine="Msgbox(\"Error empty field.!\",\"C O N F I R M";
anywheresoftware.b4a.keywords.Common.Msgbox("Error empty field.!","C O N F I R M A T I O N",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 257;BA.debugLine="If text_email.Text.CompareTo(Email) == 0 And t";
if (mostCurrent._text_email.getText().compareTo(mostCurrent._email)==0 && mostCurrent._text_password.getText().compareTo(mostCurrent._pass)==0) { 
 //BA.debugLineNum = 261;BA.debugLine="Dim dialogR As Int";
_dialogr = 0;
 //BA.debugLineNum = 262;BA.debugLine="dialogR = Msgbox2(\"Welcome \"&name,\"C O N F I";
_dialogr = anywheresoftware.b4a.keywords.Common.Msgbox2("Welcome "+mostCurrent._name,"C O N F I R M A T I O N","OK","","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA);
 //BA.debugLineNum = 263;BA.debugLine="booleanCount = 0";
_booleancount = (int) (0);
 //BA.debugLineNum = 264;BA.debugLine="If  dialogR == DialogResponse.POSITIVE Then";
if (_dialogr==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 265;BA.debugLine="text_password.Text = \"\"";
mostCurrent._text_password.setText((Object)(""));
 //BA.debugLineNum = 266;BA.debugLine="text_email.text = \"\"";
mostCurrent._text_email.setText((Object)(""));
 //BA.debugLineNum = 267;BA.debugLine="is_log_in = True";
_is_log_in = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 268;BA.debugLine="StartActivity(\"menu_form\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("menu_form"));
 }else {
 };
 }else {
 //BA.debugLineNum = 272;BA.debugLine="Msgbox(\"Error email address or password.!\",\"";
anywheresoftware.b4a.keywords.Common.Msgbox("Error email address or password.!","C O N F I R M A T I O N",mostCurrent.activityBA);
 //BA.debugLineNum = 273;BA.debugLine="text_password.Text = \"\"";
mostCurrent._text_password.setText((Object)(""));
 //BA.debugLineNum = 274;BA.debugLine="booleanCount = 0";
_booleancount = (int) (0);
 };
 };
 }else {
 ...
 //BA.debugLineNum = 283;BA.debugLine="If log_click == False Then";
if (_log_click==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 284;BA.debugLine="If booleanforgotcount == 1 Then";
if (_booleanforgotcount==1) { 
 //BA.debugLineNum = 285;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 286;BA.debugLine="If email_for.CompareTo(email_forgot.Text) == 0";
if (mostCurrent._email_for.compareTo(mostCurrent._email_forgot.getText())==0 && mostCurrent._nickname_for.compareTo(mostCurrent._nickn_forgot.getText())==0) { 
 //BA.debugLineNum = 288;BA.debugLine="Dim url_back As calculations";
_url_back = new bloodlife.system.calculations();
 //BA.debugLineNum = 289;BA.debugLine="Dim forgot_string As String";
_forgot_string = "";
 //BA.debugLineNum = 290;BA.debugLine="url_back.Initialize";
_url_back._initialize(processBA);
 //BA.debugLineNum = 291;BA.debugLine="forgot_string = url_back.php_email_url(\"forgot";
_forgot_string = _url_back._php_email_url("forgot_pass.php");
 //BA.debugLineNum = 292;BA.debugLine="forgot_recover_job.Download2(forgot_string,Arr";
mostCurrent._forgot_recover_job._download2(_forgot_string,new String[]{"recover","UPDATE `person_info` SET `password`=ENCODE('"+mostCurrent._newpass.getText()+"','goroy') WHERE  `email`='"+mostCurrent._email_for+"' and `nick_name`='"+mostCurrent._nickname_for+"';"});
 //BA.debugLineNum = 293;BA.debugLine="ToastMessageShow(\"Successfully Recovered Accou";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Successfully Recovered Account!",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 294;BA.debugLine="forgot_pass_pnl.RemoveView";
mostCurrent._forgot_pass_pnl.RemoveView();
 }else {
 //BA.debugLineNum = 296;BA.debugLine="Msgbox(\"Error: Information not existed!\",\"C O N";
anywheresoftware.b4a.keywords.Common.Msgbox("Error: Information not existed!","C O N F I R M A T I O N",mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 302;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 303;BA.debugLine="If booleanCount = 4 And booleanforgotcount = 1 T";
if (_booleancount==4 && _booleanforgotcount==1) { 
 //BA.debugLineNum = 304;BA.debugLine="Msgbox(\"Error: Error connecting to server, try a";
anywheresoftware.b4a.keywords.Common.Msgbox("Error: Error connecting to server, try again later.!","C O N F I R M A T I O N",mostCurrent.activityBA);
 //BA.debugLineNum = 305;BA.debugLine="booleanCount = 0";
_booleancount = (int) (0);
 //BA.debugLineNum = 306;BA.debugLine="booleanforgotcount = 0";
_booleanforgotcount = (int) (0);
 }else {
 //BA.debugLineNum = 308;BA.debugLine="booleanCount = 4";
_booleancount = (int) (4);
 //BA.debugLineNum = 309;BA.debugLine="booleanforgotcount = 1";
...
public static String  _forgot_can_btn_click() throws Exception{
 //BA.debugLineNum = 523;BA.debugLine="Sub forgot_can_btn_click";
 //BA.debugLineNum = 524;BA.debugLine="forgot_pass_pnl.RemoveView";
mostCurrent._forgot_pass_pnl.RemoveView();
 //BA.debugLineNum = 525;BA.debugLine="End Sub";
return "";
}
public static String  _forgot_pass_pnl_click() throws Exception{
 //BA.debugLineNum = 526;BA.debugLine="Sub forgot_pass_pnl_click";
...
String _url_email = "";
String _nickname = "";
 //BA.debugLineNum = 442;BA.debugLine="Sub forgot_recover_btn_click";
 //BA.debugLineNum = 443;BA.debugLine="booleanforgotcount = 0";
_booleanforgotcount = (int) (0);
 //BA.debugLineNum = 444;BA.debugLine="nickName_for = \"\"";
mostCurrent._nickname_for = "";
 //BA.debugLineNum = 445;BA.debugLine="email_for = \"\"";
mostCurrent._email_for = "";
 //BA.debugLineNum = 446;BA.debugLine="If email_forgot.Text == \"\" Or nickN_forgot.Text =";
if ((mostCurrent._email_forgot.getText()).equals("") || (mostCurrent._nickn_forgot.getText()).equals("") || (mostCurrent._newpass.getText()).equals("") || (mostCurrent._renewpass.getText()).equals("")) { 
 //BA.debugLineNum = 447;BA.debugLine="Msgbox(\"Error: Empty fields. Needed to fill all";
anywheresoftware.b4a.keywords.Common.Msgbox("Error: Empty fields. Needed to fill all required fields to recover your account!","C O N F I R M A T I O N",mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 449;BA.debugLine="If newPass.Text.Length <= 5 Then";
if (mostCurrent._newpass.getText().length()<=5) { 
 //BA.debugLineNum = 450;BA.debugLine="Msgbox(\"Error: Password lenght must be 6 letter";
anywheresoftware.b4a.keywords.Common.Msgbox("Error: Password lenght must be 6 letter and above!","C O N F I R M A T I O N",mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 452;BA.debugLine="Msgbox(\"Error: Password did not match!\",\"C O N F";
anywheresoftware.b4a.keywords.Common.Msgbox("Error: Password did not match!","C O N F I R M A T I O N",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 454;BA.debugLine="ProgressDialogShow2(\"please wait...\",False)";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow2(mostCurrent.activityBA,"please wait...",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 455;BA.debugLine="log_click = False";
_log_click = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 456;BA.debugLine="Dim url_back As calculations";
_url_back = new bloodlife.system.calculations();
 //BA.debugLineNum = 457;BA.debugLine="Dim url_email,nickname As String";
_url_email = "";
_nickname = "";
 //BA.debugLineNum = 458;BA.debugLine="url_back.Initialize";
_url_back._initialize(processBA);
 //BA.debugLineNum = 459;BA.debugLine="url_email = url_back.php_email_url(\"index.php\")";
_url_email = _url_back._php_email_url("index.php");
 //BA.debugLineNum = 460;BA.debugLine="nickname = url_back.php_email_url(\"search_blood";
_nickname = _url_back._php_email_url("search_blood_nickN.php");
 //BA.debugLineNum = 461;BA.debugLine="forgot_email_job.Download2(url_email,Array As S";
mostCurrent._forgot_email_job._download2(_url_email,new String[]{"email","SELECT * FROM `person_info` where `email`='"+mostCurrent._email_forgot.getText()+"';","email_class","recover"});
 //BA.debugLineNum = 462;BA.debugLine="forgot_nick_job.Download2(nickname,Array As Str";
...
mostCurrent._calcs._name = _job._getstring().trim();
 break; }
case 5: {
 //BA.debugLineNum = 143;BA.debugLine="email_for = job.GetString.Trim";
mostCurrent._email_for = _job._getstring().trim();
 break; }
case 6: {
 //BA.debugLineNum = 146;BA.debugLine="nickName_for = job.GetString.Trim";
mostCurrent._nickname_for = _job._getstring().trim();
 break; }
}
;
 //BA.debugLineNum = 149;BA.debugLine="booleanforgotcount = booleanforgotcount + 1";
_booleanforgotcount = (int) (_booleanforgotcount+1);
 //BA.debugLineNum = 150;BA.debugLine="booleanCount = booleanCount+1";
_booleancount = (int) (_booleancount+1);
 //BA.debugLineNum = 152;BA.debugLine="If log_click == True Then";
if (_log_click==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 153;BA.debugLine="If booleanCount = 4 Then '''''''' 1st statement";
if (_booleancount==4) { 
 //BA.debugLineNum = 154;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 155;BA.debugLine="If text_email.Text == \"\" Or text_password.Text";
if ((mostCurrent._text_email.getText()).equals("") || (mostCurrent._text_password.getText()).equals("")) { 
 //BA.debugLineNum = 156;BA.debugLine="Msgbox(\"Error empty field.!\",\"C O N F I R M";
anywheresoftware.b4a.keywords.Common.Msgbox("Error empty field.!","C O N F I R M A T I O N",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 158;BA.debugLine="If text_email.Text.CompareTo(Email) == 0 And t";
if (mostCurrent._text_email.getText().compareTo(mostCurrent._email)==0 && mostCurrent._text_password.getText().compareTo(mostCurrent._pass)==0) { 
 //BA.debugLineNum = 162;BA.debugLine="Dim dialogR As Int";
_dialogr = 0;
 //BA.debugLineNum = 163;BA.debugLine="dialogR = Msgbox2(\"Welcome \"&name,\"C O N F I";
_dialogr = anywheresoftware.b4a.keywords.Common.Msgbox2("Welcome "+mostCurrent._name,"C O N F I R M A T I O N","OK","","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA);
 //BA.debugLineNum = 164;BA.debugLine="booleanCount = 0";
_booleancount = (int) (0);
 //BA.debugLineNum = 165;BA.debugLine="If  dialogR == DialogResponse.POSITIVE Then";
if (_dialogr==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 166;BA.debugLine="text_password.Text = \"\"";
mostCurrent._text_password.setText((Object)(""));
 //BA.debugLineNum = 167;BA.debugLine="text_email.text = \"\"";
mostCurrent._text_email.setText((Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="is_log_in = True";
_is_log_in = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 169;BA.debugLine="StartActivity(\"menu_form\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("menu_form"));
 }else {
 };
 }else {
 //BA.debugLineNum = 173;BA.debugLine="Msgbox(\"Error email address or password.!\",\"";
anywheresoftware.b4a.keywords.Common.Msgbox("Error email address or password.!","C O N F I R M A T I O N",mostCurrent.activityBA);
 //BA.debugLineNum = 174;BA.debugLine="text_password.Text = \"\"";
mostCurrent._text_password.setText((Object)(""));
 //BA.debugLineNum = 175;BA.debugLine="booleanCount = 0";
_booleancount = (int) (0);
 };
 };
 }else {
 ...
 //BA.debugLineNum = 184;BA.debugLine="If log_click == False Then";
if (_log_click==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 185;BA.debugLine="If booleanforgotcount == 2 Then";
if (_booleanforgotcount==2) { 
 //BA.debugLineNum = 186;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 187;BA.debugLine="If email_for.CompareTo(email_forgot.Text.Trim)";
if (mostCurrent._email_for.compareTo(mostCurrent._email_forgot.getText().trim())==0 && mostCurrent._nickname_for.compareTo(mostCurrent._nickn_forgot.getText().trim())==0) { 
 //BA.debugLineNum = 189;BA.debugLine="Dim url_back As calculations";
_url_back = new bloodlife.system.calculations();
 //BA.debugLineNum = 190;BA.debugLine="Dim forgot_string As String";
_forgot_string = "";
 //BA.debugLineNum = 191;BA.debugLine="url_back.Initialize";
_url_back._initialize(processBA);
 //BA.debugLineNum = 192;BA.debugLine="forgot_string = url_back.php_email_url(\"forgot";
_forgot_string = _url_back._php_email_url("forgot_pass.php");
 //BA.debugLineNum = 193;BA.debugLine="forgot_recover_job.Download2(forgot_string,Arr";
mostCurrent._forgot_recover_job._download2(_forgot_string,new String[]{"recover","UPDATE `person_info` SET `password`=ENCODE('"+mostCurrent._newpass.getText()+"','goroy') WHERE  `email`='"+mostCurrent._email_for+"' and `nick_name`='"+mostCurrent._nickname_for+"';"});
 //BA.debugLineNum = 194;BA.debugLine="ToastMessageShow(\"Successfully Recovered Accou";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Successfully Recovered Account!",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 195;BA.debugLine="forgot_pass_pnl.RemoveView";
mostCurrent._forgot_pass_pnl.RemoveView();
 }else {
 //BA.debugLineNum = 197;BA.debugLine="Msgbox(\"Error: Information not existed!\",\"C O N";
anywheresoftware.b4a.keywords.Common.Msgbox("Error: Information not existed!","C O N F I R M A T I O N",mostCurrent.activityBA);
 };
 };
 };
...
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 204;BA.debugLine="If booleanCount = 4 And booleanforgotcount = 1 T";
if (_booleancount==4 && _booleanforgotcount==1) { 
 //BA.debugLineNum = 205;BA.debugLine="Msgbox(\"Error: Error connecting to server, try a";
anywheresoftware.b4a.keywords.Common.Msgbox("Error: Error connecting to server, try again later.!","C O N F I R M A T I O N",mostCurrent.activityBA);
 //BA.debugLineNum = 206;BA.debugLine="booleanCount = 0";
_booleancount = (int) (0);
 //BA.debugLineNum = 207;BA.debugLine="booleanforgotcount = 0";
_booleanforgotcount = (int) (0);
 }else {
 //BA.debugLineNum = 209;BA.debugLine="booleanCount = 4";
_booleancount = (int) (4);
 //BA.debugLineNum = 210;BA.debugLine="booleanforgotcount = 1";
_booleanforgotcount = (int) (1);
 };
 };
...
int[] _colorg = null;
 //BA.debugLineNum = 467;BA.debugLine="Sub label_forgot_Click";
 //BA.debugLineNum = 469;BA.debugLine="a3.Start(label_forgot)";
mostCurrent._a3.Start((android.view.View)(mostCurrent._label_forgot.getObject()));
 //BA.debugLineNum = 470;BA.debugLine="Dim pnl As Panel";
_pnl = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 471;BA.debugLine="Dim edit_ok_btn,edit_can_btn As Button";
_edit_ok_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
_edit_can_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 472;BA.debugLine="Dim title_lbl As Label";
_title_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 473;BA.debugLine="title_lbl.Initialize(\"\")";
_title_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 474;BA.debugLine="edit_ok_btn.Initialize(\"forgot_recover_btn\")";
_edit_ok_btn.Initialize(mostCurrent.activityBA,"forgot_recover_btn");
 //BA.debugLineNum = 475;BA.debugLine="edit_can_btn.Initialize(\"forgot_can_btn\")";
_edit_can_btn.Initialize(mostCurrent.activityBA,"forgot_can_btn");
 //BA.debugLineNum = 476;BA.debugLine="Dim V_btn,C_btn As GradientDrawable";
...
_pnl.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"modal_bg.png").getObject()));
 //BA.debugLineNum = 494;BA.debugLine="title_lbl.Text = \"RECOVERING ACCOUNT\"";
_title_lbl.setText((Object)("RECOVERING ACCOUNT"));
 //BA.debugLineNum = 495;BA.debugLine="title_lbl.Typeface = Typeface.LoadFromAssets(\"Hip";
_title_lbl.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("HipHopDemi.ttf"));
 //BA.debugLineNum = 496;BA.debugLine="title_lbl.Gravity = Gravity.CENTER";
_title_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 498;BA.debugLine="email_forgot.Initialize(\"\")";
mostCurrent._email_forgot.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 499;BA.debugLine="nickN_forgot.Initialize(\"\")";
mostCurrent._nickn_forgot.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 500;BA.debugLine="newPass.Initialize(\"\")";
mostCurrent._newpass.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 501;BA.debugLine="renewPass.Initialize(\"\")";
mostCurrent._renewpass.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 502;BA.debugLine="email_forgot.Hint = \"Enter your Email Address\"";
mostCurrent._email_forgot.setHint("Enter your Email Address");
 //BA.debugLineNum = 503;BA.debugLine="nickN_forgot.Hint = \"Enter your Nick Name\"";
mostCurrent._nickn_forgot.setHint("Enter your Nick Name");
 //BA.debugLineNum = 504;BA.debugLine="newPass.Hint = \"Enter your New Password\"";
mostCurrent._newpass.setHint("Enter your New Password");
 //BA.debugLineNum = 505;BA.debugLine="renewPass.Hint = \"Retype New Password\"";
mostCurrent._renewpass.setHint("Retype New Password");
 //BA.debugLineNum = 506;BA.debugLine="newPass.PasswordMode = True";
mostCurrent._newpass.setPasswordMode(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 507;BA.debugLine="renewPass.PasswordMode = True";
mostCurrent._renewpass.setPasswordMode(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 508;BA.debugLine="pnl.AddView(title_lbl,2%x,2%y,68%x,8%y)";
_pnl.AddView((android.view.View)(_title_lbl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 509;BA.debugLine="pnl.AddView(email_forgot,2%x,title_lbl.Top + titl";
_pnl.AddView((android.view.View)(mostCurrent._email_forgot.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),(int) (_title_lbl.getTop()+_title_lbl.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA));
 //BA.debugLineNum = 510;BA.debugLine="pnl.AddView(nickN_forgot,2%x,email_forgot.Top + e";
_pnl.AddView((android.view.View)(mostCurrent._nickn_forgot.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),(int) (mostCurrent._email_forgot.getTop()+mostCurrent._email_forgot.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA));
 //BA.debugLineNum = 511;BA.debugLine="pnl.AddView(newPass,2%x,nickN_forgot.Top + nickN_";
_pnl.AddView((android.view.View)(mostCurrent._newpass.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),(int) (mostCurrent._nickn_forgot.getTop()+mostCurrent._nickn_forgot.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA));
 //BA.debugLineNum = 512;BA.debugLine="pnl.AddView(renewPass,2%x,newPass.Top + newPass.H";
_pnl.AddView((android.view.View)(mostCurrent._renewpass.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),(int) (mostCurrent._newpass.getTop()+mostCurrent._newpass.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA));
 //BA.debugLineNum = 514;BA.debugLine="pnl.AddView(edit_ok_btn,8%x,renewPass.Top+renewPa";
_pnl.AddView((android.view.View)(_edit_ok_btn.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (8),mostCurrent.activityBA),(int) (mostCurrent._renewpass.getTop()+mostCurrent._renewpass.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (28),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 515;BA.debugLine="pnl.AddView(edit_can_btn,edit_ok_btn.Left+edit_ok";
_pnl.AddView((android.view.View)(_edit_can_btn.getObject()),(int) (_edit_ok_btn.getLeft()+_edit_ok_btn.getWidth()+anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA)),(int) (mostCurrent._renewpass.getTop()+mostCurrent._renewpass.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (28),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 517;BA.debugLine="forgot_pass_pnl.AddView(pnl,13%x,(((Activity.Heig";
mostCurrent._forgot_pass_pnl.AddView((android.view.View)(_pnl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (13),mostCurrent.activityBA),(int) ((((mostCurrent._activity.getHeight()/(double)2)/(double)2)/(double)2)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (74),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (58),mostCurrent.activityBA));
 //BA.debugLineNum = 518;BA.debugLine="forgot_pass_pnl.BringToFront";
mostCurrent._forgot_pass_pnl.BringToFront();
 //BA.debugLineNum = 521;BA.debugLine="Activity.AddView(forgot_pass_pnl,0,0,100%x,100%y)";
...
String _id = "";
String _nickname = "";
 //BA.debugLineNum = 320;BA.debugLine="Sub log_in_button_click";
 //BA.debugLineNum = 321;BA.debugLine="a1.Start(log_in_button)";
mostCurrent._a1.Start((android.view.View)(mostCurrent._log_in_button.getObject()));
 //BA.debugLineNum = 322;BA.debugLine="ProgressDialogShow2(\"please wait...\",False)";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow2(mostCurrent.activityBA,"please wait...",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 323;BA.debugLine="Email = \"\"";
mostCurrent._email = "";
 //BA.debugLineNum = 324;BA.debugLine="pass = \"\"";
mostCurrent._pass = "";
 //BA.debugLineNum = 325;BA.debugLine="log_click = True";
_log_click = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 326;BA.debugLine="booleanCount = 0";
_booleancount = (int) (0);
 //BA.debugLineNum = 327;BA.debugLine="Dim url_back As calculations";
_url_back = new bloodlife.system.calculations();
 //BA.debugLineNum = 328;BA.debugLine="Dim url_email,url_pass,full_name,id,nickname As S";
_url_email = "";
_url_pass = "";
_full_name = "";
_id = "";
...
_url_back._initialize(processBA);
 //BA.debugLineNum = 330;BA.debugLine="url_email = url_back.php_email_url(\"index.php\")";
_url_email = _url_back._php_email_url("index.php");
 //BA.debugLineNum = 331;BA.debugLine="url_pass = url_back.php_email_url(\"index1.php\")";
_url_pass = _url_back._php_email_url("index1.php");
 //BA.debugLineNum = 332;BA.debugLine="full_name = url_back.php_email_url(\"search_blood_";
_full_name = _url_back._php_email_url("search_blood_fullN.php");
 //BA.debugLineNum = 333;BA.debugLine="id = url_back.php_email_url(\"search_blood_id.php\"";
_id = _url_back._php_email_url("search_blood_id.php");
 //BA.debugLineNum = 334;BA.debugLine="nickname = url_back.php_email_url(\"search_blood_n";
_nickname = _url_back._php_email_url("search_blood_nickN.php");
 //BA.debugLineNum = 336;BA.debugLine="h_fullname.Download2(full_name,Array As String(\"f";
mostCurrent._h_fullname._download2(_full_name,new String[]{"full_name","SELECT full_name FROM `person_info` where `email`='"+mostCurrent._text_email.getText()+"';"});
 //BA.debugLineNum = 337;BA.debugLine="user_id.Download2(id,Array As String(\"id\",\"SELECT";
mostCurrent._user_id._download2(_id,new String[]{"id","SELECT id FROM `person_info` where `email`='"+mostCurrent._text_email.getText()+"';"});
 //BA.debugLineNum = 340;BA.debugLine="h_email.Download2(url_email,Array As String(\"emai";
mostCurrent._h_email._download2(_url_email,new String[]{"email","SELECT * FROM `person_info` where `email`='"+mostCurrent._text_email.getText()+"';","email_class","login"});
 //BA.debugLineNum = 341;BA.debugLine="h_pass.Download2(url_pass,Array As String(\"pass\",";
...
public static String  _new_acc_button_click() throws Exception{
 //BA.debugLineNum = 438;BA.debugLine="Sub new_acc_button_Click";
 //BA.debugLineNum = 439;BA.debugLine="a2.Start(new_acc_button)";
mostCurrent._a2.Start((android.view.View)(mostCurrent._new_acc_button.getObject()));
 //BA.debugLineNum = 440;BA.debugLine="StartActivity (\"create_account\")";
