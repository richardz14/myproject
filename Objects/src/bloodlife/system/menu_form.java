...
String _s_string = "";
int _string_h = 0;
 //BA.debugLineNum = 1941;BA.debugLine="Sub about_Click";
 //BA.debugLineNum = 1942;BA.debugLine="panel_click_ = 2";
_panel_click_ = (int) (2);
 //BA.debugLineNum = 1943;BA.debugLine="Dim pnl As Panel";
_pnl = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 1944;BA.debugLine="Dim about_ok_btn As Button";
_about_ok_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 1945;BA.debugLine="Dim title_lbl,about_data,for_h As Label";
...
_for_h = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 1947;BA.debugLine="for_h.Initialize(\"\")";
_for_h.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1948;BA.debugLine="Dim sus As StringUtils";
_sus = new anywheresoftware.b4a.objects.StringUtils();
 //BA.debugLineNum = 1953;BA.debugLine="about_us_pnl.Initialize(\"about_us_pnl\")";
mostCurrent._about_us_pnl.Initialize(mostCurrent.activityBA,"about_us_pnl");
 //BA.debugLineNum = 1954;BA.debugLine="about_ok_btn.Initialize(\"about_ok_btn\")";
_about_ok_btn.Initialize(mostCurrent.activityBA,"about_ok_btn");
 //BA.debugLineNum = 1955;BA.debugLine="title_lbl.Initialize(\"\")";
_title_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1956;BA.debugLine="about_data.Initialize(\"\")";
_about_data.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1957;BA.debugLine="about_ok_btn.Text = \"OK\"";
_about_ok_btn.setText((Object)("OK"));
 //BA.debugLineNum = 1958;BA.debugLine="Dim V_btn,C_btn As GradientDrawable";
...
_c_btn = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
 //BA.debugLineNum = 1959;BA.debugLine="Dim colorG(2) As Int";
_colorg = new int[(int) (2)];
;
 //BA.debugLineNum = 1960;BA.debugLine="colorG(0) = Colors.White";
_colorg[(int) (0)] = anywheresoftware.b4a.keywords.Common.Colors.White;
 //BA.debugLineNum = 1961;BA.debugLine="colorG(1) = Colors.Red";
_colorg[(int) (1)] = anywheresoftware.b4a.keywords.Common.Colors.Red;
 //BA.debugLineNum = 1962;BA.debugLine="C_btn.Initialize(\"TOP_BOTTOM\",colorG)";
_c_btn.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colorg);
 //BA.debugLineNum = 1963;BA.debugLine="V_btn.Initialize(\"TOP_BOTTOM\",colorG)";
_v_btn.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colorg);
 //BA.debugLineNum = 1964;BA.debugLine="V_btn.CornerRadius = 50dip";
_v_btn.setCornerRadius((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 1965;BA.debugLine="about_ok_btn.Background = V_btn";
_about_ok_btn.setBackground((android.graphics.drawable.Drawable)(_v_btn.getObject()));
 //BA.debugLineNum = 1966;BA.debugLine="title_lbl.Text = \"ABOUT\"";
_title_lbl.setText((Object)("ABOUT"));
 //BA.debugLineNum = 1967;BA.debugLine="title_lbl.TextSize = 25";
_title_lbl.setTextSize((float) (25));
 //BA.debugLineNum = 1968;BA.debugLine="title_lbl.Typeface = Typeface.DEFAULT_BOLD";
_title_lbl.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD);
 //BA.debugLineNum = 1969;BA.debugLine="title_lbl.Background = C_btn";
_title_lbl.setBackground((android.graphics.drawable.Drawable)(_c_btn.getObject()));
 //BA.debugLineNum = 1970;BA.debugLine="title_lbl.TextColor = Colors.Black";
_title_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 1972;BA.debugLine="Dim rs As RichString";
_rs = new anywheresoftware.b4a.agraham.richstring.RichStringBuilder.RichString();
 //BA.debugLineNum = 1973;BA.debugLine="Dim f_string,s_string As String";
_f_string = "";
_s_string = "";
 //BA.debugLineNum = 1974;BA.debugLine="f_string = CRLF&\"•	{ib}{bg1}Becgrajhon2013{bg1}{i";
_f_string = anywheresoftware.b4a.keywords.Common.CRLF+"•	{ib}{bg1}Becgrajhon2013{bg1}{ib} was the developer and designer of the LIFEBLOOD WITH GIS mobile app. It was started when the developer saw the posted in NONESCOST IT building that there was a boy that need a certain blood to help cure his illness.";
 //BA.debugLineNum = 1975;BA.debugLine="s_string = CRLF&CRLF&\"•	{iib}{bg2}Philippines{bg2";
_s_string = anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+"•	{iib}{bg2}Philippines{bg2}{iib} is facing a blood shortage and even Himamaylan City. People not only have to run from their respective place to other barangay or other city as well because they need some donor, they will be go to Bacolod City to process the blood donation procedure of the government. This LIFEBLOOD WITH GIS will help the NOT only in people of HIMAMAYLAN CITY but in other neighboring municipalities and cities in finding blood donors.";
 //BA.debugLineNum = 1976;BA.debugLine="rs.Initialize(f_string&s_string)";
_rs.Initialize((java.lang.CharSequence)(_f_string+_s_string));
 //BA.debugLineNum = 1977;BA.debugLine="rs.Style2(rs.STYLE_BOLD_ITALIC, \"{ib}\")";
_rs.Style2(_rs.STYLE_BOLD_ITALIC,"{ib}");
 //BA.debugLineNum = 1978;BA.debugLine="rs.Style2(rs.STYLE_BOLD_ITALIC, \"{iib}\")";
_rs.Style2(_rs.STYLE_BOLD_ITALIC,"{iib}");
 //BA.debugLineNum = 1979;BA.debugLine="rs.BackColor2(Colors.DarkGray,\"{bg1}\")";
_rs.BackColor2(anywheresoftware.b4a.keywords.Common.Colors.DarkGray,"{bg1}");
 //BA.debugLineNum = 1980;BA.debugLine="rs.BackColor2(Colors.DarkGray,\"{bg2}\")";
_rs.BackColor2(anywheresoftware.b4a.keywords.Common.Colors.DarkGray,"{bg2}");
 //BA.debugLineNum = 1981;BA.debugLine="about_data.Text = rs '' to set the string output";
_about_data.setText((Object)(_rs.getObject()));
 //BA.debugLineNum = 1982;BA.debugLine="about_data.TextSize = 17";
_about_data.setTextSize((float) (17));
 //BA.debugLineNum = 1983;BA.debugLine="for_h.Text = rs";
_for_h.setText((Object)(_rs.getObject()));
 //BA.debugLineNum = 1984;BA.debugLine="about_us_pnl.AddView(for_h,0,0,50%x,50%y)";
mostCurrent._about_us_pnl.AddView((android.view.View)(_for_h.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (50),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (50),mostCurrent.activityBA));
 //BA.debugLineNum = 1985;BA.debugLine="for_h.Visible = False";
_for_h.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1986;BA.debugLine="Dim string_h As Int : string_h= sus.MeasureMulti";
_string_h = 0;
 //BA.debugLineNum = 1986;BA.debugLine="Dim string_h As Int : string_h= sus.MeasureMulti";
_string_h = _sus.MeasureMultilineTextHeight((android.widget.TextView)(_for_h.getObject()),_for_h.getText());
 //BA.debugLineNum = 1988;BA.debugLine="about_sc2d.Initialize(68%x,string_h+7%Y,\"about_";
mostCurrent._about_sc2d.Initialize(mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),(int) (_string_h+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA)),"about_sc2d");
 //BA.debugLineNum = 1989;BA.debugLine="about_sc2d.ScrollbarsVisibility(False,False)";
mostCurrent._about_sc2d.ScrollbarsVisibility(anywheresoftware.b4a.keywords.Common.False,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1990;BA.debugLine="title_lbl.Gravity = Gravity.CENTER";
_title_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 1991;BA.debugLine="pnl.Initialize(\"pnl\")";
_pnl.Initialize(mostCurrent.activityBA,"pnl");
 //BA.debugLineNum = 1992;BA.debugLine="about_us_pnl.Color = Colors.Transparent";
mostCurrent._about_us_pnl.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 1993;BA.debugLine="pnl.SetBackgroundImage(LoadBitmap(File.DirAssets,";
_pnl.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"modal_bg.png").getObject()));
 //BA.debugLineNum = 1994;BA.debugLine="pnl.AddView(title_lbl,2%x,2%y,68%x,8%y)";
_pnl.AddView((android.view.View)(_title_lbl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 1996;BA.debugLine="about_sc2d.Panel.AddView(about_data,0,0,69%x,stri";
mostCurrent._about_sc2d.getPanel().AddView((android.view.View)(_about_data.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (69),mostCurrent.activityBA),(int) (_string_h+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA)));
 //BA.debugLineNum = 1997;BA.debugLine="pnl.AddView(about_sc2d,2%x,title_lbl.Top + title_";
_pnl.AddView((android.view.View)(mostCurrent._about_sc2d.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),(int) (_title_lbl.getTop()+_title_lbl.getHeight()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (70),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (60),mostCurrent.activityBA));
 //BA.debugLineNum = 1998;BA.debugLine="pnl.AddView(about_ok_btn,3%x,about_sc2d.Top + abo";
_pnl.AddView((android.view.View)(_about_ok_btn.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (3),mostCurrent.activityBA),(int) (mostCurrent._about_sc2d.getTop()+mostCurrent._about_sc2d.getHeight()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 2000;BA.debugLine="about_us_pnl.AddView(pnl,13%x,((((Activity.Height";
mostCurrent._about_us_pnl.AddView((android.view.View)(_pnl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (13),mostCurrent.activityBA),(int) (((((mostCurrent._activity.getHeight()/(double)2)/(double)2)/(double)2)/(double)2)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (74),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (80),mostCurrent.activityBA));
 //BA.debugLineNum = 2001;BA.debugLine="about_us_pnl.BringToFront";
mostCurrent._about_us_pnl.BringToFront();
 //BA.debugLineNum = 2005;BA.debugLine="Activity.AddView(about_us_pnl,0,0,100%x,100%y)";
...
public static String  _about_ok_btn_click() throws Exception{
 //BA.debugLineNum = 2007;BA.debugLine="Sub about_ok_btn_click";
 //BA.debugLineNum = 2008;BA.debugLine="about_us_pnl.RemoveView";
...
public static String  _about_us_pnl_click() throws Exception{
 //BA.debugLineNum = 2010;BA.debugLine="Sub about_us_pnl_click";
...
public static String  _all_inputs_click() throws Exception{
 //BA.debugLineNum = 1181;BA.debugLine="Sub all_inputs_click";
...
anywheresoftware.b4a.objects.drawable.GradientDrawable _c_btn = null;
int[] _colorg = null;
 //BA.debugLineNum = 944;BA.debugLine="Sub bday_edit_Click";
 //BA.debugLineNum = 945;BA.debugLine="edit_panel_click_ = 2";
_edit_panel_click_ = (int) (2);
 //BA.debugLineNum = 946;BA.debugLine="list_day.Initialize";
_list_day.Initialize();
 //BA.debugLineNum = 947;BA.debugLine="list_month.Initialize";
_list_month.Initialize();
 //BA.debugLineNum = 948;BA.debugLine="list_year.Initialize";
_list_year.Initialize();
 //BA.debugLineNum = 949;BA.debugLine="spin_day.Initialize(\"spin_day\")";
mostCurrent._spin_day.Initialize(mostCurrent.activityBA,"spin_day");
 //BA.debugLineNum = 950;BA.debugLine="spin_month.Initialize(\"spin_month\")";
mostCurrent._spin_month.Initialize(mostCurrent.activityBA,"spin_month");
 //BA.debugLineNum = 951;BA.debugLine="spin_year.Initialize(\"spin_year\")";
mostCurrent._spin_year.Initialize(mostCurrent.activityBA,"spin_year");
 //BA.debugLineNum = 952;BA.debugLine="For i = 1 To 31";
{
final int step8 = 1;
final int limit8 = (int) (31);
for (_i = (int) (1) ; (step8 > 0 && _i <= limit8) || (step8 < 0 && _i >= limit8); _i = ((int)(0 + _i + step8)) ) {
 //BA.debugLineNum = 953;BA.debugLine="list_day.Add(i)";
_list_day.Add((Object)(_i));
 }
};
 //BA.debugLineNum = 955;BA.debugLine="Dim iNowYear As Int";
_inowyear = 0;
 //BA.debugLineNum = 956;BA.debugLine="iNowYear = DateTime.GetYear(DateTime.Now)";
_inowyear = anywheresoftware.b4a.keywords.Common.DateTime.GetYear(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 957;BA.debugLine="For ii = 1950 To DateTime.GetYear(DateTime.Now)";
{
final int step13 = 1;
...
for (_ii = (int) (1950) ; (step13 > 0 && _ii <= limit13) || (step13 < 0 && _ii >= limit13); _ii = ((int)(0 + _ii + step13)) ) {
 //BA.debugLineNum = 958;BA.debugLine="list_year.Add(iNowYear)";
_list_year.Add((Object)(_inowyear));
 //BA.debugLineNum = 959;BA.debugLine="iNowYear = iNowYear-1";
_inowyear = (int) (_inowyear-1);
 }
};
 //BA.debugLineNum = 961;BA.debugLine="For iii = 1 To 12";
{
final int step17 = 1;
final int limit17 = (int) (12);
for (_iii = (int) (1) ; (step17 > 0 && _iii <= limit17) || (step17 < 0 && _iii >= limit17); _iii = ((int)(0 + _iii + step17)) ) {
 //BA.debugLineNum = 962;BA.debugLine="list_month.Add(iii)";
_list_month.Add((Object)(_iii));
 }
};
 //BA.debugLineNum = 964;BA.debugLine="spin_day.AddAll(list_day)";
mostCurrent._spin_day.AddAll(_list_day);
 //BA.debugLineNum = 965;BA.debugLine="spin_month.AddAll(list_month)";
mostCurrent._spin_month.AddAll(_list_month);
 //BA.debugLineNum = 966;BA.debugLine="spin_year.AddAll(list_year)";
mostCurrent._spin_year.AddAll(_list_year);
 //BA.debugLineNum = 967;BA.debugLine="Dim pnl As Panel";
_pnl = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 968;BA.debugLine="Dim edit_ok_btn,edit_can_btn As Button";
_edit_ok_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
_edit_can_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 969;BA.debugLine="Dim title_lbl As Label";
_title_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 970;BA.debugLine="edit_ok_btn.Initialize(\"edit_bday_ok_btn\")";
_edit_ok_btn.Initialize(mostCurrent.activityBA,"edit_bday_ok_btn");
 //BA.debugLineNum = 971;BA.debugLine="edit_can_btn.Initialize(\"edit_bday_can_btn\")";
_edit_can_btn.Initialize(mostCurrent.activityBA,"edit_bday_can_btn");
 //BA.debugLineNum = 972;BA.debugLine="title_lbl.Initialize(\"\")";
_title_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 973;BA.debugLine="edit_ok_btn.Text = \"OK\"";
_edit_ok_btn.setText((Object)("OK"));
 //BA.debugLineNum = 974;BA.debugLine="edit_can_btn.Text = \"CANCEL\"";
_edit_can_btn.setText((Object)("CANCEL"));
 //BA.debugLineNum = 975;BA.debugLine="Dim V_btn,C_btn As GradientDrawable";
_v_btn = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
_c_btn = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
 //BA.debugLineNum = 976;BA.debugLine="Dim colorG(2) As Int";
_colorg = new int[(int) (2)];
;
 //BA.debugLineNum = 977;BA.debugLine="colorG(0) = Colors.White";
_colorg[(int) (0)] = anywheresoftware.b4a.keywords.Common.Colors.White;
 //BA.debugLineNum = 978;BA.debugLine="colorG(1) = Colors.Red";
_colorg[(int) (1)] = anywheresoftware.b4a.keywords.Common.Colors.Red;
 //BA.debugLineNum = 979;BA.debugLine="C_btn.Initialize(\"TOP_BOTTOM\",colorG)";
_c_btn.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colorg);
 //BA.debugLineNum = 980;BA.debugLine="V_btn.Initialize(\"TOP_BOTTOM\",colorG)";
_v_btn.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colorg);
 //BA.debugLineNum = 981;BA.debugLine="V_btn.CornerRadius = 50dip";
_v_btn.setCornerRadius((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 982;BA.debugLine="C_btn.CornerRadius = 50dip";
_c_btn.setCornerRadius((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 983;BA.debugLine="edit_ok_btn.Background = V_btn";
_edit_ok_btn.setBackground((android.graphics.drawable.Drawable)(_v_btn.getObject()));
 //BA.debugLineNum = 984;BA.debugLine="edit_can_btn.Background = C_btn";
_edit_can_btn.setBackground((android.graphics.drawable.Drawable)(_c_btn.getObject()));
 //BA.debugLineNum = 985;BA.debugLine="title_lbl.Text = \"SELECT BIRTH DATE\"";
_title_lbl.setText((Object)("SELECT BIRTH DATE"));
 //BA.debugLineNum = 986;BA.debugLine="title_lbl.Gravity = Gravity.CENTER";
_title_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 987;BA.debugLine="pnl.Initialize(\"pnl\")";
_pnl.Initialize(mostCurrent.activityBA,"pnl");
 //BA.debugLineNum = 988;BA.debugLine="pnl_bday_body.Initialize(\"pnl_bday_body\")";
mostCurrent._pnl_bday_body.Initialize(mostCurrent.activityBA,"pnl_bday_body");
 //BA.debugLineNum = 989;BA.debugLine="pnl_bday_body.Color = Colors.Transparent";
mostCurrent._pnl_bday_body.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 990;BA.debugLine="pnl.SetBackgroundImage(LoadBitmap(File.DirAssets,";
_pnl.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"modal_bg.png").getObject()));
 //BA.debugLineNum = 991;BA.debugLine="pnl.AddView(title_lbl,2%x,2%y,68%x,8%y)";
_pnl.AddView((android.view.View)(_title_lbl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 992;BA.debugLine="pnl.AddView(spin_day,2%x,title_lbl.Top + title_lb";
_pnl.AddView((android.view.View)(mostCurrent._spin_day.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),(int) (_title_lbl.getTop()+_title_lbl.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 993;BA.debugLine="pnl.AddView(spin_month,spin_day.Left+spin_day.Wid";
_pnl.AddView((android.view.View)(mostCurrent._spin_month.getObject()),(int) (mostCurrent._spin_day.getLeft()+mostCurrent._spin_day.getWidth()+anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (1),mostCurrent.activityBA)),mostCurrent._spin_day.getTop(),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 994;BA.debugLine="pnl.AddView(spin_year,spin_month.Left+spin_month.";
_pnl.AddView((android.view.View)(mostCurrent._spin_year.getObject()),(int) (mostCurrent._spin_month.getLeft()+mostCurrent._spin_month.getWidth()+anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (1),mostCurrent.activityBA)),mostCurrent._spin_month.getTop(),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 995;BA.debugLine="pnl.AddView(edit_ok_btn,15%x,spin_year.Top+spin_y";
_pnl.AddView((android.view.View)(_edit_ok_btn.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (15),mostCurrent.activityBA),(int) (mostCurrent._spin_year.getTop()+mostCurrent._spin_year.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 996;BA.debugLine="pnl.AddView(edit_can_btn,edit_ok_btn.Left+edit_ok";
_pnl.AddView((android.view.View)(_edit_can_btn.getObject()),(int) (_edit_ok_btn.getLeft()+_edit_ok_btn.getWidth()+anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA)),(int) (mostCurrent._spin_year.getTop()+mostCurrent._spin_year.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 998;BA.debugLine="pnl_bday_body.AddView(pnl,13%x,((Activity.Height/";
mostCurrent._pnl_bday_body.AddView((android.view.View)(_pnl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (13),mostCurrent.activityBA),(int) (((mostCurrent._activity.getHeight()/(double)2)/(double)2)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (74),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (33),mostCurrent.activityBA));
 //BA.debugLineNum = 999;BA.debugLine="pnl_bday_body.BringToFront";
mostCurrent._pnl_bday_body.BringToFront();
 //BA.debugLineNum = 1002;BA.debugLine="Activity.AddView(pnl_bday_body,0,0,100%x,100%y)";
...
anywheresoftware.b4a.objects.drawable.GradientDrawable _c_btn = null;
int[] _colorg = null;
 //BA.debugLineNum = 1027;BA.debugLine="Sub blood_edit_Click";
 //BA.debugLineNum = 1029;BA.debugLine="edit_panel_click_ = 1";
_edit_panel_click_ = (int) (1);
 //BA.debugLineNum = 1030;BA.debugLine="list_bloodgroup.Initialize";
_list_bloodgroup.Initialize();
 //BA.debugLineNum = 1031;BA.debugLine="spin_bloodgroup.Initialize(\"spin_bloodgroup\")";
mostCurrent._spin_bloodgroup.Initialize(mostCurrent.activityBA,"spin_bloodgroup");
 //BA.debugLineNum = 1032;BA.debugLine="list_bloodgroup.Add(\"A\")";
_list_bloodgroup.Add((Object)("A"));
 //BA.debugLineNum = 1033;BA.debugLine="list_bloodgroup.Add(\"B\")";
_list_bloodgroup.Add((Object)("B"));
 //BA.debugLineNum = 1034;BA.debugLine="list_bloodgroup.Add(\"O\")";
_list_bloodgroup.Add((Object)("O"));
 //BA.debugLineNum = 1035;BA.debugLine="list_bloodgroup.Add(\"AB\")";
_list_bloodgroup.Add((Object)("AB"));
 //BA.debugLineNum = 1040;BA.debugLine="list_bloodgroup.Add(\"A-\")";
_list_bloodgroup.Add((Object)("A-"));
 //BA.debugLineNum = 1041;BA.debugLine="list_bloodgroup.Add(\"B-\")";
_list_bloodgroup.Add((Object)("B-"));
 //BA.debugLineNum = 1042;BA.debugLine="list_bloodgroup.Add(\"O-\")";
_list_bloodgroup.Add((Object)("O-"));
 //BA.debugLineNum = 1043;BA.debugLine="list_bloodgroup.Add(\"AB-\")";
_list_bloodgroup.Add((Object)("AB-"));
 //BA.debugLineNum = 1044;BA.debugLine="spin_bloodgroup.AddAll(list_bloodgroup)";
mostCurrent._spin_bloodgroup.AddAll(_list_bloodgroup);
 //BA.debugLineNum = 1045;BA.debugLine="Dim pnl As Panel";
_pnl = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 1046;BA.debugLine="Dim edit_ok_btn,edit_can_btn As Button";
_edit_ok_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
_edit_can_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 1047;BA.debugLine="Dim title_lbl As Label";
_title_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 1048;BA.debugLine="title_lbl.Initialize(\"\")";
_title_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1049;BA.debugLine="edit_ok_btn.Initialize(\"edit_blood_ok_btn\")";
_edit_ok_btn.Initialize(mostCurrent.activityBA,"edit_blood_ok_btn");
 //BA.debugLineNum = 1050;BA.debugLine="edit_can_btn.Initialize(\"edit_blood_can_btn\")";
_edit_can_btn.Initialize(mostCurrent.activityBA,"edit_blood_can_btn");
 //BA.debugLineNum = 1051;BA.debugLine="Dim V_btn,C_btn As GradientDrawable";
_v_btn = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
_c_btn = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
 //BA.debugLineNum = 1052;BA.debugLine="Dim colorG(2) As Int";
_colorg = new int[(int) (2)];
;
 //BA.debugLineNum = 1053;BA.debugLine="colorG(0) = Colors.White";
_colorg[(int) (0)] = anywheresoftware.b4a.keywords.Common.Colors.White;
 //BA.debugLineNum = 1054;BA.debugLine="colorG(1) = Colors.Red";
_colorg[(int) (1)] = anywheresoftware.b4a.keywords.Common.Colors.Red;
 //BA.debugLineNum = 1055;BA.debugLine="C_btn.Initialize(\"TOP_BOTTOM\",colorG)";
_c_btn.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colorg);
 //BA.debugLineNum = 1056;BA.debugLine="V_btn.Initialize(\"TOP_BOTTOM\",colorG)";
_v_btn.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colorg);
 //BA.debugLineNum = 1057;BA.debugLine="V_btn.CornerRadius = 50dip";
_v_btn.setCornerRadius((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 1058;BA.debugLine="C_btn.CornerRadius = 50dip";
_c_btn.setCornerRadius((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 1059;BA.debugLine="edit_ok_btn.Background = V_btn";
_edit_ok_btn.setBackground((android.graphics.drawable.Drawable)(_v_btn.getObject()));
 //BA.debugLineNum = 1060;BA.debugLine="edit_can_btn.Background = C_btn";
_edit_can_btn.setBackground((android.graphics.drawable.Drawable)(_c_btn.getObject()));
 //BA.debugLineNum = 1061;BA.debugLine="edit_ok_btn.Text = \"OK\"";
_edit_ok_btn.setText((Object)("OK"));
 //BA.debugLineNum = 1062;BA.debugLine="edit_can_btn.Text = \"CANCEL\"";
_edit_can_btn.setText((Object)("CANCEL"));
 //BA.debugLineNum = 1063;BA.debugLine="pnl.Initialize(\"pnl\")";
_pnl.Initialize(mostCurrent.activityBA,"pnl");
 //BA.debugLineNum = 1064;BA.debugLine="pnl_blood_body.Initialize(\"pnl_blood_body\")";
mostCurrent._pnl_blood_body.Initialize(mostCurrent.activityBA,"pnl_blood_body");
 //BA.debugLineNum = 1065;BA.debugLine="pnl_blood_body.Color = Colors.Transparent";
mostCurrent._pnl_blood_body.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 1066;BA.debugLine="pnl.SetBackgroundImage(LoadBitmap(File.DirAssets,";
_pnl.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"modal_bg.png").getObject()));
 //BA.debugLineNum = 1067;BA.debugLine="title_lbl.Text = \"SELECT BLOOD TYPE\"";
_title_lbl.setText((Object)("SELECT BLOOD TYPE"));
 //BA.debugLineNum = 1068;BA.debugLine="title_lbl.Gravity = Gravity.CENTER";
_title_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 1069;BA.debugLine="pnl.AddView(title_lbl,2%x,2%y,68%x,8%y)";
_pnl.AddView((android.view.View)(_title_lbl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 1070;BA.debugLine="pnl.AddView(spin_bloodgroup,2%x,title_lbl.Top + t";
_pnl.AddView((android.view.View)(mostCurrent._spin_bloodgroup.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),(int) (_title_lbl.getTop()+_title_lbl.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 1071;BA.debugLine="pnl.AddView(edit_ok_btn,15%x,spin_bloodgroup.Top+";
_pnl.AddView((android.view.View)(_edit_ok_btn.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (15),mostCurrent.activityBA),(int) (mostCurrent._spin_bloodgroup.getTop()+mostCurrent._spin_bloodgroup.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 1072;BA.debugLine="pnl.AddView(edit_can_btn,edit_ok_btn.Left+edit_ok";
_pnl.AddView((android.view.View)(_edit_can_btn.getObject()),(int) (_edit_ok_btn.getLeft()+_edit_ok_btn.getWidth()+anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA)),(int) (mostCurrent._spin_bloodgroup.getTop()+mostCurrent._spin_bloodgroup.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 1074;BA.debugLine="pnl_blood_body.AddView(pnl,13%x,((Activity.Height";
mostCurrent._pnl_blood_body.AddView((android.view.View)(_pnl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (13),mostCurrent.activityBA),(int) (((mostCurrent._activity.getHeight()/(double)2)/(double)2)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (74),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (33),mostCurrent.activityBA));
 //BA.debugLineNum = 1075;BA.debugLine="pnl_blood_body.BringToFront";
mostCurrent._pnl_blood_body.BringToFront();
 //BA.debugLineNum = 1078;BA.debugLine="Activity.AddView(pnl_blood_body,0,0,100%x,100%y)";
...
public static String  _cancel_btn_click() throws Exception{
 //BA.debugLineNum = 654;BA.debugLine="Sub cancel_btn_Click";
 //BA.debugLineNum = 655;BA.debugLine="profile_all_body.RemoveView";
mostCurrent._profile_all_body.RemoveView();
 //BA.debugLineNum = 656;BA.debugLine="End Sub";
return "";
}
public static String  _donate_spin_day_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 903;BA.debugLine="Sub donate_spin_day_ItemClick (Position As Int, Va";
 //BA.debugLineNum = 904;BA.debugLine="donate_d_pos = Position";
...
public static String  _donate_spin_month_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 907;BA.debugLine="Sub donate_spin_month_ItemClick (Position As Int,";
 //BA.debugLineNum = 908;BA.debugLine="donate_m_pos = Position";
...
public static String  _donate_spin_year_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 911;BA.debugLine="Sub donate_spin_year_ItemClick (Position As Int, V";
 //BA.debugLineNum = 912;BA.debugLine="donate_y_pos = Position";
...
anywheresoftware.b4a.objects.drawable.GradientDrawable _c_btn = null;
int[] _colorg = null;
 //BA.debugLineNum = 783;BA.debugLine="Sub donated_edit_Click";
 //BA.debugLineNum = 784;BA.debugLine="edit_panel_click_ = 4";
_edit_panel_click_ = (int) (4);
 //BA.debugLineNum = 785;BA.debugLine="list_donated.Initialize";
_list_donated.Initialize();
 //BA.debugLineNum = 786;BA.debugLine="spin_donated.Initialize(\"spin_donated\")";
mostCurrent._spin_donated.Initialize(mostCurrent.activityBA,"spin_donated");
 //BA.debugLineNum = 787;BA.debugLine="list_donated.Add(\"NO\")";
_list_donated.Add((Object)("NO"));
 //BA.debugLineNum = 788;BA.debugLine="list_donated.Add(\"YES\")";
_list_donated.Add((Object)("YES"));
 //BA.debugLineNum = 789;BA.debugLine="spin_donated.AddAll(list_donated)";
mostCurrent._spin_donated.AddAll(_list_donated);
 //BA.debugLineNum = 790;BA.debugLine="Dim pnl As Panel";
_pnl = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 791;BA.debugLine="Dim edit_ok_btn,edit_can_btn As Button";
_edit_ok_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
_edit_can_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 792;BA.debugLine="Dim title_lbl As Label";
_title_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 793;BA.debugLine="edit_ok_btn.Initialize(\"edit_donated_ok_btn\")";
_edit_ok_btn.Initialize(mostCurrent.activityBA,"edit_donated_ok_btn");
 //BA.debugLineNum = 794;BA.debugLine="edit_can_btn.Initialize(\"edit_donated_can_btn\")";
_edit_can_btn.Initialize(mostCurrent.activityBA,"edit_donated_can_btn");
 //BA.debugLineNum = 795;BA.debugLine="title_lbl.Initialize(\"\")";
_title_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 796;BA.debugLine="edit_ok_btn.Text = \"OK\"";
_edit_ok_btn.setText((Object)("OK"));
 //BA.debugLineNum = 797;BA.debugLine="edit_can_btn.Text = \"CANCEL\"";
_edit_can_btn.setText((Object)("CANCEL"));
 //BA.debugLineNum = 798;BA.debugLine="Dim V_btn,C_btn As GradientDrawable";
_v_btn = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
_c_btn = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
 //BA.debugLineNum = 799;BA.debugLine="Dim colorG(2) As Int";
_colorg = new int[(int) (2)];
;
 //BA.debugLineNum = 800;BA.debugLine="colorG(0) = Colors.White";
_colorg[(int) (0)] = anywheresoftware.b4a.keywords.Common.Colors.White;
 //BA.debugLineNum = 801;BA.debugLine="colorG(1) = Colors.Red";
_colorg[(int) (1)] = anywheresoftware.b4a.keywords.Common.Colors.Red;
 //BA.debugLineNum = 802;BA.debugLine="C_btn.Initialize(\"TOP_BOTTOM\",colorG)";
_c_btn.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colorg);
 //BA.debugLineNum = 803;BA.debugLine="V_btn.Initialize(\"TOP_BOTTOM\",colorG)";
_v_btn.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colorg);
 //BA.debugLineNum = 804;BA.debugLine="V_btn.CornerRadius = 50dip";
_v_btn.setCornerRadius((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 805;BA.debugLine="C_btn.CornerRadius = 50dip";
_c_btn.setCornerRadius((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 806;BA.debugLine="edit_ok_btn.Background = V_btn";
_edit_ok_btn.setBackground((android.graphics.drawable.Drawable)(_v_btn.getObject()));
 //BA.debugLineNum = 807;BA.debugLine="edit_can_btn.Background = C_btn";
_edit_can_btn.setBackground((android.graphics.drawable.Drawable)(_c_btn.getObject()));
 //BA.debugLineNum = 808;BA.debugLine="title_lbl.Text = \"SELECT DONATED STATUS\"";
_title_lbl.setText((Object)("SELECT DONATED STATUS"));
 //BA.debugLineNum = 809;BA.debugLine="title_lbl.Gravity = Gravity.CENTER";
_title_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 810;BA.debugLine="pnl.Initialize(\"pnl\")";
_pnl.Initialize(mostCurrent.activityBA,"pnl");
 //BA.debugLineNum = 811;BA.debugLine="pnl_donated_body.Initialize(\"pnl_donated_body\")";
mostCurrent._pnl_donated_body.Initialize(mostCurrent.activityBA,"pnl_donated_body");
 //BA.debugLineNum = 812;BA.debugLine="pnl_donated_body.Color = Colors.Transparent";
mostCurrent._pnl_donated_body.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 813;BA.debugLine="pnl.SetBackgroundImage(LoadBitmap(File.DirAssets,";
_pnl.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"modal_bg.png").getObject()));
 //BA.debugLineNum = 814;BA.debugLine="pnl.AddView(title_lbl,2%x,2%y,68%x,8%y)";
_pnl.AddView((android.view.View)(_title_lbl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 815;BA.debugLine="pnl.AddView(spin_donated,2%x,title_lbl.Top+title_";
_pnl.AddView((android.view.View)(mostCurrent._spin_donated.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),(int) (_title_lbl.getTop()+_title_lbl.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 816;BA.debugLine="pnl.AddView(edit_ok_btn,15%x,spin_donated.Top+spi";
_pnl.AddView((android.view.View)(_edit_ok_btn.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (15),mostCurrent.activityBA),(int) (mostCurrent._spin_donated.getTop()+mostCurrent._spin_donated.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 817;BA.debugLine="pnl.AddView(edit_can_btn,edit_ok_btn.Left+edit_ok";
_pnl.AddView((android.view.View)(_edit_can_btn.getObject()),(int) (_edit_ok_btn.getLeft()+_edit_ok_btn.getWidth()+anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA)),(int) (mostCurrent._spin_donated.getTop()+mostCurrent._spin_donated.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 819;BA.debugLine="pnl_donated_body.AddView(pnl,13%x,((Activity.Heig";
mostCurrent._pnl_donated_body.AddView((android.view.View)(_pnl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (13),mostCurrent.activityBA),(int) (((mostCurrent._activity.getHeight()/(double)2)/(double)2)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (74),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (33),mostCurrent.activityBA));
 //BA.debugLineNum = 820;BA.debugLine="pnl_donated_body.BringToFront";
mostCurrent._pnl_donated_body.BringToFront();
 //BA.debugLineNum = 823;BA.debugLine="Activity.AddView(pnl_donated_body,0,0,100%x,100%y";
...
public static String  _edit_bday_can_btn_click() throws Exception{
 //BA.debugLineNum = 1021;BA.debugLine="Sub edit_bday_can_btn_click";
 //BA.debugLineNum = 1022;BA.debugLine="pnl_bday_body.RemoveView";
mostCurrent._pnl_bday_body.RemoveView();
 //BA.debugLineNum = 1023;BA.debugLine="End Sub";
return "";
}
public static String  _edit_bday_ok_btn_click() throws Exception{
 //BA.debugLineNum = 1016;BA.debugLine="Sub edit_bday_ok_btn_click";
 //BA.debugLineNum = 1017;BA.debugLine="text_bday.Text = bday_month_selected&\"/\"&bday_day";
mostCurrent._text_bday.setText((Object)(_bday_month_selected+"/"+_bday_day_selected+"/"+_bday_year_selected));
 //BA.debugLineNum = 1018;BA.debugLine="Log(\"date: \"& bday_month_selected&\"/\"&bday_day_s";
anywheresoftware.b4a.keywords.Common.Log("date: "+_bday_month_selected+"/"+_bday_day_selected+"/"+_bday_year_selected);
 //BA.debugLineNum = 1019;BA.debugLine="pnl_bday_body.RemoveView";
mostCurrent._pnl_bday_body.RemoveView();
 //BA.debugLineNum = 1020;BA.debugLine="End Sub";
return "";
}
public static String  _edit_blood_can_btn_click() throws Exception{
 //BA.debugLineNum = 1084;BA.debugLine="Sub edit_blood_can_btn_click";
 //BA.debugLineNum = 1085;BA.debugLine="pnl_blood_body.RemoveView";
mostCurrent._pnl_blood_body.RemoveView();
 //BA.debugLineNum = 1086;BA.debugLine="End Sub";
return "";
}
public static String  _edit_blood_ok_btn_click() throws Exception{
 //BA.debugLineNum = 1080;BA.debugLine="Sub edit_blood_ok_btn_click";
 //BA.debugLineNum = 1081;BA.debugLine="text_blood.Text = blood_selected";
mostCurrent._text_blood.setText((Object)(_blood_selected));
 //BA.debugLineNum = 1082;BA.debugLine="pnl_blood_body.RemoveView";
mostCurrent._pnl_blood_body.RemoveView();
 //BA.debugLineNum = 1083;BA.debugLine="End Sub";
return "";
}
public static String  _edit_can_btn_click() throws Exception{
 //BA.debugLineNum = 1167;BA.debugLine="Sub edit_can_btn_click";
 //BA.debugLineNum = 1168;BA.debugLine="pnl_body.RemoveView";
mostCurrent._pnl_body.RemoveView();
 //BA.debugLineNum = 1169;BA.debugLine="End Sub";
return "";
}
public static String  _edit_donated_can_btn_click() throws Exception{
 //BA.debugLineNum = 938;BA.debugLine="Sub edit_donated_can_btn_click";
 //BA.debugLineNum = 939;BA.debugLine="pnl_donated_body.RemoveView";
mostCurrent._pnl_donated_body.RemoveView();
 //BA.debugLineNum = 940;BA.debugLine="End Sub";
return "";
}
public static String  _edit_donated_ok_btn_click() throws Exception{
 //BA.debugLineNum = 830;BA.debugLine="Sub edit_donated_ok_btn_click";
 //BA.debugLineNum = 831;BA.debugLine="If donated_index == 0 Then";
if (_donated_index==0) { 
 //BA.debugLineNum = 832;BA.debugLine="is_donated = \"NO\"";
_is_donated = "NO";
 //BA.debugLineNum = 833;BA.debugLine="isDonateDate = \"NONE\"";
_isdonatedate = "NONE";
 //BA.debugLineNum = 834;BA.debugLine="text_donated.Text = \"NO\"";
mostCurrent._text_donated.setText((Object)("NO"));
 }else {
 //BA.debugLineNum = 836;BA.debugLine="isDonate_edit_";
_isdonate_edit_();
 };
 //BA.debugLineNum = 840;BA.debugLine="pnl_donated_body.RemoveView";
mostCurrent._pnl_donated_body.RemoveView();
 //BA.debugLineNum = 841;BA.debugLine="End Sub";
return "";
}
public static String  _edit_gender_can_btn_click() throws Exception{
 //BA.debugLineNum = 777;BA.debugLine="Sub edit_gender_can_btn_click";
 //BA.debugLineNum = 778;BA.debugLine="pnl_gender_body.RemoveView";
mostCurrent._pnl_gender_body.RemoveView();
...
anywheresoftware.b4a.objects.drawable.GradientDrawable _c_btn = null;
int[] _colorg = null;
 //BA.debugLineNum = 725;BA.debugLine="Sub edit_gender_Click";
 //BA.debugLineNum = 726;BA.debugLine="edit_panel_click_ = 5";
_edit_panel_click_ = (int) (5);
 //BA.debugLineNum = 727;BA.debugLine="list_is_gender.Initialize";
_list_is_gender.Initialize();
 //BA.debugLineNum = 728;BA.debugLine="spin_gender.Initialize(\"spin_gender\")";
mostCurrent._spin_gender.Initialize(mostCurrent.activityBA,"spin_gender");
 //BA.debugLineNum = 729;BA.debugLine="list_is_gender.Add(\"Male\")";
_list_is_gender.Add((Object)("Male"));
 //BA.debugLineNum = 730;BA.debugLine="list_is_gender.Add(\"Female\")";
_list_is_gender.Add((Object)("Female"));
 //BA.debugLineNum = 731;BA.debugLine="spin_gender.AddAll(list_is_gender)";
mostCurrent._spin_gender.AddAll(_list_is_gender);
 //BA.debugLineNum = 732;BA.debugLine="Dim pnl As Panel";
_pnl = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 733;BA.debugLine="Dim edit_ok_btn,edit_can_btn As Button";
_edit_ok_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
_edit_can_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 734;BA.debugLine="Dim title_lbl As Label";
_title_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 735;BA.debugLine="edit_ok_btn.Initialize(\"edit_gender_ok_btn\")";
_edit_ok_btn.Initialize(mostCurrent.activityBA,"edit_gender_ok_btn");
 //BA.debugLineNum = 736;BA.debugLine="edit_can_btn.Initialize(\"edit_gender_can_btn\")";
_edit_can_btn.Initialize(mostCurrent.activityBA,"edit_gender_can_btn");
 //BA.debugLineNum = 737;BA.debugLine="title_lbl.Initialize(\"\")";
_title_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 738;BA.debugLine="edit_ok_btn.Text = \"OK\"";
_edit_ok_btn.setText((Object)("OK"));
 //BA.debugLineNum = 739;BA.debugLine="edit_can_btn.Text = \"CANCEL\"";
_edit_can_btn.setText((Object)("CANCEL"));
 //BA.debugLineNum = 740;BA.debugLine="Dim V_btn,C_btn As GradientDrawable";
_v_btn = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
_c_btn = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
 //BA.debugLineNum = 741;BA.debugLine="Dim colorG(2) As Int";
_colorg = new int[(int) (2)];
;
 //BA.debugLineNum = 742;BA.debugLine="colorG(0) = Colors.White";
_colorg[(int) (0)] = anywheresoftware.b4a.keywords.Common.Colors.White;
 //BA.debugLineNum = 743;BA.debugLine="colorG(1) = Colors.Red";
_colorg[(int) (1)] = anywheresoftware.b4a.keywords.Common.Colors.Red;
 //BA.debugLineNum = 744;BA.debugLine="C_btn.Initialize(\"TOP_BOTTOM\",colorG)";
_c_btn.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colorg);
 //BA.debugLineNum = 745;BA.debugLine="V_btn.Initialize(\"TOP_BOTTOM\",colorG)";
_v_btn.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colorg);
 //BA.debugLineNum = 746;BA.debugLine="V_btn.CornerRadius = 50dip";
_v_btn.setCornerRadius((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 747;BA.debugLine="C_btn.CornerRadius = 50dip";
_c_btn.setCornerRadius((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 748;BA.debugLine="edit_ok_btn.Background = V_btn";
_edit_ok_btn.setBackground((android.graphics.drawable.Drawable)(_v_btn.getObject()));
 //BA.debugLineNum = 749;BA.debugLine="edit_can_btn.Background = C_btn";
_edit_can_btn.setBackground((android.graphics.drawable.Drawable)(_c_btn.getObject()));
 //BA.debugLineNum = 750;BA.debugLine="title_lbl.Text = \"SELECT GENDER\"";
_title_lbl.setText((Object)("SELECT GENDER"));
 //BA.debugLineNum = 751;BA.debugLine="title_lbl.Gravity = Gravity.CENTER";
_title_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 752;BA.debugLine="pnl.Initialize(\"pnl\")";
_pnl.Initialize(mostCurrent.activityBA,"pnl");
 //BA.debugLineNum = 753;BA.debugLine="pnl_gender_body.Initialize(\"pnl_gender_body\")";
mostCurrent._pnl_gender_body.Initialize(mostCurrent.activityBA,"pnl_gender_body");
 //BA.debugLineNum = 754;BA.debugLine="pnl_gender_body.Color = Colors.Transparent";
mostCurrent._pnl_gender_body.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 755;BA.debugLine="pnl.SetBackgroundImage(LoadBitmap(File.DirAssets,";
_pnl.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"modal_bg.png").getObject()));
 //BA.debugLineNum = 756;BA.debugLine="pnl.AddView(title_lbl,2%x,2%y,68%x,8%y)";
_pnl.AddView((android.view.View)(_title_lbl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 757;BA.debugLine="pnl.AddView(spin_gender,2%x,title_lbl.Top+title_l";
_pnl.AddView((android.view.View)(mostCurrent._spin_gender.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),(int) (_title_lbl.getTop()+_title_lbl.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 758;BA.debugLine="pnl.AddView(edit_ok_btn,15%x,spin_gender.Top+spin";
_pnl.AddView((android.view.View)(_edit_ok_btn.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (15),mostCurrent.activityBA),(int) (mostCurrent._spin_gender.getTop()+mostCurrent._spin_gender.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 759;BA.debugLine="pnl.AddView(edit_can_btn,edit_ok_btn.Left+edit_ok";
_pnl.AddView((android.view.View)(_edit_can_btn.getObject()),(int) (_edit_ok_btn.getLeft()+_edit_ok_btn.getWidth()+anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA)),(int) (mostCurrent._spin_gender.getTop()+mostCurrent._spin_gender.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 761;BA.debugLine="pnl_gender_body.AddView(pnl,13%x,((Activity.Heigh";
mostCurrent._pnl_gender_body.AddView((android.view.View)(_pnl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (13),mostCurrent.activityBA),(int) (((mostCurrent._activity.getHeight()/(double)2)/(double)2)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (74),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (33),mostCurrent.activityBA));
 //BA.debugLineNum = 762;BA.debugLine="pnl_gender_body.BringToFront";
mostCurrent._pnl_gender_body.BringToFront();
 //BA.debugLineNum = 765;BA.debugLine="Activity.AddView(pnl_gender_body,0,0,100%x,100%y)";
...
public static String  _edit_gender_ok_btn_click() throws Exception{
 //BA.debugLineNum = 771;BA.debugLine="Sub edit_gender_ok_btn_click";
 //BA.debugLineNum = 773;BA.debugLine="text_gender.Text = list_is_gender.Get(is_gender_i";
mostCurrent._text_gender.setText(_list_is_gender.Get(_is_gender_index));
 //BA.debugLineNum = 774;BA.debugLine="gender_string_data = list_is_gender.Get(is_gender";
_gender_string_data = BA.ObjectToString(_list_is_gender.Get(_is_gender_index));
 //BA.debugLineNum = 775;BA.debugLine="pnl_gender_body.RemoveView";
mostCurrent._pnl_gender_body.RemoveView();
...
String _click_string = "";
 //BA.debugLineNum = 1170;BA.debugLine="Sub edit_ok_btn_click";
 //BA.debugLineNum = 1171;BA.debugLine="Dim click_string As String";
_click_string = "";
 //BA.debugLineNum = 1172;BA.debugLine="click_string = location_spin_brgy.GetItem(brgy_in";
_click_string = mostCurrent._location_spin_brgy.GetItem(_brgy_index)+", "+mostCurrent._location_spin_street.GetItem(_street_index);
 //BA.debugLineNum = 1173;BA.debugLine="location_brgy_selected = location_spin_brgy.GetIt";
_location_brgy_selected = mostCurrent._location_spin_brgy.GetItem(_brgy_index);
 //BA.debugLineNum = 1174;BA.debugLine="location_street_selected = location_spin_stree";
_location_street_selected = mostCurrent._location_spin_street.GetItem(_street_index);
 //BA.debugLineNum = 1175;BA.debugLine="text_location.Text = click_string";
mostCurrent._text_location.setText((Object)(_click_string));
 //BA.debugLineNum = 1176;BA.debugLine="pnl_body.RemoveView";
mostCurrent._pnl_body.RemoveView();
...
int _confirm = 0;
 //BA.debugLineNum = 638;BA.debugLine="Sub exit_btn_Click";
 //BA.debugLineNum = 639;BA.debugLine="If login_form.is_log_in == True Then";
if (mostCurrent._login_form._is_log_in==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 640;BA.debugLine="Dim confirm As Int";
_confirm = 0;
 //BA.debugLineNum = 641;BA.debugLine="confirm = Msgbox2(\"Would you to log out your acc";
_confirm = anywheresoftware.b4a.keywords.Common.Msgbox2("Would you to log out your account, and exit the application?","C O N F I R M A T I O N","YES","","NO",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA);
 //BA.debugLineNum = 642;BA.debugLine="If confirm == DialogResponse.POSITIVE Then";
if (_confirm==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 643;BA.debugLine="login_form.is_log_in = False";
mostCurrent._login_form._is_log_in = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 645;BA.debugLine="ExitApplication";
anywheresoftware.b4a.keywords.Common.ExitApplication();
 }else {
 };
 }else {
...
String _fi_string = "";
int _string_h = 0;
 //BA.debugLineNum = 2013;BA.debugLine="Sub help_Click";
 //BA.debugLineNum = 2014;BA.debugLine="panel_click_ = 3";
_panel_click_ = (int) (3);
 //BA.debugLineNum = 2015;BA.debugLine="Dim pnl As Panel";
_pnl = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 2016;BA.debugLine="Dim help_ok_btn As Button";
_help_ok_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 2017;BA.debugLine="Dim title_lbl,help_data,for_h As Label";
_title_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
_help_data = new anywheresoftware.b4a.objects.LabelWrapper();
_for_h = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 2018;BA.debugLine="for_h.Initialize(\"\")";
_for_h.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 2019;BA.debugLine="Dim sus As StringUtils";
_sus = new anywheresoftware.b4a.objects.StringUtils();
 //BA.debugLineNum = 2020;BA.debugLine="help_ok_btn.Initialize(\"help_ok_btn\")";
_help_ok_btn.Initialize(mostCurrent.activityBA,"help_ok_btn");
 //BA.debugLineNum = 2021;BA.debugLine="title_lbl.Initialize(\"\")";
_title_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 2022;BA.debugLine="help_data.Initialize(\"\")";
_help_data.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 2023;BA.debugLine="help_ok_btn.Text = \"OK\"";
_help_ok_btn.setText((Object)("OK"));
 //BA.debugLineNum = 2024;BA.debugLine="Dim V_btn,C_btn As GradientDrawable";
_v_btn = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
_c_btn = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
 //BA.debugLineNum = 2025;BA.debugLine="Dim colorG(2) As Int";
_colorg = new int[(int) (2)];
;
 //BA.debugLineNum = 2026;BA.debugLine="colorG(0) = Colors.White";
_colorg[(int) (0)] = anywheresoftware.b4a.keywords.Common.Colors.White;
 //BA.debugLineNum = 2027;BA.debugLine="colorG(1) = Colors.Red";
_colorg[(int) (1)] = anywheresoftware.b4a.keywords.Common.Colors.Red;
 //BA.debugLineNum = 2028;BA.debugLine="C_btn.Initialize(\"TOP_BOTTOM\",colorG)";
_c_btn.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colorg);
 //BA.debugLineNum = 2029;BA.debugLine="V_btn.Initialize(\"TOP_BOTTOM\",colorG)";
_v_btn.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colorg);
 //BA.debugLineNum = 2030;BA.debugLine="V_btn.CornerRadius = 50dip";
_v_btn.setCornerRadius((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 2032;BA.debugLine="help_ok_btn.Background = V_btn";
_help_ok_btn.setBackground((android.graphics.drawable.Drawable)(_v_btn.getObject()));
 //BA.debugLineNum = 2033;BA.debugLine="title_lbl.Text = \"HELP\"";
_title_lbl.setText((Object)("HELP"));
 //BA.debugLineNum = 2034;BA.debugLine="title_lbl.TextSize = 25";
_title_lbl.setTextSize((float) (25));
 //BA.debugLineNum = 2035;BA.debugLine="title_lbl.Typeface = Typeface.DEFAULT_BOLD";
_title_lbl.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD);
 //BA.debugLineNum = 2036;BA.debugLine="title_lbl.Background = C_btn";
_title_lbl.setBackground((android.graphics.drawable.Drawable)(_c_btn.getObject()));
 //BA.debugLineNum = 2037;BA.debugLine="title_lbl.TextColor = Colors.Black";
_title_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 2039;BA.debugLine="help_us_pnl.Initialize(\"help_us_pnl\")";
mostCurrent._help_us_pnl.Initialize(mostCurrent.activityBA,"help_us_pnl");
 //BA.debugLineNum = 2040;BA.debugLine="Dim rs As RichString";
_rs = new anywheresoftware.b4a.agraham.richstring.RichStringBuilder.RichString();
 //BA.debugLineNum = 2041;BA.debugLine="Dim f_string,s_string,t_string,fo_string,fi_strin";
_f_string = "";
_s_string = "";
_t_string = "";
_fo_string = "";
_fi_string = "";
_s_string = "";
 //BA.debugLineNum = 2042;BA.debugLine="f_string = CRLF&\"•	Once you gave your name and yo";
_f_string = anywheresoftware.b4a.keywords.Common.CRLF+"•	Once you gave your name and your contact number, all your information will be shown to all this mobile app users.  ";
 //BA.debugLineNum = 2043;BA.debugLine="s_string = CRLF&CRLF&\"•  Your mobile number will";
_s_string = anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+"•  Your mobile number will be call you once the recipient found you that you are one of the possible donors. ";
 //BA.debugLineNum = 2044;BA.debugLine="t_string = CRLF&CRLF&\"•  DO NOT do a search and c";
_t_string = anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+"•  DO NOT do a search and contact just to test app. If you do TEST the SEARCH button and contact the donor and tell the donor that you only testing the app the donor might be disappointed. You will waste not only your time and effort but you will waste a patient’s who is really need a donor.";
 //BA.debugLineNum = 2045;BA.debugLine="fo_string = CRLF&CRLF&\"•  Using call button is mo";
_fo_string = anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+"•  Using call button is more effective than sending message to the donor. It saves time and effort.";
 //BA.debugLineNum = 2046;BA.debugLine="fi_string = CRLF&CRLF&\"•  Select the correct Feed";
_fi_string = anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+"•  Select the correct Feedback given to this app so that it will help in boosting the confident of the developer and will be making more community based app like this LIFEBLOOD WITH GIS.";
 //BA.debugLineNum = 2047;BA.debugLine="s_string = CRLF&CRLF&\"•  Please share this app an";
_s_string = anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+"•  Please share this app and let us build a community that cares.";
 //BA.debugLineNum = 2048;BA.debugLine="rs.Initialize(f_string&s_string&t_string&fo_strin";
_rs.Initialize((java.lang.CharSequence)(_f_string+_s_string+_t_string+_fo_string+_fi_string+_s_string));
 //BA.debugLineNum = 2049;BA.debugLine="help_data.Text = rs '' to set the string output";
_help_data.setText((Object)(_rs.getObject()));
 //BA.debugLineNum = 2050;BA.debugLine="help_data.TextSize = 17";
_help_data.setTextSize((float) (17));
 //BA.debugLineNum = 2051;BA.debugLine="for_h.Text = rs";
_for_h.setText((Object)(_rs.getObject()));
 //BA.debugLineNum = 2052;BA.debugLine="help_us_pnl.AddView(for_h,0,0,50%x,50%y)";
mostCurrent._help_us_pnl.AddView((android.view.View)(_for_h.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (50),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (50),mostCurrent.activityBA));
 //BA.debugLineNum = 2053;BA.debugLine="for_h.Visible = False";
_for_h.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2054;BA.debugLine="Dim string_h As Int : string_h= sus.MeasureMulti";
_string_h = 0;
 //BA.debugLineNum = 2054;BA.debugLine="Dim string_h As Int : string_h= sus.MeasureMulti";
_string_h = _sus.MeasureMultilineTextHeight((android.widget.TextView)(_for_h.getObject()),_for_h.getText());
 //BA.debugLineNum = 2056;BA.debugLine="help_sc2d.Initialize(68%x,string_h+15%Y,\"help_s";
mostCurrent._help_sc2d.Initialize(mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),(int) (_string_h+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (15),mostCurrent.activityBA)),"help_sc2d");
 //BA.debugLineNum = 2057;BA.debugLine="help_sc2d.ScrollbarsVisibility(False,False)";
mostCurrent._help_sc2d.ScrollbarsVisibility(anywheresoftware.b4a.keywords.Common.False,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2058;BA.debugLine="title_lbl.Gravity = Gravity.CENTER";
_title_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 2059;BA.debugLine="pnl.Initialize(\"pnl\")";
_pnl.Initialize(mostCurrent.activityBA,"pnl");
 //BA.debugLineNum = 2061;BA.debugLine="help_us_pnl.Color = Colors.Transparent";
mostCurrent._help_us_pnl.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 2062;BA.debugLine="pnl.SetBackgroundImage(LoadBitmap(File.DirAssets,";
_pnl.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"modal_bg.png").getObject()));
 //BA.debugLineNum = 2063;BA.debugLine="pnl.AddView(title_lbl,2%x,2%y,70%x,8%y)";
_pnl.AddView((android.view.View)(_title_lbl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (70),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 2065;BA.debugLine="pnl.AddView(help_sc2d,2%x,title_lbl.Top + title_l";
_pnl.AddView((android.view.View)(mostCurrent._help_sc2d.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),(int) (_title_lbl.getTop()+_title_lbl.getHeight()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (70),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (60),mostCurrent.activityBA));
 //BA.debugLineNum = 2066;BA.debugLine="help_sc2d.Panel.AddView(help_data,0,0,70%x,string";
mostCurrent._help_sc2d.getPanel().AddView((android.view.View)(_help_data.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (70),mostCurrent.activityBA),(int) (_string_h+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (15),mostCurrent.activityBA)));
 //BA.debugLineNum = 2067;BA.debugLine="pnl.AddView(help_ok_btn,1%x,help_sc2d.Top + help_";
_pnl.AddView((android.view.View)(_help_ok_btn.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (1),mostCurrent.activityBA),(int) (mostCurrent._help_sc2d.getTop()+mostCurrent._help_sc2d.getHeight()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (72),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 2069;BA.debugLine="help_us_pnl.AddView(pnl,13%x,((((Activity.Height/";
mostCurrent._help_us_pnl.AddView((android.view.View)(_pnl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (13),mostCurrent.activityBA),(int) (((((mostCurrent._activity.getHeight()/(double)2)/(double)2)/(double)2)/(double)2)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (74),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (80),mostCurrent.activityBA));
 //BA.debugLineNum = 2070;BA.debugLine="help_us_pnl.BringToFront";
mostCurrent._help_us_pnl.BringToFront();
 //BA.debugLineNum = 2073;BA.debugLine="Activity.AddView(help_us_pnl,0,0,100%x,100%y)";
...
public static String  _help_ok_btn_click() throws Exception{
 //BA.debugLineNum = 2075;BA.debugLine="Sub help_ok_btn_click";
 //BA.debugLineNum = 2076;BA.debugLine="help_us_pnl.RemoveView";
mostCurrent._help_us_pnl.RemoveView();
 //BA.debugLineNum = 2077;BA.debugLine="End Sub";
return "";
}
public static String  _help_us_pnl_click() throws Exception{
 //BA.debugLineNum = 2078;BA.debugLine="Sub help_us_pnl_click";
...
anywheresoftware.b4a.objects.drawable.GradientDrawable _c_btn = null;
int[] _colorg = null;
 //BA.debugLineNum = 842;BA.debugLine="Sub isDonate_edit_";
 //BA.debugLineNum = 843;BA.debugLine="donated_index = 0";
_donated_index = (int) (0);
 //BA.debugLineNum = 845;BA.debugLine="list_day.Initialize";
_list_day.Initialize();
 //BA.debugLineNum = 846;BA.debugLine="list_month.Initialize";
_list_month.Initialize();
 //BA.debugLineNum = 847;BA.debugLine="list_year.Initialize";
_list_year.Initialize();
 //BA.debugLineNum = 848;BA.debugLine="spin_day.Initialize(\"donate_spin_day\")";
mostCurrent._spin_day.Initialize(mostCurrent.activityBA,"donate_spin_day");
 //BA.debugLineNum = 849;BA.debugLine="spin_month.Initialize(\"donate_spin_month\")";
mostCurrent._spin_month.Initialize(mostCurrent.activityBA,"donate_spin_month");
 //BA.debugLineNum = 850;BA.debugLine="spin_year.Initialize(\"donate_spin_year\")";
mostCurrent._spin_year.Initialize(mostCurrent.activityBA,"donate_spin_year");
 //BA.debugLineNum = 851;BA.debugLine="For i = 1 To 31";
{
final int step8 = 1;
final int limit8 = (int) (31);
for (_i = (int) (1) ; (step8 > 0 && _i <= limit8) || (step8 < 0 && _i >= limit8); _i = ((int)(0 + _i + step8)) ) {
 //BA.debugLineNum = 852;BA.debugLine="list_day.Add(i)";
_list_day.Add((Object)(_i));
 }
};
 //BA.debugLineNum = 854;BA.debugLine="Dim iNowYear As Int";
_inowyear = 0;
 //BA.debugLineNum = 855;BA.debugLine="iNowYear = DateTime.GetYear(DateTime.Now)";
_inowyear = anywheresoftware.b4a.keywords.Common.DateTime.GetYear(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 856;BA.debugLine="For ii = 1950 To DateTime.GetYear(DateTime.Now)";
{
final int step13 = 1;
final int limit13 = anywheresoftware.b4a.keywords.Common.DateTime.GetYear(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
for (_ii = (int) (1950) ; (step13 > 0 && _ii <= limit13) || (step13 < 0 && _ii >= limit13); _ii = ((int)(0 + _ii + step13)) ) {
 //BA.debugLineNum = 857;BA.debugLine="list_year.Add(iNowYear)";
_list_year.Add((Object)(_inowyear));
 //BA.debugLineNum = 858;BA.debugLine="iNowYear = iNowYear-1";
_inowyear = (int) (_inowyear-1);
 }
};
 //BA.debugLineNum = 860;BA.debugLine="For iii = 1 To 12";
{
final int step17 = 1;
final int limit17 = (int) (12);
for (_iii = (int) (1) ; (step17 > 0 && _iii <= limit17) || (step17 < 0 && _iii >= limit17); _iii = ((int)(0 + _iii + step17)) ) {
 //BA.debugLineNum = 861;BA.debugLine="list_month.Add(iii)";
_list_month.Add((Object)(_iii));
 }
};
 //BA.debugLineNum = 863;BA.debugLine="spin_day.AddAll(list_day)";
mostCurrent._spin_day.AddAll(_list_day);
 //BA.debugLineNum = 864;BA.debugLine="spin_month.AddAll(list_month)";
mostCurrent._spin_month.AddAll(_list_month);
 //BA.debugLineNum = 865;BA.debugLine="spin_year.AddAll(list_year)";
mostCurrent._spin_year.AddAll(_list_year);
 //BA.debugLineNum = 866;BA.debugLine="Dim pnl As Panel";
_pnl = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 867;BA.debugLine="Dim edit_ok_btn,edit_can_btn As Button";
_edit_ok_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
_edit_can_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 868;BA.debugLine="Dim title_lbl As Label";
_title_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 869;BA.debugLine="edit_ok_btn.Initialize(\"isdonated_ok_btn\")";
_edit_ok_btn.Initialize(mostCurrent.activityBA,"isdonated_ok_btn");
 //BA.debugLineNum = 870;BA.debugLine="edit_can_btn.Initialize(\"isdonated_can_btn\")";
_edit_can_btn.Initialize(mostCurrent.activityBA,"isdonated_can_btn");
 //BA.debugLineNum = 871;BA.debugLine="title_lbl.Initialize(\"\")";
_title_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 872;BA.debugLine="edit_ok_btn.Text = \"OK\"";
_edit_ok_btn.setText((Object)("OK"));
 //BA.debugLineNum = 873;BA.debugLine="edit_can_btn.Text = \"CANCEL\"";
_edit_can_btn.setText((Object)("CANCEL"));
 //BA.debugLineNum = 874;BA.debugLine="Dim V_btn,C_btn As GradientDrawable";
_v_btn = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
_c_btn = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
 //BA.debugLineNum = 875;BA.debugLine="Dim colorG(2) As Int";
_colorg = new int[(int) (2)];
;
 //BA.debugLineNum = 876;BA.debugLine="colorG(0) = Colors.White";
_colorg[(int) (0)] = anywheresoftware.b4a.keywords.Common.Colors.White;
 //BA.debugLineNum = 877;BA.debugLine="colorG(1) = Colors.Red";
_colorg[(int) (1)] = anywheresoftware.b4a.keywords.Common.Colors.Red;
 //BA.debugLineNum = 878;BA.debugLine="C_btn.Initialize(\"TOP_BOTTOM\",colorG)";
_c_btn.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colorg);
 //BA.debugLineNum = 879;BA.debugLine="V_btn.Initialize(\"TOP_BOTTOM\",colorG)";
_v_btn.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colorg);
 //BA.debugLineNum = 880;BA.debugLine="V_btn.CornerRadius = 50dip";
_v_btn.setCornerRadius((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 881;BA.debugLine="C_btn.CornerRadius = 50dip";
_c_btn.setCornerRadius((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 882;BA.debugLine="edit_ok_btn.Background = V_btn";
_edit_ok_btn.setBackground((android.graphics.drawable.Drawable)(_v_btn.getObject()));
 //BA.debugLineNum = 883;BA.debugLine="edit_can_btn.Background = C_btn";
_edit_can_btn.setBackground((android.graphics.drawable.Drawable)(_c_btn.getObject()));
 //BA.debugLineNum = 884;BA.debugLine="title_lbl.Text = \"SELECT DONATED DATE\"";
_title_lbl.setText((Object)("SELECT DONATED DATE"));
 //BA.debugLineNum = 885;BA.debugLine="title_lbl.Gravity = Gravity.CENTER";
_title_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 886;BA.debugLine="pnl.Initialize(\"pnl\")";
_pnl.Initialize(mostCurrent.activityBA,"pnl");
 //BA.debugLineNum = 887;BA.debugLine="pnl_bday_body.Initialize(\"pnl_bday_body\")";
mostCurrent._pnl_bday_body.Initialize(mostCurrent.activityBA,"pnl_bday_body");
 //BA.debugLineNum = 888;BA.debugLine="pnl_bday_body.Color = Colors.Transparent";
mostCurrent._pnl_bday_body.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 889;BA.debugLine="pnl.SetBackgroundImage(LoadBitmap(File.DirAssets,";
_pnl.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"modal_bg.png").getObject()));
 //BA.debugLineNum = 890;BA.debugLine="pnl.AddView(title_lbl,2%x,2%y,68%x,8%y)";
_pnl.AddView((android.view.View)(_title_lbl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 891;BA.debugLine="pnl.AddView(spin_day,2%x,title_lbl.Top + title_lb";
_pnl.AddView((android.view.View)(mostCurrent._spin_day.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),(int) (_title_lbl.getTop()+_title_lbl.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 892;BA.debugLine="pnl.AddView(spin_month,spin_day.Left+spin_day.Wid";
_pnl.AddView((android.view.View)(mostCurrent._spin_month.getObject()),(int) (mostCurrent._spin_day.getLeft()+mostCurrent._spin_day.getWidth()+anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (1),mostCurrent.activityBA)),mostCurrent._spin_day.getTop(),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 893;BA.debugLine="pnl.AddView(spin_year,spin_month.Left+spin_month.";
_pnl.AddView((android.view.View)(mostCurrent._spin_year.getObject()),(int) (mostCurrent._spin_month.getLeft()+mostCurrent._spin_month.getWidth()+anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (1),mostCurrent.activityBA)),mostCurrent._spin_month.getTop(),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 894;BA.debugLine="pnl.AddView(edit_ok_btn,15%x,spin_year.Top+spin_y";
_pnl.AddView((android.view.View)(_edit_ok_btn.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (15),mostCurrent.activityBA),(int) (mostCurrent._spin_year.getTop()+mostCurrent._spin_year.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 895;BA.debugLine="pnl.AddView(edit_can_btn,edit_ok_btn.Left+edit_ok";
_pnl.AddView((android.view.View)(_edit_can_btn.getObject()),(int) (_edit_ok_btn.getLeft()+_edit_ok_btn.getWidth()+anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA)),(int) (mostCurrent._spin_year.getTop()+mostCurrent._spin_year.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 897;BA.debugLine="pnl_bday_body.AddView(pnl,13%x,((Activity.Height/";
mostCurrent._pnl_bday_body.AddView((android.view.View)(_pnl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (13),mostCurrent.activityBA),(int) (((mostCurrent._activity.getHeight()/(double)2)/(double)2)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (74),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (33),mostCurrent.activityBA));
 //BA.debugLineNum = 898;BA.debugLine="pnl_bday_body.BringToFront";
mostCurrent._pnl_bday_body.BringToFront();
 //BA.debugLineNum = 901;BA.debugLine="Activity.AddView(pnl_bday_body,0,0,100%x,100%y)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._pnl_bday_body.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 902;BA.debugLine="End Sub";
return "";
}
public static String  _isdonated_can_btn_click() throws Exception{
 //BA.debugLineNum = 927;BA.debugLine="Sub isdonated_can_btn_click";
 //BA.debugLineNum = 928;BA.debugLine="pnl_bday_body.RemoveView";
mostCurrent._pnl_bday_body.RemoveView();
 //BA.debugLineNum = 929;BA.debugLine="If text_donated.Text == \"NO\" Then";
if ((mostCurrent._text_donated.getText()).equals("NO")) { 
 //BA.debugLineNum = 930;BA.debugLine="text_donated.Text = \"NO\"";
mostCurrent._text_donated.setText((Object)("NO"));
 }else {
 //BA.debugLineNum = 932;BA.debugLine="text_donated.Text = \"YES\"";
...
String _month = "";
String _year = "";
 //BA.debugLineNum = 915;BA.debugLine="Sub isdonated_ok_btn_click";
 //BA.debugLineNum = 916;BA.debugLine="Dim day,month,year As String";
_day = "";
_month = "";
_year = "";
 //BA.debugLineNum = 917;BA.debugLine="day = spin_day.GetItem(donate_d_pos)";
_day = mostCurrent._spin_day.GetItem(_donate_d_pos);
 //BA.debugLineNum = 918;BA.debugLine="month = spin_month.GetItem(donate_m_pos)";
_month = mostCurrent._spin_month.GetItem(_donate_m_pos);
 //BA.debugLineNum = 919;BA.debugLine="year = spin_year.GetItem(donate_y_pos)";
_year = mostCurrent._spin_year.GetItem(_donate_y_pos);
 //BA.debugLineNum = 920;BA.debugLine="isDonateDate = month&\"/\"&day&\"/\"&year";
_isdonatedate = _month+"/"+_day+"/"+_year;
 //BA.debugLineNum = 922;BA.debugLine="Msgbox(\"\"&month&\"/\"&day&\"/\"&year,\"Date Selected\")";
anywheresoftware.b4a.keywords.Common.Msgbox(""+_month+"/"+_day+"/"+_year,"Date Selected",mostCurrent.activityBA);
 //BA.debugLineNum = 923;BA.debugLine="text_donated.Text = is_donated";
mostCurrent._text_donated.setText((Object)(_is_donated));
 //BA.debugLineNum = 924;BA.debugLine="Log(isDonateDate)";
anywheresoftware.b4a.keywords.Common.Log(_isdonatedate);
 //BA.debugLineNum = 925;BA.debugLine="pnl_bday_body.RemoveView";
mostCurrent._pnl_bday_body.RemoveView();
...
int _confirmr = 0;
 //BA.debugLineNum = 531;BA.debugLine="Public Sub JobDone(job As HttpJob)";
 //BA.debugLineNum = 532;BA.debugLine="If job.Success Then";
if (_job._success) { 
 //BA.debugLineNum = 533;BA.debugLine="Select job.JobName";
switch (BA.switchObjectToInt(_job._jobname,"all_info_query")) {
case 0: {
 //BA.debugLineNum = 535;BA.debugLine="Dim user_all_info As TextWriter";
_user_all_info = new anywheresoftware.b4a.objects.streams.File.TextWriterWrapper();
 //BA.debugLineNum = 536;BA.debugLine="user_all_info.Initialize(File.OpenOutput(";
_user_all_info.Initialize((java.io.OutputStream)(anywheresoftware.b4a.keywords.Common.File.OpenOutput(anywheresoftware.b4a.keywords.Common.File.getDirInternalCache(),"users_all_info.txt",anywheresoftware.b4a.keywords.Common.False).getObject()));
 //BA.debugLineNum = 537;BA.debugLine="user_all_info.WriteLine(job.GetString.Tr";
_user_all_info.WriteLine(_job._getstring().trim());
 //BA.debugLineNum = 538;BA.debugLine="user_all_info.Close";
_user_all_info.Close();
 break; }
}
;
 //BA.debugLineNum = 542;BA.debugLine="If optionSelected == \"pofileView\" Then";
if ((_optionselected).equals("pofileView")) { 
 //BA.debugLineNum = 543;BA.debugLine="all_input_on_list";
_all_input_on_list();
 }else {
 //BA.debugLineNum = 545;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 546;BA.debugLine="profile_all_body.RemoveView";
mostCurrent._profile_all_body.RemoveView();
 //BA.debugLineNum = 547;BA.debugLine="Dim confirmR As Int";
_confirmr = 0;
 //BA.debugLineNum = 548;BA.debugLine="confirmR = Msgbox2(\"Successfuly Update!\",\"C O";
_confirmr = anywheresoftware.b4a.keywords.Common.Msgbox2("Successfuly Update!","C O N F I R M A T I O N","OK","","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA);
 //BA.debugLineNum = 549;BA.debugLine="If confirmR == DialogResponse.POSITIVE Then";
if (_confirmr==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 550;BA.debugLine="users_out_lbl.text = text_answer.Text";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 557;BA.debugLine="profile_all_body.RemoveView";
mostCurrent._profile_all_body.RemoveView();
 //BA.debugLineNum = 558;BA.debugLine="Msgbox(\"Error connecting to server, try again!\"";
...
anywheresoftware.b4a.objects.drawable.GradientDrawable _c_btn = null;
int[] _colorg = null;
 //BA.debugLineNum = 1094;BA.debugLine="Sub locate_edit_Click";
 //BA.debugLineNum = 1095;BA.debugLine="edit_panel_click_ = 3";
_edit_panel_click_ = (int) (3);
 //BA.debugLineNum = 1096;BA.debugLine="list_location_b.Initialize";
_list_location_b.Initialize();
 //BA.debugLineNum = 1097;BA.debugLine="location_spin_street.Initialize(\"location_spin_s";
mostCurrent._location_spin_street.Initialize(mostCurrent.activityBA,"location_spin_street");
 //BA.debugLineNum = 1098;BA.debugLine="location_spin_brgy.Initialize(\"location_spin_brg";
mostCurrent._location_spin_brgy.Initialize(mostCurrent.activityBA,"location_spin_brgy");
 //BA.debugLineNum = 1099;BA.debugLine="list_location_s.Initialize";
_list_location_s.Initialize();
 //BA.debugLineNum = 1100;BA.debugLine="list_location_b.Add(\"Barangay  1\") 'index 0";
_list_location_b.Add((Object)("Barangay  1"));
 //BA.debugLineNum = 1101;BA.debugLine="list_location_b.Add(\"Barangay 2\") 'index 1";
_list_location_b.Add((Object)("Barangay 2"));
 //BA.debugLineNum = 1102;BA.debugLine="list_location_b.Add(\"Barangay 3\") 'index 2";
_list_location_b.Add((Object)("Barangay 3"));
 //BA.debugLineNum = 1103;BA.debugLine="list_location_b.Add(\"Barangay 4\") 'index 3";
_list_location_b.Add((Object)("Barangay 4"));
 //BA.debugLineNum = 1104;BA.debugLine="list_location_b.Add(\"Aguisan\") 'index 4";
_list_location_b.Add((Object)("Aguisan"));
 //BA.debugLineNum = 1105;BA.debugLine="list_location_b.Add(\"caradio-an\") 'index 5";
_list_location_b.Add((Object)("caradio-an"));
 //BA.debugLineNum = 1106;BA.debugLine="list_location_b.Add(\"Buenavista\") 'index 6";
_list_location_b.Add((Object)("Buenavista"));
 //BA.debugLineNum = 1107;BA.debugLine="list_location_b.Add(\"Cabadiangan\") 'index 7";
_list_location_b.Add((Object)("Cabadiangan"));
 //BA.debugLineNum = 1108;BA.debugLine="list_location_b.Add(\"Cabanbanan\") 'index 8";
_list_location_b.Add((Object)("Cabanbanan"));
 //BA.debugLineNum = 1109;BA.debugLine="list_location_b.Add(\"Carabalan\") 'index 9";
_list_location_b.Add((Object)("Carabalan"));
 //BA.debugLineNum = 1110;BA.debugLine="list_location_b.Add(\"Libacao\") 'index 10";
_list_location_b.Add((Object)("Libacao"));
 //BA.debugLineNum = 1111;BA.debugLine="list_location_b.Add(\"Mahalang\") 'index 11";
_list_location_b.Add((Object)("Mahalang"));
 //BA.debugLineNum = 1112;BA.debugLine="list_location_b.Add(\"Mambagaton\") 'index 12";
_list_location_b.Add((Object)("Mambagaton"));
 //BA.debugLineNum = 1113;BA.debugLine="list_location_b.Add(\"Nabalian\") 'index 13";
_list_location_b.Add((Object)("Nabalian"));
 //BA.debugLineNum = 1114;BA.debugLine="list_location_b.Add(\"San Antonio\") 'index 14";
_list_location_b.Add((Object)("San Antonio"));
 //BA.debugLineNum = 1115;BA.debugLine="list_location_b.Add(\"Saraet\") 'index 15";
_list_location_b.Add((Object)("Saraet"));
 //BA.debugLineNum = 1116;BA.debugLine="list_location_b.Add(\"Suay\") 'index 16";
_list_location_b.Add((Object)("Suay"));
 //BA.debugLineNum = 1117;BA.debugLine="list_location_b.Add(\"Talaban\") 'index 17";
_list_location_b.Add((Object)("Talaban"));
 //BA.debugLineNum = 1118;BA.debugLine="list_location_b.Add(\"Tooy\") 'index 18";
_list_location_b.Add((Object)("Tooy"));
 //BA.debugLineNum = 1119;BA.debugLine="location_spin_brgy.AddAll(list_location_b)";
mostCurrent._location_spin_brgy.AddAll(_list_location_b);
 //BA.debugLineNum = 1121;BA.debugLine="list_location_s.Add(\"Rizal st.\")";
_list_location_s.Add((Object)("Rizal st."));
 //BA.debugLineNum = 1122;BA.debugLine="list_location_s.Add(\"Valega st.\")";
_list_location_s.Add((Object)("Valega st."));
 //BA.debugLineNum = 1123;BA.debugLine="list_location_s.Add(\"Sarmiento st.\")";
_list_location_s.Add((Object)("Sarmiento st."));
 //BA.debugLineNum = 1124;BA.debugLine="list_location_s.Add(\"Bantolinao st.\")";
_list_location_s.Add((Object)("Bantolinao st."));
 //BA.debugLineNum = 1125;BA.debugLine="list_location_s.Add(\"Versoza st.\")";
_list_location_s.Add((Object)("Versoza st."));
 //BA.debugLineNum = 1126;BA.debugLine="list_location_s.Add(\"Jimenez st.\")";
_list_location_s.Add((Object)("Jimenez st."));
 //BA.debugLineNum = 1127;BA.debugLine="list_location_s.Add(\"Olmedo st.\")";
_list_location_s.Add((Object)("Olmedo st."));
 //BA.debugLineNum = 1128;BA.debugLine="list_location_s.Add(\"Burgos st.\")";
_list_location_s.Add((Object)("Burgos st."));
 //BA.debugLineNum = 1129;BA.debugLine="location_spin_street.AddAll(list_location_s)";
mostCurrent._location_spin_street.AddAll(_list_location_s);
 //BA.debugLineNum = 1131;BA.debugLine="Dim pnl As Panel";
_pnl = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 1132;BA.debugLine="Dim edit_ok_btn,edit_can_btn As Button";
_edit_ok_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
_edit_can_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 1133;BA.debugLine="Dim title_lbl As Label";
_title_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 1134;BA.debugLine="edit_ok_btn.Initialize(\"edit_ok_btn\")";
_edit_ok_btn.Initialize(mostCurrent.activityBA,"edit_ok_btn");
 //BA.debugLineNum = 1135;BA.debugLine="edit_can_btn.Initialize(\"edit_can_btn\")";
_edit_can_btn.Initialize(mostCurrent.activityBA,"edit_can_btn");
 //BA.debugLineNum = 1136;BA.debugLine="Dim V_btn,C_btn As GradientDrawable";
_v_btn = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
_c_btn = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
 //BA.debugLineNum = 1137;BA.debugLine="Dim colorG(2) As Int";
_colorg = new int[(int) (2)];
;
 //BA.debugLineNum = 1138;BA.debugLine="colorG(0) = Colors.White";
_colorg[(int) (0)] = anywheresoftware.b4a.keywords.Common.Colors.White;
 //BA.debugLineNum = 1139;BA.debugLine="colorG(1) = Colors.Red";
_colorg[(int) (1)] = anywheresoftware.b4a.keywords.Common.Colors.Red;
 //BA.debugLineNum = 1140;BA.debugLine="C_btn.Initialize(\"TOP_BOTTOM\",colorG)";
_c_btn.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colorg);
 //BA.debugLineNum = 1141;BA.debugLine="V_btn.Initialize(\"TOP_BOTTOM\",colorG)";
_v_btn.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colorg);
 //BA.debugLineNum = 1142;BA.debugLine="V_btn.CornerRadius = 50dip";
_v_btn.setCornerRadius((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 1143;BA.debugLine="C_btn.CornerRadius = 50dip";
_c_btn.setCornerRadius((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 1144;BA.debugLine="edit_ok_btn.Background = V_btn";
_edit_ok_btn.setBackground((android.graphics.drawable.Drawable)(_v_btn.getObject()));
 //BA.debugLineNum = 1145;BA.debugLine="edit_can_btn.Background = C_btn";
_edit_can_btn.setBackground((android.graphics.drawable.Drawable)(_c_btn.getObject()));
 //BA.debugLineNum = 1146;BA.debugLine="title_lbl.Initialize(\"\")";
_title_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 1147;BA.debugLine="edit_ok_btn.Text = \"OK\"";
_edit_ok_btn.setText((Object)("OK"));
 //BA.debugLineNum = 1148;BA.debugLine="edit_can_btn.Text = \"CANCEL\"";
_edit_can_btn.setText((Object)("CANCEL"));
 //BA.debugLineNum = 1149;BA.debugLine="title_lbl.Text = \"SELECT LOCATION\"";
_title_lbl.setText((Object)("SELECT LOCATION"));
 //BA.debugLineNum = 1150;BA.debugLine="title_lbl.Gravity =  Gravity.CENTER";
_title_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 1151;BA.debugLine="pnl.Initialize(\"pnl\")";
_pnl.Initialize(mostCurrent.activityBA,"pnl");
 //BA.debugLineNum = 1152;BA.debugLine="pnl_body.Initialize(\"pnl_body\")";
mostCurrent._pnl_body.Initialize(mostCurrent.activityBA,"pnl_body");
 //BA.debugLineNum = 1153;BA.debugLine="pnl_body.Color = Colors.Transparent";
mostCurrent._pnl_body.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 1154;BA.debugLine="pnl.SetBackgroundImage(LoadBitmap(File.DirAssets,";
_pnl.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"modal_bg.png").getObject()));
 //BA.debugLineNum = 1155;BA.debugLine="pnl.AddView(title_lbl,2%x,2%y,68%x,8%y)";
_pnl.AddView((android.view.View)(_title_lbl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 1156;BA.debugLine="pnl.AddView(location_spin_brgy,2%x,title_lbl.Top";
_pnl.AddView((android.view.View)(mostCurrent._location_spin_brgy.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),(int) (_title_lbl.getTop()+_title_lbl.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (33),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 1157;BA.debugLine="pnl.AddView(location_spin_street,location_spin_br";
_pnl.AddView((android.view.View)(mostCurrent._location_spin_street.getObject()),(int) (mostCurrent._location_spin_brgy.getLeft()+mostCurrent._location_spin_brgy.getWidth()+anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA)),mostCurrent._location_spin_brgy.getTop(),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (33),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 1158;BA.debugLine="pnl.AddView(edit_ok_btn,15%x,location_spin_street";
_pnl.AddView((android.view.View)(_edit_ok_btn.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (15),mostCurrent.activityBA),(int) (mostCurrent._location_spin_street.getTop()+mostCurrent._location_spin_street.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 1159;BA.debugLine="pnl.AddView(edit_can_btn,edit_ok_btn.Left+edit_ok";
_pnl.AddView((android.view.View)(_edit_can_btn.getObject()),(int) (_edit_ok_btn.getLeft()+_edit_ok_btn.getWidth()+anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA)),(int) (mostCurrent._location_spin_street.getTop()+mostCurrent._location_spin_street.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 1161;BA.debugLine="pnl_body.AddView(pnl,13%x,((Activity.Height/2)/2)";
mostCurrent._pnl_body.AddView((android.view.View)(_pnl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (13),mostCurrent.activityBA),(int) (((mostCurrent._activity.getHeight()/(double)2)/(double)2)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (74),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (33),mostCurrent.activityBA));
 //BA.debugLineNum = 1162;BA.debugLine="pnl_body.BringToFront";
mostCurrent._pnl_body.BringToFront();
 //BA.debugLineNum = 1165;BA.debugLine="Activity.AddView(pnl_body,0,0,100%x,100%y)";
...
public static String  _location_spin_brgy_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 1736;BA.debugLine="Sub location_spin_brgy_ItemClick (Position As Int,";
 //BA.debugLineNum = 1737;BA.debugLine="list_location_s.Clear";
_list_location_s.Clear();
 //BA.debugLineNum = 1739;BA.debugLine="location_spin_street.Clear";
mostCurrent._location_spin_street.Clear();
 //BA.debugLineNum = 1742;BA.debugLine="If Position == 0 Then";
if (_position==0) { 
 //BA.debugLineNum = 1743;BA.debugLine="list_location_s.Add(\"Rizal st.\")";
_list_location_s.Add((Object)("Rizal st."));
 //BA.debugLineNum = 1744;BA.debugLine="list_location_s.Add(\"Valega st.\")";
_list_location_s.Add((Object)("Valega st."));
 //BA.debugLineNum = 1745;BA.debugLine="list_location_s.Add(\"Sarmiento st.\")";
_list_location_s.Add((Object)("Sarmiento st."));
 //BA.debugLineNum = 1746;BA.debugLine="list_location_s.Add(\"Bantolinao st.\")";
_list_location_s.Add((Object)("Bantolinao st."));
 //BA.debugLineNum = 1747;BA.debugLine="list_location_s.Add(\"Versoza st.\")";
_list_location_s.Add((Object)("Versoza st."));
 //BA.debugLineNum = 1748;BA.debugLine="list_location_s.Add(\"Jimenez st.\")";
_list_location_s.Add((Object)("Jimenez st."));
 //BA.debugLineNum = 1749;BA.debugLine="list_location_s.Add(\"Olmedo st.\")";
_list_location_s.Add((Object)("Olmedo st."));
 //BA.debugLineNum = 1750;BA.debugLine="list_location_s.Add(\"Burgos st.\")";
_list_location_s.Add((Object)("Burgos st."));
 }else if(_position==1) { 
 //BA.debugLineNum = 1753;BA.debugLine="list_location_s.Add(\"Rizal st.\")";
_list_location_s.Add((Object)("Rizal st."));
 //BA.debugLineNum = 1754;BA.debugLine="list_location_s.Add(\"Monton st.\")";
_list_location_s.Add((Object)("Monton st."));
 //BA.debugLineNum = 1755;BA.debugLine="list_location_s.Add(\"Carabalan road\")";
_list_location_s.Add((Object)("Carabalan road"));
 //BA.debugLineNum = 1756;BA.debugLine="list_location_s.Add(\"Purok star apple\")";
_list_location_s.Add((Object)("Purok star apple"));
 //BA.debugLineNum = 1757;BA.debugLine="list_location_s.Add(\"Gatuslao st.\")";
_list_location_s.Add((Object)("Gatuslao st."));
 //BA.debugLineNum = 1758;BA.debugLine="list_location_s.Add(\"Bungyod\")";
_list_location_s.Add((Object)("Bungyod"));
 //BA.debugLineNum = 1759;BA.debugLine="list_location_s.Add(\"Tabino st.\")";
_list_location_s.Add((Object)("Tabino st."));
 //BA.debugLineNum = 1760;BA.debugLine="list_location_s.Add(\"River side\")";
_list_location_s.Add((Object)("River side"));
 //BA.debugLineNum = 1761;BA.debugLine="list_location_s.Add(\"Arroyan st\")";
_list_location_s.Add((Object)("Arroyan st"));
 }else if(_position==2) { 
 //BA.debugLineNum = 1763;BA.debugLine="list_location_s.Add(\"Segovia st.\")";
_list_location_s.Add((Object)("Segovia st."));
 //BA.debugLineNum = 1764;BA.debugLine="list_location_s.Add(\"Vasquez st.\")";
_list_location_s.Add((Object)("Vasquez st."));
 //BA.debugLineNum = 1765;BA.debugLine="list_location_s.Add(\"Olmedo st.\")";
_list_location_s.Add((Object)("Olmedo st."));
 //BA.debugLineNum = 1766;BA.debugLine="list_location_s.Add(\"Old relis st.\")";
_list_location_s.Add((Object)("Old relis st."));
 //BA.debugLineNum = 1767;BA.debugLine="list_location_s.Add(\"Wayang\")";
_list_location_s.Add((Object)("Wayang"));
 //BA.debugLineNum = 1768;BA.debugLine="list_location_s.Add(\"Valencia\")";
_list_location_s.Add((Object)("Valencia"));
 //BA.debugLineNum = 1769;BA.debugLine="list_location_s.Add(\"Bungyod\")";
_list_location_s.Add((Object)("Bungyod"));
 //BA.debugLineNum = 1770;BA.debugLine="list_location_s.Add(\"Bingig\")";
_list_location_s.Add((Object)("Bingig"));
 //BA.debugLineNum = 1771;BA.debugLine="list_location_s.Add(\"Bajay\")";
_list_location_s.Add((Object)("Bajay"));
 //BA.debugLineNum = 1772;BA.debugLine="list_location_s.Add(\"Carabalan road\")";
_list_location_s.Add((Object)("Carabalan road"));
 }else if(_position==3) { 
 //BA.debugLineNum = 1774;BA.debugLine="list_location_s.Add(\"Crusher\")";
_list_location_s.Add((Object)("Crusher"));
 //BA.debugLineNum = 1775;BA.debugLine="list_location_s.Add(\"Bangga mayok\")";
_list_location_s.Add((Object)("Bangga mayok"));
 //BA.debugLineNum = 1776;BA.debugLine="list_location_s.Add(\"Villa julita\")";
_list_location_s.Add((Object)("Villa julita"));
 //BA.debugLineNum = 1777;BA.debugLine="list_location_s.Add(\"Greenland subdivision\")";
_list_location_s.Add((Object)("Greenland subdivision"));
 //BA.debugLineNum = 1778;BA.debugLine="list_location_s.Add(\"Bangga 3c\")";
_list_location_s.Add((Object)("Bangga 3c"));
 //BA.debugLineNum = 1779;BA.debugLine="list_location_s.Add(\"Cambugnon\")";
_list_location_s.Add((Object)("Cambugnon"));
 //BA.debugLineNum = 1780;BA.debugLine="list_location_s.Add(\"Menez\")";
_list_location_s.Add((Object)("Menez"));
 //BA.debugLineNum = 1781;BA.debugLine="list_location_s.Add(\"Relis\")";
_list_location_s.Add((Object)("Relis"));
 //BA.debugLineNum = 1782;BA.debugLine="list_location_s.Add(\"Bangga patyo\")";
_list_location_s.Add((Object)("Bangga patyo"));
 }else if(_position==4) { 
 //BA.debugLineNum = 1784;BA.debugLine="list_location_s.Add(\"Purok 1\")";
_list_location_s.Add((Object)("Purok 1"));
 //BA.debugLineNum = 1785;BA.debugLine="list_location_s.Add(\"Purok 2\")";
_list_location_s.Add((Object)("Purok 2"));
 //BA.debugLineNum = 1786;BA.debugLine="list_location_s.Add(\"Purok 3\")";
_list_location_s.Add((Object)("Purok 3"));
 //BA.debugLineNum = 1787;BA.debugLine="list_location_s.Add(\"Purok 4\")";
_list_location_s.Add((Object)("Purok 4"));
 //BA.debugLineNum = 1788;BA.debugLine="list_location_s.Add(\"Purok 5\")";
_list_location_s.Add((Object)("Purok 5"));
 //BA.debugLineNum = 1789;BA.debugLine="list_location_s.Add(\"Purok 6\")";
_list_location_s.Add((Object)("Purok 6"));
 //BA.debugLineNum = 1790;BA.debugLine="list_location_s.Add(\"Purok 7\")";
_list_location_s.Add((Object)("Purok 7"));
 //BA.debugLineNum = 1791;BA.debugLine="list_location_s.Add(\"Purok 8\")";
_list_location_s.Add((Object)("Purok 8"));
 //BA.debugLineNum = 1792;BA.debugLine="list_location_s.Add(\"Purok 9\")";
_list_location_s.Add((Object)("Purok 9"));
 //BA.debugLineNum = 1793;BA.debugLine="list_location_s.Add(\"Purok 10\")";
_list_location_s.Add((Object)("Purok 10"));
 //BA.debugLineNum = 1794;BA.debugLine="list_location_s.Add(\"Purok 11\")";
_list_location_s.Add((Object)("Purok 11"));
 //BA.debugLineNum = 1795;BA.debugLine="list_location_s.Add(\"Purok 12\")";
_list_location_s.Add((Object)("Purok 12"));
 }else if(_position==5) { 
 //BA.debugLineNum = 1797;BA.debugLine="list_location_s.Add(\"Malusay\")";
_list_location_s.Add((Object)("Malusay"));
 //BA.debugLineNum = 1798;BA.debugLine="list_location_s.Add(\"Nasug ong\")";
_list_location_s.Add((Object)("Nasug ong"));
 //BA.debugLineNum = 1799;BA.debugLine="list_location_s.Add(\"Lugway\")";
_list_location_s.Add((Object)("Lugway"));
 //BA.debugLineNum = 1800;BA.debugLine="list_location_s.Add(\"Ubay\")";
_list_location_s.Add((Object)("Ubay"));
 //BA.debugLineNum = 1801;BA.debugLine="list_location_s.Add(\"Fisheries\")";
_list_location_s.Add((Object)("Fisheries"));
 //BA.debugLineNum = 1802;BA.debugLine="list_location_s.Add(\"Proper\")";
_list_location_s.Add((Object)("Proper"));
 //BA.debugLineNum = 1803;BA.debugLine="list_location_s.Add(\"Calasa\")";
_list_location_s.Add((Object)("Calasa"));
 //BA.debugLineNum = 1804;BA.debugLine="list_location_s.Add(\"Hda. Serafin\")";
_list_location_s.Add((Object)("Hda. Serafin"));
 //BA.debugLineNum = 1805;BA.debugLine="list_location_s.Add(\"Patay na suba\")";
_list_location_s.Add((Object)("Patay na suba"));
 //BA.debugLineNum = 1806;BA.debugLine="list_location_s.Add(\"Lumanog\")";
_list_location_s.Add((Object)("Lumanog"));
 //BA.debugLineNum = 1807;BA.debugLine="list_location_s.Add(\"San agustin\")";
_list_location_s.Add((Object)("San agustin"));
 //BA.debugLineNum = 1808;BA.debugLine="list_location_s.Add(\"San jose\")";
_list_location_s.Add((Object)("San jose"));
 //BA.debugLineNum = 1809;BA.debugLine="list_location_s.Add(\"Maglantay\")";
_list_location_s.Add((Object)("Maglantay"));
 //BA.debugLineNum = 1810;BA.debugLine="list_location_s.Add(\"San juan\")";
_list_location_s.Add((Object)("San juan"));
 //BA.debugLineNum = 1811;BA.debugLine="list_location_s.Add(\"Magsaha\")";
_list_location_s.Add((Object)("Magsaha"));
 //BA.debugLineNum = 1812;BA.debugLine="list_location_s.Add(\"Tagmanok\")";
_list_location_s.Add((Object)("Tagmanok"));
 //BA.debugLineNum = 1813;BA.debugLine="list_location_s.Add(\"Butong\")";
_list_location_s.Add((Object)("Butong"));
 }else if(_position==6) { 
 //BA.debugLineNum = 1815;BA.debugLine="list_location_s.Add(\"Proper\")";
_list_location_s.Add((Object)("Proper"));
 //BA.debugLineNum = 1816;BA.debugLine="list_location_s.Add(\"Saisi\")";
_list_location_s.Add((Object)("Saisi"));
 //BA.debugLineNum = 1817;BA.debugLine="list_location_s.Add(\"Paloypoy\")";
_list_location_s.Add((Object)("Paloypoy"));
 //BA.debugLineNum = 1818;BA.debugLine="list_location_s.Add(\"Tigue\")";
_list_location_s.Add((Object)("Tigue"));
 }else if(_position==7) { 
 //BA.debugLineNum = 1820;BA.debugLine="list_location_s.Add(\"Proper\")";
_list_location_s.Add((Object)("Proper"));
 //BA.debugLineNum = 1821;BA.debugLine="list_location_s.Add(\"Tonggo\")";
_list_location_s.Add((Object)("Tonggo"));
 //BA.debugLineNum = 1822;BA.debugLine="list_location_s.Add(\"Iling iling\")";
_list_location_s.Add((Object)("Iling iling"));
 //BA.debugLineNum = 1823;BA.debugLine="list_location_s.Add(\"Campayas\")";
_list_location_s.Add((Object)("Campayas"));
 //BA.debugLineNum = 1824;BA.debugLine="list_location_s.Add(\"Palayan\")";
_list_location_s.Add((Object)("Palayan"));
 //BA.debugLineNum = 1825;BA.debugLine="list_location_s.Add(\"Guia\")";
_list_location_s.Add((Object)("Guia"));
 //BA.debugLineNum = 1826;BA.debugLine="list_location_s.Add(\"An-an\")";
_list_location_s.Add((Object)("An-an"));
 //BA.debugLineNum = 1827;BA.debugLine="list_location_s.Add(\"An-an 2\")";
_list_location_s.Add((Object)("An-an 2"));
 //BA.debugLineNum = 1828;BA.debugLine="list_location_s.Add(\"Sta. rita\")";
_list_location_s.Add((Object)("Sta. rita"));
 //BA.debugLineNum = 1829;BA.debugLine="list_location_s.Add(\"Benedicto\")";
_list_location_s.Add((Object)("Benedicto"));
 //BA.debugLineNum = 1830;BA.debugLine="list_location_s.Add(\"Sta. cruz/ bunggol\")";
_list_location_s.Add((Object)("Sta. cruz/ bunggol"));
 //BA.debugLineNum = 1831;BA.debugLine="list_location_s.Add(\"Olalia\")";
_list_location_s.Add((Object)("Olalia"));
 //BA.debugLineNum = 1832;BA.debugLine="list_location_s.Add(\"Banuyo\")";
_list_location_s.Add((Object)("Banuyo"));
 //BA.debugLineNum = 1833;BA.debugLine="list_location_s.Add(\"Carmen\")";
_list_location_s.Add((Object)("Carmen"));
 //BA.debugLineNum = 1834;BA.debugLine="list_location_s.Add(\"Riverside\")";
_list_location_s.Add((Object)("Riverside"));
 }else if(_position==8) { 
 //BA.debugLineNum = 1836;BA.debugLine="list_location_s.Add(\"Balangga-an\")";
_list_location_s.Add((Object)("Balangga-an"));
 //BA.debugLineNum = 1837;BA.debugLine="list_location_s.Add(\"Proper\")";
_list_location_s.Add((Object)("Proper"));
 //BA.debugLineNum = 1838;BA.debugLine="list_location_s.Add(\"Proper\")";
_list_location_s.Add((Object)("Proper"));
 //BA.debugLineNum = 1839;BA.debugLine="list_location_s.Add(\"Ruiz\")";
_list_location_s.Add((Object)("Ruiz"));
 //BA.debugLineNum = 1840;BA.debugLine="list_location_s.Add(\"Bakyas\")";
_list_location_s.Add((Object)("Bakyas"));
 }else if(_position==9) { 
 //BA.debugLineNum = 1842;BA.debugLine="list_location_s.Add(\"Cunalom\")";
_list_location_s.Add((Object)("Cunalom"));
 //BA.debugLineNum = 1843;BA.debugLine="list_location_s.Add(\"Tara\")";
_list_location_s.Add((Object)("Tara"));
 //BA.debugLineNum = 1844;BA.debugLine="list_location_s.Add(\"Proper\")";
_list_location_s.Add((Object)("Proper"));
 //BA.debugLineNum = 1845;BA.debugLine="list_location_s.Add(\"Casipungan\")";
_list_location_s.Add((Object)("Casipungan"));
 //BA.debugLineNum = 1846;BA.debugLine="list_location_s.Add(\"Carmen\")";
_list_location_s.Add((Object)("Carmen"));
 //BA.debugLineNum = 1847;BA.debugLine="list_location_s.Add(\"Lanipga\")";
_list_location_s.Add((Object)("Lanipga"));
 //BA.debugLineNum = 1848;BA.debugLine="list_location_s.Add(\"Bulod\")";
_list_location_s.Add((Object)("Bulod"));
 //BA.debugLineNum = 1849;BA.debugLine="list_location_s.Add(\"Bonton\")";
_list_location_s.Add((Object)("Bonton"));
 //BA.debugLineNum = 1850;BA.debugLine="list_location_s.Add(\"Poblador\")";
_list_location_s.Add((Object)("Poblador"));
 }else if(_position==10) { 
 //BA.debugLineNum = 1852;BA.debugLine="list_location_s.Add(\"Ruiz\")";
_list_location_s.Add((Object)("Ruiz"));
 //BA.debugLineNum = 1853;BA.debugLine="list_location_s.Add(\"Balisong\")";
_list_location_s.Add((Object)("Balisong"));
 //BA.debugLineNum = 1854;BA.debugLine="list_location_s.Add(\"Purok 1\")";
_list_location_s.Add((Object)("Purok 1"));
 //BA.debugLineNum = 1855;BA.debugLine="list_location_s.Add(\"Purok 2\")";
_list_location_s.Add((Object)("Purok 2"));
 //BA.debugLineNum = 1856;BA.debugLine="list_location_s.Add(\"Purok 3\")";
_list_location_s.Add((Object)("Purok 3"));
 //BA.debugLineNum = 1857;BA.debugLine="list_location_s.Add(\"Purok 4\")";
_list_location_s.Add((Object)("Purok 4"));
 //BA.debugLineNum = 1858;BA.debugLine="list_location_s.Add(\"Dubdub\")";
_list_location_s.Add((Object)("Dubdub"));
 //BA.debugLineNum = 1859;BA.debugLine="list_location_s.Add(\"Hda. San jose valing\")";
_list_location_s.Add((Object)("Hda. San jose valing"));
 }else if(_position==11) { 
 //BA.debugLineNum = 1861;BA.debugLine="list_location_s.Add(\"Acapulco\")";
_list_location_s.Add((Object)("Acapulco"));
 //BA.debugLineNum = 1862;BA.debugLine="list_location_s.Add(\"Liki\")";
_list_location_s.Add((Object)("Liki"));
 //BA.debugLineNum = 1863;BA.debugLine="list_location_s.Add(\"500\")";
_list_location_s.Add((Object)("500"));
 //BA.debugLineNum = 1864;BA.debugLine="list_location_s.Add(\"Aglatong\")";
_list_location_s.Add((Object)("Aglatong"));
 //BA.debugLineNum = 1865;BA.debugLine="list_location_s.Add(\"Proper\")";
_list_location_s.Add((Object)("Proper"));
 //BA.debugLineNum = 1866;BA.debugLine="list_location_s.Add(\"Baptist\")";
_list_location_s.Add((Object)("Baptist"));
 }else if(_position==12) { 
 //BA.debugLineNum = 1868;BA.debugLine="list_location_s.Add(\"Lizares\")";
_list_location_s.Add((Object)("Lizares"));
 //BA.debugLineNum = 1869;BA.debugLine="list_location_s.Add(\"Pakol\")";
_list_location_s.Add((Object)("Pakol"));
 //BA.debugLineNum = 1870;BA.debugLine="list_location_s.Add(\"Proper\")";
_list_location_s.Add((Object)("Proper"));
 //BA.debugLineNum = 1871;BA.debugLine="list_location_s.Add(\"Lanete\")";
_list_location_s.Add((Object)("Lanete"));
 //BA.debugLineNum = 1872;BA.debugLine="list_location_s.Add(\"Kasoy\")";
_list_location_s.Add((Object)("Kasoy"));
 //BA.debugLineNum = 1873;BA.debugLine="list_location_s.Add(\"Bato\")";
_list_location_s.Add((Object)("Bato"));
 //BA.debugLineNum = 1874;BA.debugLine="list_location_s.Add(\"Frande\")";
_list_location_s.Add((Object)("Frande"));
 //BA.debugLineNum = 1875;BA.debugLine="list_location_s.Add(\"Bajay\")";
_list_location_s.Add((Object)("Bajay"));
 //BA.debugLineNum = 1876;BA.debugLine="list_location_s.Add(\"Poblador\")";
_list_location_s.Add((Object)("Poblador"));
 //BA.debugLineNum = 1877;BA.debugLine="list_location_s.Add(\"Culban\")";
_list_location_s.Add((Object)("Culban"));
 //BA.debugLineNum = 1878;BA.debugLine="list_location_s.Add(\"Calansi\")";
_list_location_s.Add((Object)("Calansi"));
 //BA.debugLineNum = 1879;BA.debugLine="list_location_s.Add(\"Carmen\")";
_list_location_s.Add((Object)("Carmen"));
 //BA.debugLineNum = 1880;BA.debugLine="list_location_s.Add(\"Dama\")";
_list_location_s.Add((Object)("Dama"));
 }else if(_position==13) { 
 //BA.debugLineNum = 1882;BA.debugLine="list_location_s.Add(\"Purok 1\")";
_list_location_s.Add((Object)("Purok 1"));
 //BA.debugLineNum = 1883;BA.debugLine="list_location_s.Add(\"Purok 2\")";
_list_location_s.Add((Object)("Purok 2"));
 //BA.debugLineNum = 1884;BA.debugLine="list_location_s.Add(\"Purok 3\")";
_list_location_s.Add((Object)("Purok 3"));
 //BA.debugLineNum = 1885;BA.debugLine="list_location_s.Add(\"Purok 4\")";
_list_location_s.Add((Object)("Purok 4"));
 //BA.debugLineNum = 1886;BA.debugLine="list_location_s.Add(\"Purok 5\")";
_list_location_s.Add((Object)("Purok 5"));
 //BA.debugLineNum = 1887;BA.debugLine="list_location_s.Add(\"Purok 6\")";
_list_location_s.Add((Object)("Purok 6"));
 }else if(_position==14) { 
 //BA.debugLineNum = 1889;BA.debugLine="list_location_s.Add(\"Proper\")";
_list_location_s.Add((Object)("Proper"));
 //BA.debugLineNum = 1890;BA.debugLine="list_location_s.Add(\"Calubihan\")";
_list_location_s.Add((Object)("Calubihan"));
 //BA.debugLineNum = 1891;BA.debugLine="list_location_s.Add(\"Mapulang duta\")";
_list_location_s.Add((Object)("Mapulang duta"));
 //BA.debugLineNum = 1892;BA.debugLine="list_location_s.Add(\"Abud\")";
_list_location_s.Add((Object)("Abud"));
 //BA.debugLineNum = 1893;BA.debugLine="list_location_s.Add(\"Molo\")";
_list_location_s.Add((Object)("Molo"));
 //BA.debugLineNum = 1894;BA.debugLine="list_location_s.Add(\"Balabag\")";
_list_location_s.Add((Object)("Balabag"));
 //BA.debugLineNum = 1895;BA.debugLine="list_location_s.Add(\"Pandan\")";
_list_location_s.Add((Object)("Pandan"));
 //BA.debugLineNum = 1896;BA.debugLine="list_location_s.Add(\"Nahulop\")";
_list_location_s.Add((Object)("Nahulop"));
 //BA.debugLineNum = 1897;BA.debugLine="list_location_s.Add(\"Cubay\")";
_list_location_s.Add((Object)("Cubay"));
 //BA.debugLineNum = 1898;BA.debugLine="list_location_s.Add(\"Aglaoa\")";
_list_location_s.Add((Object)("Aglaoa"));
 }else if(_position==15) { 
 //BA.debugLineNum = 1900;BA.debugLine="list_location_s.Add(\"Purok 1\")";
_list_location_s.Add((Object)("Purok 1"));
 //BA.debugLineNum = 1901;BA.debugLine="list_location_s.Add(\"Purok 2\")";
_list_location_s.Add((Object)("Purok 2"));
 //BA.debugLineNum = 1902;BA.debugLine="list_location_s.Add(\"Purok 3\")";
_list_location_s.Add((Object)("Purok 3"));
 //BA.debugLineNum = 1903;BA.debugLine="list_location_s.Add(\"Purok 4\")";
_list_location_s.Add((Object)("Purok 4"));
 }else if(_position==16) { 
 //BA.debugLineNum = 1905;BA.debugLine="list_location_s.Add(\"ORS\")";
_list_location_s.Add((Object)("ORS"));
 //BA.debugLineNum = 1906;BA.debugLine="list_location_s.Add(\"Aloe vera\")";
_list_location_s.Add((Object)("Aloe vera"));
 //BA.debugLineNum = 1907;BA.debugLine="list_location_s.Add(\"SCAD\")";
_list_location_s.Add((Object)("SCAD"));
 //BA.debugLineNum = 1908;BA.debugLine="list_location_s.Add(\"Proper\")";
_list_location_s.Add((Object)("Proper"));
 //BA.debugLineNum = 1909;BA.debugLine="list_location_s.Add(\"Sampaguita\")";
_list_location_s.Add((Object)("Sampaguita"));
 //BA.debugLineNum = 1910;BA.debugLine="list_location_s.Add(\"Bonguinvilla\")";
_list_location_s.Add((Object)("Bonguinvilla"));
 //BA.debugLineNum = 1911;BA.debugLine="list_location_s.Add(\"Cagay\")";
_list_location_s.Add((Object)("Cagay"));
 //BA.debugLineNum = 1912;BA.debugLine="list_location_s.Add(\"Naga\")";
_list_location_s.Add((Object)("Naga"));
 }else if(_position==17) { 
 //BA.debugLineNum = 1914;BA.debugLine="list_location_s.Add(\"Hda. Naval\")";
_list_location_s.Add((Object)("Hda. Naval"));
 //BA.debugLineNum = 1915;BA.debugLine="list_location_s.Add(\"Antipolo\")";
_list_location_s.Add((Object)("Antipolo"));
 //BA.debugLineNum = 1916;BA.debugLine="list_location_s.Add(\"Rizal st.\")";
_list_location_s.Add((Object)("Rizal st."));
 //BA.debugLineNum = 1917;BA.debugLine="list_location_s.Add(\"Punta talaban\")";
_list_location_s.Add((Object)("Punta talaban"));
 //BA.debugLineNum = 1918;BA.debugLine="list_location_s.Add(\"Batang guwaan\")";
_list_location_s.Add((Object)("Batang guwaan"));
 //BA.debugLineNum = 1919;BA.debugLine="list_location_s.Add(\"Batang sulod\")";
_list_location_s.Add((Object)("Batang sulod"));
 //BA.debugLineNum = 1920;BA.debugLine="list_location_s.Add(\"Mabini st.\")";
_list_location_s.Add((Object)("Mabini st."));
 //BA.debugLineNum = 1921;BA.debugLine="list_location_s.Add(\"Cubay\")";
_list_location_s.Add((Object)("Cubay"));
 //BA.debugLineNum = 1922;BA.debugLine="list_location_s.Add(\"Hacienda silos\")";
_list_location_s.Add((Object)("Hacienda silos"));
 //BA.debugLineNum = 1923;BA.debugLine="list_location_s.Add(\"Lopez jeana 1\")";
_list_location_s.Add((Object)("Lopez jeana 1"));
 //BA.debugLineNum = 1924;BA.debugLine="list_location_s.Add(\"Lopez jeana 2\")";
_list_location_s.Add((Object)("Lopez jeana 2"));
 }else if(_position==18) { 
 //BA.debugLineNum = 1926;BA.debugLine="list_location_s.Add(\"Ilawod\")";
_list_location_s.Add((Object)("Ilawod"));
 //BA.debugLineNum = 1927;BA.debugLine="list_location_s.Add(\"Buhian\")";
_list_location_s.Add((Object)("Buhian"));
 //BA.debugLineNum = 1928;BA.debugLine="list_location_s.Add(\"Proper\")";
_list_location_s.Add((Object)("Proper"));
 //BA.debugLineNum = 1929;BA.debugLine="list_location_s.Add(\"Mambato\")";
_list_location_s.Add((Object)("Mambato"));
 };
 //BA.debugLineNum = 1932;BA.debugLine="brgy_index = Position";
_brgy_index = _position;
 //BA.debugLineNum = 1933;BA.debugLine="location_spin_street.AddAll(list_location_s)";
mostCurrent._location_spin_street.AddAll(_list_location_s);
...
mostCurrent._all_info_query._initialize(processBA,"all_info_query",menu_form.getObject());
 //BA.debugLineNum = 295;BA.debugLine="all_users_info = url_back.php_email_url(\"/bloodli";
...
anywheresoftware.b4a.objects.ImageViewWrapper _img_isdonated = null;
 //BA.debugLineNum = 562;BA.debugLine="Sub profiled_Click";
 //BA.debugLineNum = 564;BA.debugLine="profile_panel.Initialize(\"profile_panel\")";
mostCurrent._profile_panel.Initialize(mostCurrent.activityBA,"profile_panel");
 //BA.debugLineNum = 566;BA.debugLine="profile_panel.SetBackgroundImage(LoadBitmap(File";
...
_img_fulln.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"glyphicons-4-user.png").getObject()));
 //BA.debugLineNum = 595;BA.debugLine="img_blood_sel.SetBackgroundImage(LoadBitmap(Fil";
_img_blood_sel.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"glyphicons-93-tint.png").getObject()));
 //BA.debugLineNum = 596;BA.debugLine="img_email.SetBackgroundImage(LoadBitmap(File.Di";
_img_email.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"glyphicons-social-40-e-mail.png").getObject()));
 //BA.debugLineNum = 597;BA.debugLine="img_phone1.SetBackgroundImage(LoadBitmap(File.D";
_img_phone1.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"glyphicons-354-nameplate-alt1.png").getObject()));
 //BA.debugLineNum = 598;BA.debugLine="img_phone2.SetBackgroundImage(LoadBitmap(File.D";
_img_phone2.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"glyphicons-354-nameplate-alt2.png").getObject()));
 //BA.debugLineNum = 599;BA.debugLine="img_location.SetBackgroundImage(LoadBitmap(File";
_img_location.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"glyphicons-21-home.png").getObject()));
 //BA.debugLineNum = 600;BA.debugLine="img_bday.SetBackgroundImage(LoadBitmap(File.Dir";
_img_bday.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"glyphicons-40-notes.png").getObject()));
 //BA.debugLineNum = 601;BA.debugLine="img_nickN.SetBackgroundImage(LoadBitmap(File.Di";
_img_nickn.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"glyphicons-265-vcard.png").getObject()));
 //BA.debugLineNum = 602;BA.debugLine="img_isDonated.SetBackgroundImage(LoadBitmap(Fil";
_img_isdonated.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"glyphicons-91-eyedropper.png").getObject()));
 //BA.debugLineNum = 605;BA.debugLine="profile_panel.AddView(title,0,1%y,90%x,8%y) '";
mostCurrent._profile_panel.AddView((android.view.View)(_title.getObject()),(int) (0),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (90),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 606;BA.debugLine="profile_panel.AddView(img_fullN,5%x, title.Top+t";
mostCurrent._profile_panel.AddView((android.view.View)(_img_fulln.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA),(int) (_title.getTop()+_title.getHeight()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (10),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 607;BA.debugLine="profile_panel.AddView(fullN, img_fullN.Left+img_";
mostCurrent._profile_panel.AddView((android.view.View)(_fulln.getObject()),(int) (_img_fulln.getLeft()+_img_fulln.getWidth()),(int) (_title.getTop()+_title.getHeight()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 609;BA.debugLine="profile_panel.AddView(img_blood_sel,5%x,fullN.To";
mostCurrent._profile_panel.AddView((android.view.View)(_img_blood_sel.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA),(int) (_fulln.getTop()+_fulln.getHeight()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (10),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 610;BA.debugLine="profile_panel.AddView(blood_sel,img_blood_sel.Le";
mostCurrent._profile_panel.AddView((android.view.View)(_blood_sel.getObject()),(int) (_img_blood_sel.getLeft()+_img_blood_sel.getWidth()),_img_blood_sel.getTop(),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (10),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 612;BA.debugLine="profile_panel.AddView(img_email,5%x,img_blood_se";
mostCurrent._profile_panel.AddView((android.view.View)(_img_email.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA),(int) (_img_blood_sel.getTop()+_img_blood_sel.getHeight()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (10),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 613;BA.debugLine="profile_panel.AddView(email,img_email.Left+img_e";
mostCurrent._profile_panel.AddView((android.view.View)(_email.getObject()),(int) (_img_email.getLeft()+_img_email.getWidth()),_img_email.getTop(),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 615;BA.debugLine="profile_panel.AddView(img_phone1,5%x,img_email.T";
mostCurrent._profile_panel.AddView((android.view.View)(_img_phone1.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA),(int) (_img_email.getTop()+_img_email.getHeight()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (10),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 616;BA.debugLine="profile_panel.AddView(phone1,img_phone1.Left+img";
mostCurrent._profile_panel.AddView((android.view.View)(_phone1.getObject()),(int) (_img_phone1.getLeft()+_img_phone1.getWidth()),_img_phone1.getTop(),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 618;BA.debugLine="profile_panel.AddView(img_phone2,5%x,img_phone1.";
mostCurrent._profile_panel.AddView((android.view.View)(_img_phone2.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA),(int) (_img_phone1.getTop()+_img_phone1.getHeight()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (10),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 619;BA.debugLine="profile_panel.AddView(phone2,img_phone2.Left+img";
mostCurrent._profile_panel.AddView((android.view.View)(_phone2.getObject()),(int) (_img_phone2.getLeft()+_img_phone2.getWidth()),_img_phone2.getTop(),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 621;BA.debugLine="profile_panel.AddView(img_location,5%x,img_phone";
mostCurrent._profile_panel.AddView((android.view.View)(_img_location.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA),(int) (_img_phone2.getTop()+_img_phone2.getHeight()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (10),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 622;BA.debugLine="profile_panel.AddView(location,img_location.Left";
mostCurrent._profile_panel.AddView((android.view.View)(_location.getObject()),(int) (_img_location.getLeft()+_img_location.getWidth()),_img_location.getTop(),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 624;BA.debugLine="profile_panel.AddView(img_bday,5%x,img_location.";
mostCurrent._profile_panel.AddView((android.view.View)(_img_bday.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA),(int) (_img_location.getTop()+_img_location.getHeight()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (10),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 625;BA.debugLine="profile_panel.AddView(bday,img_bday.Left+img_bda";
mostCurrent._profile_panel.AddView((android.view.View)(_bday.getObject()),(int) (_img_bday.getLeft()+_img_bday.getWidth()),_img_bday.getTop(),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (10),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 627;BA.debugLine="profile_panel.AddView(img_nickN,5%x,img_bday.Top";
mostCurrent._profile_panel.AddView((android.view.View)(_img_nickn.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA),(int) (_img_bday.getTop()+_img_bday.getHeight()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (10),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 628;BA.debugLine="profile_panel.AddView(nickN,img_nickN.Left+img_n";
mostCurrent._profile_panel.AddView((android.view.View)(_nickn.getObject()),(int) (_img_nickn.getLeft()+_img_nickn.getWidth()),_img_nickn.getTop(),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 630;BA.debugLine="profile_panel.AddView(img_isDonated,5%x,img_nick";
mostCurrent._profile_panel.AddView((android.view.View)(_img_isdonated.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA),(int) (_img_nickn.getTop()+_img_nickn.getHeight()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (10),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 631;BA.debugLine="profile_panel.AddView(isDonated,img_isDonated.Le";
mostCurrent._profile_panel.AddView((android.view.View)(_isdonated.getObject()),(int) (_img_isdonated.getLeft()+_img_isdonated.getWidth()),_img_isdonated.getTop(),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 634;BA.debugLine="scroll_profile_pnl.Panel.AddView(profile_panel,0";
mostCurrent._scroll_profile_pnl.getPanel().AddView((android.view.View)(mostCurrent._profile_panel.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (90),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (90),mostCurrent.activityBA));
 //BA.debugLineNum = 635;BA.debugLine="Activity.AddView(scroll_profile_pnl,5%x,3%y,90%x";
...
anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper _destrect = null;
 //BA.debugLineNum = 521;BA.debugLine="Sub ResizeBitmap(original As Bitmap, width As Int,";
 //BA.debugLineNum = 522;BA.debugLine="Dim new As Bitmap";
_new = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 523;BA.debugLine="new.InitializeMutable(width, height)";
_new.InitializeMutable(_width,_height);
 //BA.debugLineNum = 524;BA.debugLine="Dim c As Canvas";
_c = new anywheresoftware.b4a.objects.drawable.CanvasWrapper();
 //BA.debugLineNum = 525;BA.debugLine="c.Initialize2(new)";
_c.Initialize2((android.graphics.Bitmap)(_new.getObject()));
 //BA.debugLineNum = 526;BA.debugLine="Dim destRect As Rect";
_destrect = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper();
 //BA.debugLineNum = 527;BA.debugLine="destRect.Initialize(0, 0, width, height)";
_destrect.Initialize((int) (0),(int) (0),_width,_height);
 //BA.debugLineNum = 528;BA.debugLine="c.DrawBitmap(original, Null, destRect)";
_c.DrawBitmap((android.graphics.Bitmap)(_original.getObject()),(android.graphics.Rect)(anywheresoftware.b4a.keywords.Common.Null),(android.graphics.Rect)(_destrect.getObject()));
 //BA.debugLineNum = 529;BA.debugLine="Return new";
if (true) return _new;
...
public static String  _spin_bloodgroup_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 1090;BA.debugLine="Sub spin_bloodgroup_ItemClick (Position As Int, Va";
 //BA.debugLineNum = 1091;BA.debugLine="blood_selected = Value";
...
public static String  _spin_day_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 1004;BA.debugLine="Sub spin_day_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 1005;BA.debugLine="bday_day_selected = Value";
_bday_day_selected = BA.ObjectToString(_value);
 //BA.debugLineNum = 1006;BA.debugLine="Log(\"day: \"&Value)";
...
public static String  _spin_donated_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 825;BA.debugLine="Sub spin_donated_ItemClick (Position As Int, Value";
 //BA.debugLineNum = 826;BA.debugLine="Log(Position)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_position));
 //BA.debugLineNum = 827;BA.debugLine="is_donated = Value";
_is_donated = BA.ObjectToString(_value);
 //BA.debugLineNum = 828;BA.debugLine="donated_index = Position";
...
public static String  _spin_gender_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 768;BA.debugLine="Sub spin_gender_ItemClick (Position As Int, Value";
 //BA.debugLineNum = 769;BA.debugLine="is_gender_index = Position";
...
public static String  _spin_month_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 1008;BA.debugLine="Sub spin_month_ItemClick (Position As Int, Value A";
 //BA.debugLineNum = 1009;BA.debugLine="bday_month_selected = Value";
_bday_month_selected = BA.ObjectToString(_value);
 //BA.debugLineNum = 1010;BA.debugLine="Log(\"month: \"&Value)";
...
public static String  _spin_year_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 1012;BA.debugLine="Sub spin_year_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 1013;BA.debugLine="bday_year_selected =  Value";
_bday_year_selected = BA.ObjectToString(_value);
 //BA.debugLineNum = 1014;BA.debugLine="Log(\"year: \"&Value)";
...
public static String  _street_lat_lng() throws Exception{
 //BA.debugLineNum = 1185;BA.debugLine="Sub street_lat_lng";
 //BA.debugLineNum = 1186;BA.debugLine="If brgy_index == 0 And street_index == 0 Then";
if (_brgy_index==0 && _street_index==0) { 
 //BA.debugLineNum = 1187;BA.debugLine="lat = \"10.098014\"";
_lat = "10.098014";
 //BA.debugLineNum = 1188;BA.debugLine="lng = \"122.869168\"";
_lng = "122.869168";
 }else if(_brgy_index==0 && _street_index==1) { 
 //BA.debugLineNum = 1190;BA.debugLine="lat = \"10.097226\"";
_lat = "10.097226";
 //BA.debugLineNum = 1191;BA.debugLine="lng = \"122.870659\"";
_lng = "122.870659";
 }else if(_brgy_index==0 && _street_index==2) { 
 //BA.debugLineNum = 1193;BA.debugLine="lat = \"10.097711\"";
_lat = "10.097711";
 //BA.debugLineNum = 1194;BA.debugLine="lng = \"122.868378\"";
_lng = "122.868378";
 }else if(_brgy_index==0 && _street_index==3) { 
 //BA.debugLineNum = 1196;BA.debugLine="lat = \"10.098293\"";
_lat = "10.098293";
 //BA.debugLineNum = 1197;BA.debugLine="lng = \"122.868977\"";
_lng = "122.868977";
 }else if(_brgy_index==0 && _street_index==4) { 
 //BA.debugLineNum = 1199;BA.debugLine="lat = \"10.097031\"";
_lat = "10.097031";
 //BA.debugLineNum = 1200;BA.debugLine="lng = \"122.868764\"";
_lng = "122.868764";
 }else if(_brgy_index==0 && _street_index==5) { 
 //BA.debugLineNum = 1202;BA.debugLine="lat = \"10.096021\"";
_lat = "10.096021";
 //BA.debugLineNum = 1203;BA.debugLine="lng = \"122.869737\"";
_lng = "122.869737";
 }else if(_brgy_index==0 && _street_index==6) { 
 //BA.debugLineNum = 1205;BA.debugLine="lat = \"10.095142\"";
_lat = "10.095142";
 //BA.debugLineNum = 1206;BA.debugLine="lng = \"122.868317\"";
_lng = "122.868317";
 }else if(_brgy_index==0 && _street_index==7) { 
 //BA.debugLineNum = 1208;BA.debugLine="lat = \"10.095303\"";
_lat = "10.095303";
 //BA.debugLineNum = 1209;BA.debugLine="lng = \"122.869509\"";
_lng = "122.869509";
 };
 //BA.debugLineNum = 1212;BA.debugLine="If brgy_index == 1 And street_index == 0 Then 'br";
if (_brgy_index==1 && _street_index==0) { 
 //BA.debugLineNum = 1213;BA.debugLine="lat = \"10.101356\"";
_lat = "10.101356";
 //BA.debugLineNum = 1214;BA.debugLine="lng = \"122.870075\"";
_lng = "122.870075";
 }else if(_brgy_index==1 && _street_index==1) { 
 //BA.debugLineNum = 1216;BA.debugLine="lat = \"10.100583\"";
_lat = "10.100583";
 //BA.debugLineNum = 1217;BA.debugLine="lng = \"122.870176\"";
_lng = "122.870176";
 }else if(_brgy_index==1 && _street_index==2) { 
 //BA.debugLineNum = 1219;BA.debugLine="lat = \"10.100031\"";
_lat = "10.100031";
 //BA.debugLineNum = 1220;BA.debugLine="lng = \"122.870623\"";
_lng = "122.870623";
 }else if(_brgy_index==1 && _street_index==3) { 
 //BA.debugLineNum = 1222;BA.debugLine="lat = \"10.101327\"";
_lat = "10.101327";
 //BA.debugLineNum = 1223;BA.debugLine="lng = \"122.871177\"";
_lng = "122.871177";
 }else if(_brgy_index==1 && _street_index==4) { 
 //BA.debugLineNum = 1225;BA.debugLine="lat = \"10.103330\"";
_lat = "10.103330";
 //BA.debugLineNum = 1226;BA.debugLine="lng = \"122.871391\"";
_lng = "122.871391";
 }else if(_brgy_index==1 && _street_index==5) { 
 //BA.debugLineNum = 1228;BA.debugLine="lat = \"10.102317\"";
_lat = "10.102317";
 //BA.debugLineNum = 1229;BA.debugLine="lng = \"122.870755\"";
_lng = "122.870755";
 }else if(_brgy_index==1 && _street_index==6) { 
 //BA.debugLineNum = 1231;BA.debugLine="lat = \"10.104250\"";
_lat = "10.104250";
 //BA.debugLineNum = 1232;BA.debugLine="lng = \"122.882834\"";
_lng = "122.882834";
 }else if(_brgy_index==1 && _street_index==7) { 
 //BA.debugLineNum = 1234;BA.debugLine="lat = \"10.104943\"";
_lat = "10.104943";
 //BA.debugLineNum = 1235;BA.debugLine="lng = \"122.885207\"";
_lng = "122.885207";
 }else if(_brgy_index==1 && _street_index==8) { 
 //BA.debugLineNum = 1237;BA.debugLine="lat = \"10.101843\"";
_lat = "10.101843";
 //BA.debugLineNum = 1238;BA.debugLine="lng = \"122.871020\"";
_lng = "122.871020";
 }else if(_brgy_index==1 && _street_index==9) { 
 //BA.debugLineNum = 1240;BA.debugLine="lat = \"10.103477\"";
_lat = "10.103477";
 //BA.debugLineNum = 1241;BA.debugLine="lng = \"122.870042\"";
_lng = "122.870042";
 }else if(_brgy_index==1 && _street_index==10) { 
 //BA.debugLineNum = 1243;BA.debugLine="lat = \"10.100710\"";
_lat = "10.100710";
 //BA.debugLineNum = 1244;BA.debugLine="lng = \"122.870889\"";
_lng = "122.870889";
 };
 //BA.debugLineNum = 1247;BA.debugLine="If brgy_index == 2 And street_index == 0 Then 'br";
if (_brgy_index==2 && _street_index==0) { 
 //BA.debugLineNum = 1248;BA.debugLine="lat = \"10.095478\"";
_lat = "10.095478";
 //BA.debugLineNum = 1249;BA.debugLine="lng = \"122.871176\"";
_lng = "122.871176";
 }else if(_brgy_index==2 && _street_index==1) { 
 //BA.debugLineNum = 1251;BA.debugLine="lat = \"10.098599\"";
_lat = "10.098599";
 //BA.debugLineNum = 1252;BA.debugLine="lng = \"122.871761\"";
_lng = "122.871761";
 }else if(_brgy_index==2 && _street_index==2) { 
 //BA.debugLineNum = 1254;BA.debugLine="lat = \"10.094573\"";
_lat = "10.094573";
 //BA.debugLineNum = 1255;BA.debugLine="lng = \"122.870340\"";
_lng = "122.870340";
 }else if(_brgy_index==2 && _street_index==3) { 
 //BA.debugLineNum = 1257;BA.debugLine="lat = \"10.098313\"";
_lat = "10.098313";
 //BA.debugLineNum = 1258;BA.debugLine="lng = \"122.875223\"";
_lng = "122.875223";
 }else if(_brgy_index==2 && _street_index==4) { 
 //BA.debugLineNum = 1260;BA.debugLine="lat = \"10.092235\"";
_lat = "10.092235";
 //BA.debugLineNum = 1261;BA.debugLine="lng = \"122.874356\"";
_lng = "122.874356";
 }else if(_brgy_index==2 && _street_index==5) { 
 //BA.debugLineNum = 1263;BA.debugLine="lat = \"10.103982\"";
_lat = "10.103982";
 //BA.debugLineNum = 1264;BA.debugLine="lng = \"122.885996\"";
_lng = "122.885996";
 }else if(_brgy_index==2 && _street_index==6) { 
 //BA.debugLineNum = 1266;BA.debugLine="lat = \"10.102170\"";
_lat = "10.102170";
 //BA.debugLineNum = 1267;BA.debugLine="lng = \"122.882390\"";
_lng = "122.882390";
 }else if(_brgy_index==2 && _street_index==7) { 
 //BA.debugLineNum = 1269;BA.debugLine="lat = \"10.103272\"";
_lat = "10.103272";
 //BA.debugLineNum = 1270;BA.debugLine="lng = \"122.883948\"";
_lng = "122.883948";
 }else if(_brgy_index==2 && _street_index==8) { 
 //BA.debugLineNum = 1272;BA.debugLine="lat = \"10.103849\"";
_lat = "10.103849";
 //BA.debugLineNum = 1273;BA.debugLine="lng = \"122.884602\"";
_lng = "122.884602";
 }else if(_brgy_index==2 && _street_index==9) { 
 //BA.debugLineNum = 1275;BA.debugLine="lat = \"10.101033\"";
_lat = "10.101033";
 //BA.debugLineNum = 1276;BA.debugLine="lng = \"122.874480\"";
_lng = "122.874480";
 };
 //BA.debugLineNum = 1279;BA.debugLine="If brgy_index == 3 And street_index == 0 Then 'b";
if (_brgy_index==3 && _street_index==0) { 
 //BA.debugLineNum = 1280;BA.debugLine="lat = \"10.121855\"";
_lat = "10.121855";
 //BA.debugLineNum = 1281;BA.debugLine="lng = \"122.872266\"";
_lng = "122.872266";
 }else if(_brgy_index==3 && _street_index==1) { 
 //BA.debugLineNum = 1283;BA.debugLine="lat = \"10.116699\"";
_lat = "10.116699";
 //BA.debugLineNum = 1284;BA.debugLine="lng = \"122.871783\"";
_lng = "122.871783";
 }else if(_brgy_index==3 && _street_index==2) { 
 //BA.debugLineNum = 1286;BA.debugLine="lat = \"10.116024\"";
_lat = "10.116024";
 //BA.debugLineNum = 1287;BA.debugLine="lng = \"122.872477\"";
_lng = "122.872477";
 }else if(_brgy_index==3 && _street_index==3) { 
 //BA.debugLineNum = 1289;BA.debugLine="lat = \"10.114588\"";
_lat = "10.114588";
 //BA.debugLineNum = 1290;BA.debugLine="lng = \"122.872515\"";
_lng = "122.872515";
 }else if(_brgy_index==3 && _street_index==4) { 
 //BA.debugLineNum = 1292;BA.debugLine="lat = \"10.112140\"";
_lat = "10.112140";
 //BA.debugLineNum = 1293;BA.debugLine="lng = \"122.872161\"";
_lng = "122.872161";
 }else if(_brgy_index==3 && _street_index==5) { 
 //BA.debugLineNum = 1295;BA.debugLine="lat = \"10.111531\"";
_lat = "10.111531";
 //BA.debugLineNum = 1296;BA.debugLine="lng = \"122.871542\"";
_lng = "122.871542";
 }else if(_brgy_index==3 && _street_index==6) { 
 //BA.debugLineNum = 1298;BA.debugLine="lat = \"10.107168\"";
_lat = "10.107168";
 //BA.debugLineNum = 1299;BA.debugLine="lng = \"122.871766\"";
_lng = "122.871766";
 }else if(_brgy_index==3 && _street_index==7) { 
 //BA.debugLineNum = 1301;BA.debugLine="lat = \"10.106570\"";
_lat = "10.106570";
 //BA.debugLineNum = 1302;BA.debugLine="lng = \"122.875197\"";
_lng = "122.875197";
 }else if(_brgy_index==3 && _street_index==8) { 
 //BA.debugLineNum = 1304;BA.debugLine="lat = \"10.105759\"";
_lat = "10.105759";
 //BA.debugLineNum = 1305;BA.debugLine="lng = \"122.871537\"";
_lng = "122.871537";
 };
 //BA.debugLineNum = 1308;BA.debugLine="If brgy_index == 4 And street_index == 0 Then 'A";
if (_brgy_index==4 && _street_index==0) { 
 //BA.debugLineNum = 1309;BA.debugLine="lat = \"10.165214\"";
_lat = "10.165214";
 //BA.debugLineNum = 1310;BA.debugLine="lng = \"122.865433\"";
_lng = "122.865433";
 }else if(_brgy_index==4 && _street_index==1) { 
 //BA.debugLineNum = 1312;BA.debugLine="lat = \"10.154170\"";
_lat = "10.154170";
 //BA.debugLineNum = 1313;BA.debugLine="lng = \"122.867255\"";
_lng = "122.867255";
 }else if(_brgy_index==4 && _street_index==2) { 
 //BA.debugLineNum = 1315;BA.debugLine="lat = \"10.161405\"";
_lat = "10.161405";
 //BA.debugLineNum = 1316;BA.debugLine="lng = \"122.862692\"";
_lng = "122.862692";
 }else if(_brgy_index==4 && _street_index==3) { 
 //BA.debugLineNum = 1318;BA.debugLine="lat = \"10.168471\"";
_lat = "10.168471";
 //BA.debugLineNum = 1319;BA.debugLine="lng = \"122.860955\"";
_lng = "122.860955";
 }else if(_brgy_index==4 && _street_index==4) { 
 //BA.debugLineNum = 1321;BA.debugLine="lat = \"10.172481\"";
_lat = "10.172481";
 //BA.debugLineNum = 1322;BA.debugLine="lng = \"122.858629\"";
_lng = "122.858629";
 }else if(_brgy_index==4 && _street_index==5) { 
 //BA.debugLineNum = 1324;BA.debugLine="lat = \"10.166561\"";
_lat = "10.166561";
 //BA.debugLineNum = 1325;BA.debugLine="lng = \"122.859428\"";
_lng = "122.859428";
 }else if(_brgy_index==4 && _street_index==6) { 
 //BA.debugLineNum = 1327;BA.debugLine="lat = \"10.163510\"";
_lat = "10.163510";
 //BA.debugLineNum = 1328;BA.debugLine="lng = \"122.860074\"";
_lng = "122.860074";
 }else if(_brgy_index==4 && _street_index==7) { 
 //BA.debugLineNum = 1330;BA.debugLine="lat = \"10.161033\"";
_lat = "10.161033";
 //BA.debugLineNum = 1331;BA.debugLine="lng = \"122.859773\"";
_lng = "122.859773";
 }else if(_brgy_index==4 && _street_index==8) { 
 //BA.debugLineNum = 1333;BA.debugLine="lat = \"10.159280\"";
_lat = "10.159280";
 //BA.debugLineNum = 1334;BA.debugLine="lng = \"122.861621\"";
_lng = "122.861621";
 }else if(_brgy_index==4 && _street_index==9) { 
 //BA.debugLineNum = 1336;BA.debugLine="lat = \"10.159062\"";
_lat = "10.159062";
 //BA.debugLineNum = 1337;BA.debugLine="lng = \"122.860209\"";
_lng = "122.860209";
 }else if(_brgy_index==4 && _street_index==10) { 
 //BA.debugLineNum = 1339;BA.debugLine="lat = \"10.181112\"";
_lat = "10.181112";
 //BA.debugLineNum = 1340;BA.debugLine="lng = \"122.864670\"";
_lng = "122.864670";
 }else if(_brgy_index==4 && _street_index==11) { 
 //BA.debugLineNum = 1342;BA.debugLine="lat = \"10.167295\"";
_lat = "10.167295";
 //BA.debugLineNum = 1343;BA.debugLine="lng = \"122.857858\"";
_lng = "122.857858";
 };
 //BA.debugLineNum = 1346;BA.debugLine="If brgy_index == 5 And street_index == 0 Then 'ca";
if (_brgy_index==5 && _street_index==0) { 
 //BA.debugLineNum = 1347;BA.debugLine="lat = \"10.092993\"";
_lat = "10.092993";
 //BA.debugLineNum = 1348;BA.debugLine="lng = \"122.861694\"";
_lng = "122.861694";
 }else if(_brgy_index==5 && _street_index==1) { 
 //BA.debugLineNum = 1350;BA.debugLine="lat = \"10.090587\"";
_lat = "10.090587";
 //BA.debugLineNum = 1351;BA.debugLine="lng = \"122.868414\"";
_lng = "122.868414";
 }else if(_brgy_index==5 && _street_index==2) { 
 //BA.debugLineNum = 1353;BA.debugLine="lat = \"10.091551\"";
_lat = "10.091551";
 //BA.debugLineNum = 1354;BA.debugLine="lng = \"122.869249\"";
_lng = "122.869249";
 }else if(_brgy_index==5 && _street_index==3) { 
 //BA.debugLineNum = 1356;BA.debugLine="lat = \"10.086452\"";
_lat = "10.086452";
 //BA.debugLineNum = 1357;BA.debugLine="lng = \"122.865742\"";
_lng = "122.865742";
 }else if(_brgy_index==5 && _street_index==4) { 
 //BA.debugLineNum = 1359;BA.debugLine="lat = \"10.083507\"";
_lat = "10.083507";
 //BA.debugLineNum = 1360;BA.debugLine="lng = \"122.858928\"";
_lng = "122.858928";
 }else if(_brgy_index==5 && _street_index==5) { 
 //BA.debugLineNum = 1362;BA.debugLine="lat = \"10.077131\"";
_lat = "10.077131";
 //BA.debugLineNum = 1363;BA.debugLine="lng = \"122.864236\"";
_lng = "122.864236";
 }else if(_brgy_index==5 && _street_index==6) { 
 //BA.debugLineNum = 1365;BA.debugLine="lat = \"10.081722\"";
_lat = "10.081722";
 //BA.debugLineNum = 1366;BA.debugLine="lng = \"122.882661\"";
_lng = "122.882661";
 }else if(_brgy_index==5 && _street_index==7) { 
 //BA.debugLineNum = 1368;BA.debugLine="lat = \"10.081822\"";
_lat = "10.081822";
 //BA.debugLineNum = 1369;BA.debugLine="lng = \"122.868295\"";
_lng = "122.868295";
 }else if(_brgy_index==5 && _street_index==8) { 
 //BA.debugLineNum = 1371;BA.debugLine="lat = \"10.079513\"";
_lat = "10.079513";
 //BA.debugLineNum = 1372;BA.debugLine="lng = \"122.876610\"";
_lng = "122.876610";
 }else if(_brgy_index==5 && _street_index==9) { 
 //BA.debugLineNum = 1374;BA.debugLine="lat = \"10.068560\"";
_lat = "10.068560";
 //BA.debugLineNum = 1375;BA.debugLine="lng = \"122.887366\"";
_lng = "122.887366";
 }else if(_brgy_index==5 && _street_index==10) { 
 //BA.debugLineNum = 1377;BA.debugLine="lat = \"10.066934\"";
_lat = "10.066934";
 //BA.debugLineNum = 1378;BA.debugLine="lng = \"122.871963\"";
_lng = "122.871963";
 }else if(_brgy_index==5 && _street_index==11) { 
 //BA.debugLineNum = 1380;BA.debugLine="lat = \"10.064251\"";
_lat = "10.064251";
 //BA.debugLineNum = 1381;BA.debugLine="lng = \"122.883023\"";
_lng = "122.883023";
 }else if(_brgy_index==5 && _street_index==12) { 
 //BA.debugLineNum = 1383;BA.debugLine="lat = \"10.058546\"";
_lat = "10.058546";
 //BA.debugLineNum = 1384;BA.debugLine="lng = \"122.882968\"";
_lng = "122.882968";
 }else if(_brgy_index==5 && _street_index==13) { 
 //BA.debugLineNum = 1386;BA.debugLine="lat = \"10.054104\"";
_lat = "10.054104";
 //BA.debugLineNum = 1387;BA.debugLine="lng = \"122.885506\"";
_lng = "122.885506";
 }else if(_brgy_index==5 && _street_index==14) { 
 //BA.debugLineNum = 1389;BA.debugLine="lat = \"10.049464\"";
_lat = "10.049464";
 //BA.debugLineNum = 1390;BA.debugLine="lng = \"122.885667\"";
_lng = "122.885667";
 }else if(_brgy_index==5 && _street_index==15) { 
 //BA.debugLineNum = 1392;BA.debugLine="lat = \"10.041580\"";
_lat = "10.041580";
 //BA.debugLineNum = 1393;BA.debugLine="lng = \"122.900269\"";
_lng = "122.900269";
 }else if(_brgy_index==5 && _street_index==16) { 
 //BA.debugLineNum = 1395;BA.debugLine="lat = \"10.041395\"";
_lat = "10.041395";
 //BA.debugLineNum = 1396;BA.debugLine="lng = \"122.906248\"";
_lng = "122.906248";
 };
 //BA.debugLineNum = 1399;BA.debugLine="If brgy_index == 6 And street_index == 0 Then 'Bu";
if (_brgy_index==6 && _street_index==0) { 
 //BA.debugLineNum = 1400;BA.debugLine="lat = \"10.035728\"";
_lat = "10.035728";
 //BA.debugLineNum = 1401;BA.debugLine="lng = \"122.847547\"";
_lng = "122.847547";
 }else if(_brgy_index==6 && _street_index==1) { 
 //BA.debugLineNum = 1403;BA.debugLine="lat = \"10.000603\"";
_lat = "10.000603";
 //BA.debugLineNum = 1404;BA.debugLine="lng = \"122.885243\"";
_lng = "122.885243";
 }else if(_brgy_index==6 && _street_index==2) { 
 //BA.debugLineNum = 1406;BA.debugLine="lat = \"10.000521\"";
_lat = "10.000521";
 //BA.debugLineNum = 1407;BA.debugLine="lng = \"122.895867\"";
_lng = "122.895867";
 }else if(_brgy_index==6 && _street_index==3) { 
 //BA.debugLineNum = 1409;BA.debugLine="lat = \"9.943276\"";
_lat = "9.943276";
 //BA.debugLineNum = 1410;BA.debugLine="lng = \"122.975801\"";
_lng = "122.975801";
 };
 //BA.debugLineNum = 1413;BA.debugLine="If brgy_index == 7 And street_index == 0 Then '";
if (_brgy_index==7 && _street_index==0) { 
 //BA.debugLineNum = 1414;BA.debugLine="lat = \"10.156301\"";
_lat = "10.156301";
 //BA.debugLineNum = 1415;BA.debugLine="lng = \"122.941207\"";
_lng = "122.941207";
 }else if(_brgy_index==7 && _street_index==1) { 
 //BA.debugLineNum = 1417;BA.debugLine="lat = \"10.142692\"";
_lat = "10.142692";
 //BA.debugLineNum = 1418;BA.debugLine="lng = \"122.947560\"";
_lng = "122.947560";
 }else if(_brgy_index==7 && _street_index==2) { 
 //BA.debugLineNum = 1420;BA.debugLine="lat = \"10.139494\"";
_lat = "10.139494";
 //BA.debugLineNum = 1421;BA.debugLine="lng = \"122.942788\"";
_lng = "122.942788";
 }else if(_brgy_index==7 && _street_index==3) { 
 //BA.debugLineNum = 1423;BA.debugLine="lat = \"10.110265\"";
_lat = "10.110265";
 //BA.debugLineNum = 1424;BA.debugLine="lng = \"122.947908\"";
_lng = "122.947908";
 }else if(_brgy_index==7 && _street_index==4) { 
 //BA.debugLineNum = 1426;BA.debugLine="lat = \"10.127828\"";
_lat = "10.127828";
 //BA.debugLineNum = 1427;BA.debugLine="lng = \"122.950197\"";
_lng = "122.950197";
 }else if(_brgy_index==7 && _street_index==5) { 
 //BA.debugLineNum = 1429;BA.debugLine="lat = \"10.125287\"";
_lat = "10.125287";
 //BA.debugLineNum = 1430;BA.debugLine="lng = \"122.945735\"";
_lng = "122.945735";
 }else if(_brgy_index==7 && _street_index==6) { 
 //BA.debugLineNum = 1432;BA.debugLine="lat = \"10.143975\"";
_lat = "10.143975";
 //BA.debugLineNum = 1433;BA.debugLine="lng = \"122.930610\"";
_lng = "122.930610";
 }else if(_brgy_index==7 && _street_index==7) { 
 //BA.debugLineNum = 1435;BA.debugLine="lat = \"10.137563\"";
_lat = "10.137563";
 //BA.debugLineNum = 1436;BA.debugLine="lng = \"122.939870\"";
_lng = "122.939870";
 }else if(_brgy_index==7 && _street_index==8) { 
 //BA.debugLineNum = 1438;BA.debugLine="lat = \"10.150449\"";
_lat = "10.150449";
 //BA.debugLineNum = 1439;BA.debugLine="lng = \"122.933761\"";
_lng = "122.933761";
 }else if(_brgy_index==7 && _street_index==9) { 
 //BA.debugLineNum = 1441;BA.debugLine="lat = \"10.150286\"";
_lat = "10.150286";
 //BA.debugLineNum = 1442;BA.debugLine="lng = \"122.948956\"";
_lng = "122.948956";
 }else if(_brgy_index==7 && _street_index==10) { 
 //BA.debugLineNum = 1444;BA.debugLine="lat = \"10.148481\"";
_lat = "10.148481";
 //BA.debugLineNum = 1445;BA.debugLine="lng = \"122.943230\"";
_lng = "122.943230";
 }else if(_brgy_index==7 && _street_index==11) { 
 //BA.debugLineNum = 1447;BA.debugLine="lat = \"10.106200\"";
_lat = "10.106200";
 //BA.debugLineNum = 1448;BA.debugLine="lng = \"122.948051\"";
_lng = "122.948051";
 }else if(_brgy_index==7 && _street_index==12) { 
 //BA.debugLineNum = 1450;BA.debugLine="lat = \"10.152073\"";
_lat = "10.152073";
 //BA.debugLineNum = 1451;BA.debugLine="lng = \"122.926593\"";
_lng = "122.926593";
 }else if(_brgy_index==7 && _street_index==13) { 
 //BA.debugLineNum = 1453;BA.debugLine="lat = \"10.120798\"";
_lat = "10.120798";
 //BA.debugLineNum = 1454;BA.debugLine="lng = \"122.938371\"";
_lng = "122.938371";
 }else if(_brgy_index==7 && _street_index==14) { 
 //BA.debugLineNum = 1456;BA.debugLine="lat = \"10.153217\"";
_lat = "10.153217";
 //BA.debugLineNum = 1457;BA.debugLine="lng = \"122.951714\"";
_lng = "122.951714";
 };
 //BA.debugLineNum = 1460;BA.debugLine="If brgy_index == 8 And street_index == 0 Then";
if (_brgy_index==8 && _street_index==0) { 
 //BA.debugLineNum = 1461;BA.debugLine="lat = \"10.157177\"";
_lat = "10.157177";
 //BA.debugLineNum = 1462;BA.debugLine="lng = \"122.895986\"";
_lng = "122.895986";
 }else if(_brgy_index==8 && _street_index==1) { 
 //BA.debugLineNum = 1464;BA.debugLine="lat = \"10.180004\"";
_lat = "10.180004";
 //BA.debugLineNum = 1465;BA.debugLine="lng = \"122.897999\"";
_lng = "122.897999";
 }else if(_brgy_index==8 && _street_index==2) { 
 //BA.debugLineNum = 1467;BA.debugLine="lat = \"10.192848\"";
_lat = "10.192848";
 //BA.debugLineNum = 1468;BA.debugLine="lng = \"122.900234\"";
_lng = "122.900234";
 }else if(_brgy_index==8 && _street_index==3) { 
 //BA.debugLineNum = 1470;BA.debugLine="lat = \"10.179993\"";
_lat = "10.179993";
 //BA.debugLineNum = 1471;BA.debugLine="lng = \"122.904299\"";
_lng = "122.904299";
 }else if(_brgy_index==8 && _street_index==4) { 
 //BA.debugLineNum = 1473;BA.debugLine="lat = \"10.183439\"";
_lat = "10.183439";
 //BA.debugLineNum = 1474;BA.debugLine="lng = \"122.889622\"";
_lng = "122.889622";
 };
 //BA.debugLineNum = 1477;BA.debugLine="If brgy_index == 9 And street_index == 0 Then 'Ca";
if (_brgy_index==9 && _street_index==0) { 
 //BA.debugLineNum = 1478;BA.debugLine="lat = \"10.074128\"";
_lat = "10.074128";
 //BA.debugLineNum = 1479;BA.debugLine="lng = \"122.981978\"";
_lng = "122.981978";
 }else if(_brgy_index==9 && _street_index==1) { 
 //BA.debugLineNum = 1481;BA.debugLine="lat = \"10.109208\"";
_lat = "10.109208";
 //BA.debugLineNum = 1482;BA.debugLine="lng = \"122.896717\"";
_lng = "122.896717";
 }else if(_brgy_index==9 && _street_index==2) { 
 //BA.debugLineNum = 1484;BA.debugLine="lat = \"10.097119\"";
_lat = "10.097119";
 //BA.debugLineNum = 1485;BA.debugLine="lng = \"122.947066\"";
_lng = "122.947066";
 }else if(_brgy_index==9 && _street_index==3) { 
 //BA.debugLineNum = 1487;BA.debugLine="lat = \"10.099023\"";
_lat = "10.099023";
 //BA.debugLineNum = 1488;BA.debugLine="lng = \"122.971723\"";
_lng = "122.971723";
 }else if(_brgy_index==9 && _street_index==4) { 
 //BA.debugLineNum = 1490;BA.debugLine="lat = \"10.119761\"";
_lat = "10.119761";
 //BA.debugLineNum = 1491;BA.debugLine="lng = \"122.901613\"";
_lng = "122.901613";
 }else if(_brgy_index==9 && _street_index==5) { 
 //BA.debugLineNum = 1493;BA.debugLine="lat = \"10.099402\"";
_lat = "10.099402";
 //BA.debugLineNum = 1494;BA.debugLine="lng = \"122.896454\"";
_lng = "122.896454";
 }else if(_brgy_index==9 && _street_index==6) { 
 //BA.debugLineNum = 1496;BA.debugLine="lat = \"10.097102\"";
_lat = "10.097102";
 //BA.debugLineNum = 1497;BA.debugLine="lng = \"122.922368\"";
_lng = "122.922368";
 }else if(_brgy_index==9 && _street_index==7) { 
 //BA.debugLineNum = 1499;BA.debugLine="lat = \"10.095304\"";
_lat = "10.095304";
 //BA.debugLineNum = 1500;BA.debugLine="lng = \"122.929242\"";
_lng = "122.929242";
 }else if(_brgy_index==9 && _street_index==8) { 
 //BA.debugLineNum = 1502;BA.debugLine="lat = \"10.114128\"";
_lat = "10.114128";
 //BA.debugLineNum = 1503;BA.debugLine="lng = \"122.893868\"";
_lng = "122.893868";
 };
 //BA.debugLineNum = 1506;BA.debugLine="If brgy_index == 10 And street_index == 0 Then 'L";
if (_brgy_index==10 && _street_index==0) { 
 //BA.debugLineNum = 1507;BA.debugLine="lat = \"10.1799469\"";
_lat = "10.1799469";
 //BA.debugLineNum = 1508;BA.debugLine="lng = \"122.9068577\"";
_lng = "122.9068577";
 }else if(_brgy_index==10 && _street_index==1) { 
 //BA.debugLineNum = 1510;BA.debugLine="lat = \"10.180524\"";
_lat = "10.180524";
 //BA.debugLineNum = 1511;BA.debugLine="lng = \"122.906798\"";
_lng = "122.906798";
 }else if(_brgy_index==10 && _street_index==2) { 
 //BA.debugLineNum = 1513;BA.debugLine="lat = \"10.173336\"";
_lat = "10.173336";
 //BA.debugLineNum = 1514;BA.debugLine="lng = \"122.9118842\"";
_lng = "122.9118842";
 }else if(_brgy_index==10 && _street_index==3) { 
 //BA.debugLineNum = 1516;BA.debugLine="lat = \"10.177359\"";
_lat = "10.177359";
 //BA.debugLineNum = 1517;BA.debugLine="lng = \"122.913033\"";
_lng = "122.913033";
 }else if(_brgy_index==10 && _street_index==4) { 
 //BA.debugLineNum = 1519;BA.debugLine="lat = \"10.179847\"";
_lat = "10.179847";
 //BA.debugLineNum = 1520;BA.debugLine="lng = \"122.914160\"";
_lng = "122.914160";
 }else if(_brgy_index==10 && _street_index==5) { 
 //BA.debugLineNum = 1522;BA.debugLine="lat = \"10.182718\"";
_lat = "10.182718";
 //BA.debugLineNum = 1523;BA.debugLine="lng = \"122.915228\"";
_lng = "122.915228";
 }else if(_brgy_index==10 && _street_index==6) { 
 //BA.debugLineNum = 1525;BA.debugLine="lat = \"10.186454\"";
_lat = "10.186454";
 //BA.debugLineNum = 1526;BA.debugLine="lng = \"122.916278\"";
_lng = "122.916278";
 }else if(_brgy_index==10 && _street_index==7) { 
 //BA.debugLineNum = 1528;BA.debugLine="lat = \"10.168057\"";
_lat = "10.168057";
 //BA.debugLineNum = 1529;BA.debugLine="lng = \"122.924501\"";
_lng = "122.924501";
 };
 //BA.debugLineNum = 1532;BA.debugLine="If brgy_index == 11 And street_index == 0 Then 'M";
if (_brgy_index==11 && _street_index==0) { 
 //BA.debugLineNum = 1533;BA.debugLine="lat = \"10.050418\"";
_lat = "10.050418";
 //BA.debugLineNum = 1534;BA.debugLine="lng = \"122.867097\"";
_lng = "122.867097";
 }else if(_brgy_index==11 && _street_index==1) { 
 //BA.debugLineNum = 1536;BA.debugLine="lat = \"10.027855\"";
_lat = "10.027855";
 //BA.debugLineNum = 1537;BA.debugLine="lng = \"122.906833\"";
_lng = "122.906833";
 }else if(_brgy_index==11 && _street_index==2) { 
 //BA.debugLineNum = 1539;BA.debugLine="lat = \"10.027522\"";
_lat = "10.027522";
 //BA.debugLineNum = 1540;BA.debugLine="lng = \"122.876637\"";
_lng = "122.876637";
 }else if(_brgy_index==11 && _street_index==3) { 
 //BA.debugLineNum = 1542;BA.debugLine="lat = \"10.017254\"";
_lat = "10.017254";
 //BA.debugLineNum = 1543;BA.debugLine="lng = \"122.900969\"";
_lng = "122.900969";
 }else if(_brgy_index==11 && _street_index==4) { 
 //BA.debugLineNum = 1545;BA.debugLine="lat = \"10.028535\"";
_lat = "10.028535";
 //BA.debugLineNum = 1546;BA.debugLine="lng = \"122.900364\"";
_lng = "122.900364";
 }else if(_brgy_index==11 && _street_index==5) { 
 //BA.debugLineNum = 1548;BA.debugLine="lat = \"10.025485\"";
_lat = "10.025485";
 //BA.debugLineNum = 1549;BA.debugLine="lng = \"122.890023\"";
_lng = "122.890023";
 };
 //BA.debugLineNum = 1552;BA.debugLine="If brgy_index == 12 And street_index == 0 Then 'M";
if (_brgy_index==12 && _street_index==0) { 
 //BA.debugLineNum = 1553;BA.debugLine="lat = \"10.137572\"";
_lat = "10.137572";
 //BA.debugLineNum = 1554;BA.debugLine="lng = \"122.939888\"";
_lng = "122.939888";
 }else if(_brgy_index==12 && _street_index==1) { 
 //BA.debugLineNum = 1556;BA.debugLine="lat = \"10.132195\"";
_lat = "10.132195";
 //BA.debugLineNum = 1557;BA.debugLine="lng = \"122.899837\"";
_lng = "122.899837";
 }else if(_brgy_index==12 && _street_index==2) { 
 //BA.debugLineNum = 1559;BA.debugLine="lat = \"10.123430\"";
_lat = "10.123430";
 //BA.debugLineNum = 1560;BA.debugLine="lng = \"122.892250\"";
_lng = "122.892250";
 }else if(_brgy_index==12 && _street_index==3) { 
 //BA.debugLineNum = 1562;BA.debugLine="lat = \"10.130383\"";
_lat = "10.130383";
 //BA.debugLineNum = 1563;BA.debugLine="lng = \"122.893010\"";
_lng = "122.893010";
 }else if(_brgy_index==12 && _street_index==4) { 
 //BA.debugLineNum = 1565;BA.debugLine="lat = \"10.123127\"";
_lat = "10.123127";
 //BA.debugLineNum = 1566;BA.debugLine="lng = \"122.887952\"";
_lng = "122.887952";
 }else if(_brgy_index==12 && _street_index==5) { 
 //BA.debugLineNum = 1568;BA.debugLine="lat = \"10.131098\"";
_lat = "10.131098";
 //BA.debugLineNum = 1569;BA.debugLine="lng = \"122.879801\"";
_lng = "122.879801";
 }else if(_brgy_index==12 && _street_index==6) { 
 //BA.debugLineNum = 1571;BA.debugLine="lat = \"10.137485\"";
_lat = "10.137485";
 //BA.debugLineNum = 1572;BA.debugLine="lng = \"122.911434\"";
_lng = "122.911434";
 }else if(_brgy_index==12 && _street_index==7) { 
 //BA.debugLineNum = 1574;BA.debugLine="lat = \"10.106803\"";
_lat = "10.106803";
 //BA.debugLineNum = 1575;BA.debugLine="lng = \"122.885727\"";
_lng = "122.885727";
 }else if(_brgy_index==12 && _street_index==8) { 
 //BA.debugLineNum = 1577;BA.debugLine="lat = \"10.115220\"";
_lat = "10.115220";
 //BA.debugLineNum = 1578;BA.debugLine="lng = \"122.890515\"";
_lng = "122.890515";
 }else if(_brgy_index==12 && _street_index==9) { 
 //BA.debugLineNum = 1580;BA.debugLine="lat = \"10.108754\"";
_lat = "10.108754";
 //BA.debugLineNum = 1581;BA.debugLine="lng = \"122.894130\"";
_lng = "122.894130";
 }else if(_brgy_index==12 && _street_index==10) { 
 //BA.debugLineNum = 1583;BA.debugLine="lat = \"10.149506\"";
_lat = "10.149506";
 //BA.debugLineNum = 1584;BA.debugLine="lng = \"122.897389\"";
_lng = "122.897389";
 }else if(_brgy_index==12 && _street_index==11) { 
 //BA.debugLineNum = 1586;BA.debugLine="lat = \"10.122215\"";
_lat = "10.122215";
 //BA.debugLineNum = 1587;BA.debugLine="lng = \"122.892160\"";
_lng = "122.892160";
 }else if(_brgy_index==12 && _street_index==12) { 
 //BA.debugLineNum = 1589;BA.debugLine="lat = \"10.142698\"";
_lat = "10.142698";
 //BA.debugLineNum = 1590;BA.debugLine="lng = \"122.898168\"";
_lng = "122.898168";
 };
 //BA.debugLineNum = 1593;BA.debugLine="If brgy_index == 13 And street_index == 0 Then 'N";
if (_brgy_index==13 && _street_index==0) { 
 //BA.debugLineNum = 1594;BA.debugLine="lat = \"10.161629\"";
_lat = "10.161629";
 //BA.debugLineNum = 1595;BA.debugLine="lng = \"122.872772\"";
_lng = "122.872772";
 }else if(_brgy_index==13 && _street_index==1) { 
 //BA.debugLineNum = 1597;BA.debugLine="lat = \"10.161863\"";
_lat = "10.161863";
 //BA.debugLineNum = 1598;BA.debugLine="lng = \"122.876192\"";
_lng = "122.876192";
 }else if(_brgy_index==13 && _street_index==2) { 
 //BA.debugLineNum = 1600;BA.debugLine="lat = \"10.157407\"";
_lat = "10.157407";
 //BA.debugLineNum = 1601;BA.debugLine="lng = \"122.885663\"";
_lng = "122.885663";
 }else if(_brgy_index==13 && _street_index==3) { 
 //BA.debugLineNum = 1603;BA.debugLine="lat = \"10.167497\"";
_lat = "10.167497";
 //BA.debugLineNum = 1604;BA.debugLine="lng = \"122.879777\"";
_lng = "122.879777";
 }else if(_brgy_index==13 && _street_index==4) { 
 //BA.debugLineNum = 1606;BA.debugLine="lat = \"10.176260\"";
_lat = "10.176260";
 //BA.debugLineNum = 1607;BA.debugLine="lng = \"122.880815\"";
_lng = "122.880815";
 }else if(_brgy_index==13 && _street_index==5) { 
 //BA.debugLineNum = 1609;BA.debugLine="lat = \"10.170524\"";
_lat = "10.170524";
 //BA.debugLineNum = 1610;BA.debugLine="lng = \"122.883603\"";
_lng = "122.883603";
 };
 //BA.debugLineNum = 1613;BA.debugLine="If brgy_index == 14 And street_index == 0 Then 'S";
if (_brgy_index==14 && _street_index==0) { 
 //BA.debugLineNum = 1614;BA.debugLine="lat = \"10.071514\"";
_lat = "10.071514";
 //BA.debugLineNum = 1615;BA.debugLine="lng = \"122.916010\"";
_lng = "122.916010";
 }else if(_brgy_index==14 && _street_index==1) { 
 //BA.debugLineNum = 1617;BA.debugLine="lat = \"10.069622\"";
_lat = "10.069622";
 //BA.debugLineNum = 1618;BA.debugLine="lng = \"122.909890\"";
_lng = "122.909890";
 }else if(_brgy_index==14 && _street_index==2) { 
 //BA.debugLineNum = 1620;BA.debugLine="lat = \"10.076890\"";
_lat = "10.076890";
 //BA.debugLineNum = 1621;BA.debugLine="lng = \"122.894231\"";
_lng = "122.894231";
 }else if(_brgy_index==14 && _street_index==3) { 
 //BA.debugLineNum = 1623;BA.debugLine="lat = \"10.086207\"";
_lat = "10.086207";
 //BA.debugLineNum = 1624;BA.debugLine="lng = \"122.914044\"";
_lng = "122.914044";
 }else if(_brgy_index==14 && _street_index==4) { 
 //BA.debugLineNum = 1626;BA.debugLine="lat = \"10.067393\"";
_lat = "10.067393";
 //BA.debugLineNum = 1627;BA.debugLine="lng = \"122.900935\"";
_lng = "122.900935";
 }else if(_brgy_index==14 && _street_index==5) { 
 //BA.debugLineNum = 1629;BA.debugLine="lat = \"10.071900\"";
_lat = "10.071900";
 //BA.debugLineNum = 1630;BA.debugLine="lng = \"122.906250\"";
_lng = "122.906250";
 }else if(_brgy_index==14 && _street_index==6) { 
 //BA.debugLineNum = 1632;BA.debugLine="lat = \"10.061702\"";
_lat = "10.061702";
 //BA.debugLineNum = 1633;BA.debugLine="lng = \"122.896226\"";
_lng = "122.896226";
 }else if(_brgy_index==14 && _street_index==7) { 
 //BA.debugLineNum = 1635;BA.debugLine="lat = \"10.054802\"";
_lat = "10.054802";
 //BA.debugLineNum = 1636;BA.debugLine="lng = \"122.938688\"";
_lng = "122.938688";
 }else if(_brgy_index==14 && _street_index==8) { 
 //BA.debugLineNum = 1638;BA.debugLine="lat = \"10.071827\"";
_lat = "10.071827";
 //BA.debugLineNum = 1639;BA.debugLine="lng = \"122.921092\"";
_lng = "122.921092";
 }else if(_brgy_index==14 && _street_index==9) { 
 //BA.debugLineNum = 1641;BA.debugLine="lat = \"10.050849\"";
_lat = "10.050849";
 //BA.debugLineNum = 1642;BA.debugLine="lng = \"122.907632\"";
_lng = "122.907632";
 };
 //BA.debugLineNum = 1645;BA.debugLine="If brgy_index == 15 And street_index == 0 Then 'S";
if (_brgy_index==15 && _street_index==0) { 
 //BA.debugLineNum = 1646;BA.debugLine="lat = \"10.155844\"";
_lat = "10.155844";
 //BA.debugLineNum = 1647;BA.debugLine="lng = \"122.861129\"";
_lng = "122.861129";
 }else if(_brgy_index==15 && _street_index==1) { 
 //BA.debugLineNum = 1649;BA.debugLine="lat = \"10.152073\"";
_lat = "10.152073";
 //BA.debugLineNum = 1650;BA.debugLine="lng = \"122.861669\"";
_lng = "122.861669";
 }else if(_brgy_index==15 && _street_index==2) { 
 //BA.debugLineNum = 1652;BA.debugLine="lat = \"10.147663\"";
_lat = "10.147663";
 //BA.debugLineNum = 1653;BA.debugLine="lng = \"122.862471\"";
_lng = "122.862471";
 }else if(_brgy_index==15 && _street_index==3) { 
 //BA.debugLineNum = 1655;BA.debugLine="lat = \"10.144440\"";
_lat = "10.144440";
 //BA.debugLineNum = 1656;BA.debugLine="lng = \"122.862524\"";
_lng = "122.862524";
 };
 //BA.debugLineNum = 1659;BA.debugLine="If brgy_index == 16 And street_index == 0 Then 'S";
if (_brgy_index==16 && _street_index==0) { 
 //BA.debugLineNum = 1660;BA.debugLine="lat = \"10.053680\"";
_lat = "10.053680";
 //BA.debugLineNum = 1661;BA.debugLine="lng = \"122.843876\"";
_lng = "122.843876";
 }else if(_brgy_index==16 && _street_index==1) { 
 //BA.debugLineNum = 1663;BA.debugLine="lat = \"10.055961\"";
_lat = "10.055961";
 //BA.debugLineNum = 1664;BA.debugLine="lng = \"122.841980\"";
_lng = "122.841980";
 }else if(_brgy_index==16 && _street_index==2) { 
 //BA.debugLineNum = 1666;BA.debugLine="lat = \"10.053363\"";
_lat = "10.053363";
 //BA.debugLineNum = 1667;BA.debugLine="lng = \"122.843295\"";
_lng = "122.843295";
 }else if(_brgy_index==16 && _street_index==3) { 
 //BA.debugLineNum = 1669;BA.debugLine="lat = \"10.053032\"";
_lat = "10.053032";
 //BA.debugLineNum = 1670;BA.debugLine="lng = \"122.842594\"";
_lng = "122.842594";
 }else if(_brgy_index==16 && _street_index==4) { 
 //BA.debugLineNum = 1672;BA.debugLine="lat = \"10.052328\"";
_lat = "10.052328";
 //BA.debugLineNum = 1673;BA.debugLine="lng = \"122.842835\"";
_lng = "122.842835";
 }else if(_brgy_index==16 && _street_index==5) { 
 //BA.debugLineNum = 1675;BA.debugLine="lat = \"10.052573\"";
_lat = "10.052573";
 //BA.debugLineNum = 1676;BA.debugLine="lng = \"122.844229\"";
_lng = "122.844229";
 }else if(_brgy_index==16 && _street_index==6) { 
 //BA.debugLineNum = 1678;BA.debugLine="lat = \"10.046957\"";
_lat = "10.046957";
 //BA.debugLineNum = 1679;BA.debugLine="lng = \"122.839610\"";
_lng = "122.839610";
 }else if(_brgy_index==16 && _street_index==7) { 
 //BA.debugLineNum = 1681;BA.debugLine="lat = \"10.035813\"";
_lat = "10.035813";
 //BA.debugLineNum = 1682;BA.debugLine="lng = \"122.835364\"";
_lng = "122.835364";
 };
 //BA.debugLineNum = 1685;BA.debugLine="If brgy_index == 17 And street_index == 0 Then 'T";
if (_brgy_index==17 && _street_index==0) { 
 //BA.debugLineNum = 1686;BA.debugLine="lat = \"10.148233\"";
_lat = "10.148233";
 //BA.debugLineNum = 1687;BA.debugLine="lng = \"122.869741\"";
_lng = "122.869741";
 }else if(_brgy_index==17 && _street_index==1) { 
 //BA.debugLineNum = 1689;BA.debugLine="lat = \"10.139867\"";
_lat = "10.139867";
 //BA.debugLineNum = 1690;BA.debugLine="lng = \"122.869882\"";
_lng = "122.869882";
 }else if(_brgy_index==17 && _street_index==2) { 
 //BA.debugLineNum = 1692;BA.debugLine="lat = \"10.126453\"";
_lat = "10.126453";
 //BA.debugLineNum = 1693;BA.debugLine="lng = \"122.868927\"";
_lng = "122.868927";
 }else if(_brgy_index==17 && _street_index==3) { 
 //BA.debugLineNum = 1695;BA.debugLine="lat = \"10.127470\"";
_lat = "10.127470";
 //BA.debugLineNum = 1696;BA.debugLine="lng = \"122.862942\"";
_lng = "122.862942";
 }else if(_brgy_index==17 && _street_index==4) { 
 //BA.debugLineNum = 1698;BA.debugLine="lat = \"10.117998\"";
_lat = "10.117998";
 //BA.debugLineNum = 1699;BA.debugLine="lng = \"122.866817\"";
_lng = "122.866817";
 }else if(_brgy_index==17 && _street_index==5) { 
 //BA.debugLineNum = 1701;BA.debugLine="lat = \"10.108173\"";
_lat = "10.108173";
 //BA.debugLineNum = 1702;BA.debugLine="lng = \"122.864592\"";
_lng = "122.864592";
 }else if(_brgy_index==17 && _street_index==6) { 
 //BA.debugLineNum = 1704;BA.debugLine="lat = \"10.126115\"";
_lat = "10.126115";
 //BA.debugLineNum = 1705;BA.debugLine="lng = \"122.871073\"";
_lng = "122.871073";
 }else if(_brgy_index==17 && _street_index==7) { 
 //BA.debugLineNum = 1707;BA.debugLine="lat = \"10.129412\"";
_lat = "10.129412";
 //BA.debugLineNum = 1708;BA.debugLine="lng = \"122.869408\"";
_lng = "122.869408";
 }else if(_brgy_index==17 && _street_index==8) { 
 //BA.debugLineNum = 1710;BA.debugLine="lat = \"10.134647\"";
_lat = "10.134647";
 //BA.debugLineNum = 1711;BA.debugLine="lng = \"122.871841\"";
_lng = "122.871841";
 }else if(_brgy_index==17 && _street_index==9) { 
 //BA.debugLineNum = 1713;BA.debugLine="lat = \"10.124801\"";
_lat = "10.124801";
 //BA.debugLineNum = 1714;BA.debugLine="lng = \"122.868277\"";
_lng = "122.868277";
 }else if(_brgy_index==17 && _street_index==10) { 
 //BA.debugLineNum = 1716;BA.debugLine="lat = \"10.124422\"";
_lat = "10.124422";
 //BA.debugLineNum = 1717;BA.debugLine="lng = \"122.866917\"";
_lng = "122.866917";
 };
 //BA.debugLineNum = 1720;BA.debugLine="If brgy_index == 18 And street_index == 0 Then 'T";
if (_brgy_index==18 && _street_index==0) { 
 //BA.debugLineNum = 1721;BA.debugLine="lat = \"10.065086\"";
_lat = "10.065086";
 //BA.debugLineNum = 1722;BA.debugLine="lng = \"122.843793\"";
_lng = "122.843793";
 }else if(_brgy_index==18 && _street_index==1) { 
 //BA.debugLineNum = 1724;BA.debugLine="lat = \"10.071356\"";
_lat = "10.071356";
 //BA.debugLineNum = 1725;BA.debugLine="lng = \"122.853102\"";
_lng = "122.853102";
 }else if(_brgy_index==18 && _street_index==2) { 
 //BA.debugLineNum = 1727;BA.debugLine="lat = \"10.060206\"";
_lat = "10.060206";
 //BA.debugLineNum = 1728;BA.debugLine="lng = \"122.850172\"";
_lng = "122.850172";
 }else if(_brgy_index==18 && _street_index==3) { 
 //BA.debugLineNum = 1730;BA.debugLine="lat = \"10.057640\"";
_lat = "10.057640";
 //BA.debugLineNum = 1731;BA.debugLine="lng = \"122.859242\"";
_lng = "122.859242";
 };
 //BA.debugLineNum = 1734;BA.debugLine="Log(\"lat: \"&lat&CRLF&\"lng: \"&lng)";
...
String _m_3 = "";
String _merge = "";
 //BA.debugLineNum = 658;BA.debugLine="Sub update_btn_Click";
 //BA.debugLineNum = 659;BA.debugLine="ProgressDialogShow2(\"Updating Please wait...\",Fal";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow2(mostCurrent.activityBA,"Updating Please wait...",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 660;BA.debugLine="optionSelected = \"updated_click\"";
_optionselected = "updated_click";
 //BA.debugLineNum = 661;BA.debugLine="update_job.Initialize(\"update_job\",Me)";
mostCurrent._update_job._initialize(processBA,"update_job",menu_form.getObject());
 //BA.debugLineNum = 662;BA.debugLine="Dim url_back As calculations";
_url_back = new bloodlife.system.calculations();
 //BA.debugLineNum = 663;BA.debugLine="Dim male_c,female_c As String";
_male_c = "";
_female_c = "";
 //BA.debugLineNum = 664;BA.debugLine="male_c = File.GetText(File.DirAssets, \"male_strin";
_male_c = anywheresoftware.b4a.keywords.Common.File.GetText(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"male_string.txt");
 //BA.debugLineNum = 665;BA.debugLine="female_c = File.GetText(File.DirAssets, \"female_s";
_female_c = anywheresoftware.b4a.keywords.Common.File.GetText(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"female_string.txt");
 //BA.debugLineNum = 667;BA.debugLine="If image_container == male_c Or image_container =";
if ((_image_container).equals(_male_c) || (_image_container).equals(_female_c)) { 
 //BA.debugLineNum = 668;BA.debugLine="Dim img_string As String";
_img_string = "";
 //BA.debugLineNum = 669;BA.debugLine="Dim su As StringUtils";
_su = new anywheresoftware.b4a.objects.StringUtils();
 //BA.debugLineNum = 670;BA.debugLine="Dim out1 As OutputStream";
_out1 = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
 //BA.debugLineNum = 671;BA.debugLine="If is_gender_index == 0 Then";
if (_is_gender_index==0) { 
 //BA.debugLineNum = 672;BA.debugLine="out1.InitializeToBytesArray(0) 'size not real";
_out1.InitializeToBytesArray((int) (0));
 //BA.debugLineNum = 673;BA.debugLine="File.Copy2(File.OpenInput(File.DirAssets, \"ma";
anywheresoftware.b4a.keywords.Common.File.Copy2((java.io.InputStream)(anywheresoftware.b4a.keywords.Common.File.OpenInput(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"male_clip.png").getObject()),(java.io.OutputStream)(_out1.getObject()));
 //BA.debugLineNum = 674;BA.debugLine="img_string=su.EncodeBase64(out1.ToBytesArray)";
_img_string = _su.EncodeBase64(_out1.ToBytesArray());
 //BA.debugLineNum = 676;BA.debugLine="image_container = img_string";
_image_container = _img_string;
 }else {
 //BA.debugLineNum = 678;BA.debugLine="out1.InitializeToBytesArray(0) 'size not reall";
_out1.InitializeToBytesArray((int) (0));
 //BA.debugLineNum = 679;BA.debugLine="File.Copy2(File.OpenInput(File.DirAssets, \"fe";
anywheresoftware.b4a.keywords.Common.File.Copy2((java.io.InputStream)(anywheresoftware.b4a.keywords.Common.File.OpenInput(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"female_clip.png").getObject()),(java.io.OutputStream)(_out1.getObject()));
 //BA.debugLineNum = 680;BA.debugLine="img_string=su.EncodeBase64(out1.ToBytesArray)";
_img_string = _su.EncodeBase64(_out1.ToBytesArray());
 //BA.debugLineNum = 682;BA.debugLine="image_container = img_string";
_image_container = _img_string;
 };
 }else {
 };
 //BA.debugLineNum = 689;BA.debugLine="Dim Nmonth,Nday,Nyear,ageGet As Int";
_nmonth = 0;
_nday = 0;
_nyear = 0;
_ageget = 0;
 //BA.debugLineNum = 690;BA.debugLine="Nday = DateTime.GetDayOfMonth(DateTime.Now)";
_nday = anywheresoftware.b4a.keywords.Common.DateTime.GetDayOfMonth(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 691;BA.debugLine="Nmonth = DateTime.GetMonth(DateTime.Now)";
_nmonth = anywheresoftware.b4a.keywords.Common.DateTime.GetMonth(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 692;BA.debugLine="Nyear = DateTime.GetYear(DateTime.Now)";
_nyear = anywheresoftware.b4a.keywords.Common.DateTime.GetYear(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 694;BA.debugLine="Dim age,Pyear,Pmonth,Pday As Int";
_age = 0;
_pyear = 0;
_pmonth = 0;
_pday = 0;
 //BA.debugLineNum = 695;BA.debugLine="Pyear = bday_year_selected";
_pyear = (int)(Double.parseDouble(_bday_year_selected));
 //BA.debugLineNum = 696;BA.debugLine="Pmonth = bday_month_selected";
_pmonth = (int)(Double.parseDouble(_bday_month_selected));
 //BA.debugLineNum = 697;BA.debugLine="Pday = bday_day_selected";
_pday = (int)(Double.parseDouble(_bday_day_selected));
 //BA.debugLineNum = 698;BA.debugLine="age = Nyear - Pyear";
_age = (int) (_nyear-_pyear);
 //BA.debugLineNum = 699;BA.debugLine="If Pmonth <= Nmonth And Pday <= Nday Then";
if (_pmonth<=_nmonth && _pday<=_nday) { 
 //BA.debugLineNum = 701;BA.debugLine="ageGet = age";
_ageget = _age;
 }else {
 //BA.debugLineNum = 703;BA.debugLine="ageGet = age-1";
_ageget = (int) (_age-1);
 };
 //BA.debugLineNum = 707;BA.debugLine="url_back.Initialize";
_url_back._initialize(processBA);
 //BA.debugLineNum = 709;BA.debugLine="Dim ins,m_1,m_2,m_3,merge As String";
_ins = "";
_m_1 = "";
_m_2 = "";
_m_3 = "";
_merge = "";
 //BA.debugLineNum = 711;BA.debugLine="If text_fn.Text == \"\"  Or text_email.Text == \"";
if ((mostCurrent._text_fn.getText()).equals("") || (mostCurrent._text_email.getText()).equals("") || (mostCurrent._text_phonenumber2.getText()).equals("") || (mostCurrent._text_phonenumber.getText()).equals("") || (mostCurrent._text_answer.getText()).equals("")) { 
 //BA.debugLineNum = 712;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 713;BA.debugLine="Msgbox(\"Error: Fill up those empty fields before";
anywheresoftware.b4a.keywords.Common.Msgbox("Error: Fill up those empty fields before you update!","C O N F I R M A T I O N",mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 715;BA.debugLine="m_1 = \"UPDATE `bloodlife_db`.`person_info` SET `";
_m_1 = "UPDATE `bloodlife_db`.`person_info` SET `full_name`='"+mostCurrent._text_fn.getText()+"',`blood_type`='"+_blood_selected+"', `phone_number1`='"+mostCurrent._text_phonenumber.getText()+"', `phone_number2`='"+mostCurrent._text_phonenumber2.getText()+"', `location_brgy`='"+_location_brgy_selected+"', `location_street`='"+_location_street_selected+"', ";
 //BA.debugLineNum = 716;BA.debugLine="m_2 = \"`location_purok`='', `bday_month`='\"&bday";
_m_2 = "`location_purok`='', `bday_month`='"+_bday_month_selected+"',`bday_day`='"+_bday_day_selected+"', `bday_year`='"+_bday_year_selected+"', `nick_name`='"+mostCurrent._text_answer.getText()+"', `donate_boolean`='"+_is_donated+"', `lat`='"+_lat+"', `long`='"+_lng+"', `image`='"+_image_container+"', ";
 //BA.debugLineNum = 717;BA.debugLine="m_3 = \"`age`='\"&ageGet&\"',`date_donated`='\"&isDo";
_m_3 = "`age`='"+BA.NumberToString(_ageget)+"',`date_donated`='"+_isdonatedate+"',`gender`='"+_gender_string_data+"' WHERE `id`="+mostCurrent._login_form._id_query+";";
 //BA.debugLineNum = 718;BA.debugLine="merge = m_1&m_2&m_3";
_merge = _m_1+_m_2+_m_3;
 //BA.debugLineNum = 719;BA.debugLine="ins = url_back.php_email_url(\"/bloodlifePHP/upda";
_ins = _url_back._php_email_url("/bloodlifePHP/updating.php");
 //BA.debugLineNum = 720;BA.debugLine="update_job.Download2(ins,Array As String(\"update";
...
anywheresoftware.b4a.objects.drawable.BitmapDrawable _bd = null;
 ...
 //BA.debugLineNum = 489;BA.debugLine="dlgFileExpl.Initialize(Activity, \"/mnt/sdcard\", \"";
mostCurrent._dlgfileexpl._initialize(mostCurrent.activityBA,mostCurrent._activity,"/mnt/sdcard",".bmp,.gif,.jpg,.png",anywheresoftware.b4a.keywords.Common.True,anywheresoftware.b4a.keywords.Common.False,"OK");
 //BA.debugLineNum = 490;BA.debugLine="dlgFileExpl.FastScrollEnabled = True";
mostCurrent._dlgfileexpl._fastscrollenabled = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 491;BA.debugLine="dlgFileExpl.Explorer2(True)";
mostCurrent._dlgfileexpl._explorer2(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 492;BA.debugLine="If Not(dlgFileExpl.Selection.Canceled Or dlgFileE";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._dlgfileexpl._selection.Canceled || (mostCurrent._dlgfileexpl._selection.ChosenFile).equals(""))) { 
 //BA.debugLineNum = 494;BA.debugLine="Dim img_string As String";
_img_string = "";
 //BA.debugLineNum = 495;BA.debugLine="Dim su As StringUtils";
_su = new anywheresoftware.b4a.objects.StringUtils();
 //BA.debugLineNum = 496;BA.debugLine="Dim out1 As OutputStream";
_out1 = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
 //BA.debugLineNum = 498;BA.debugLine="out1.InitializeToBytesArray(0) 'size not real";
_out1.InitializeToBytesArray((int) (0));
 //BA.debugLineNum = 499;BA.debugLine="File.Copy2(File.OpenInput(dlgFileExpl.Selecti";
anywheresoftware.b4a.keywords.Common.File.Copy2((java.io.InputStream)(anywheresoftware.b4a.keywords.Common.File.OpenInput(mostCurrent._dlgfileexpl._selection.ChosenPath,mostCurrent._dlgfileexpl._selection.ChosenFile).getObject()),(java.io.OutputStream)(_out1.getObject()));
 //BA.debugLineNum = 500;BA.debugLine="img_string=su.EncodeBase64(out1.ToBytesArray)";
_img_string = _su.EncodeBase64(_out1.ToBytesArray());
 //BA.debugLineNum = 501;BA.debugLine="Log(img_string)";
anywheresoftware.b4a.keywords.Common.Log(_img_string);
 //BA.debugLineNum = 504;BA.debugLine="Dim inp As InputStream";
_inp = new anywheresoftware.b4a.objects.streams.File.InputStreamWrapper();
 //BA.debugLineNum = 505;BA.debugLine="Dim bmp As Bitmap";
_bmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 506;BA.debugLine="Dim su As StringUtils";
_su = new anywheresoftware.b4a.objects.StringUtils();
 //BA.debugLineNum = 507;BA.debugLine="Dim bytes() As Byte";
_bytes = new byte[(int) (0)];
;
 //BA.debugLineNum = 508;BA.debugLine="bytes = su.DecodeBase64(img_string)";
_bytes = _su.DecodeBase64(_img_string);
 //BA.debugLineNum = 509;BA.debugLine="inp.InitializeFromBytesArray(bytes,0,bytes.Length";
_inp.InitializeFromBytesArray(_bytes,(int) (0),_bytes.length);
 //BA.debugLineNum = 510;BA.debugLine="bmp.Initialize2(inp)";
_bmp.Initialize2((java.io.InputStream)(_inp.getObject()));
 //BA.debugLineNum = 512;BA.debugLine="Dim bd As BitmapDrawable";
_bd = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 513;BA.debugLine="bd.Initialize(bmp)";
_bd.Initialize((android.graphics.Bitmap)(_bmp.getObject()));
 //BA.debugLineNum = 515;BA.debugLine="usr_img.Background = bd";
