...
public class clschecklist extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bloodlife.system.clschecklist");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bloodlife.system.clschecklist.class).invoke(this, new Object[] {null});
        else
...
_previousposition = (int) (-1);
 //BA.debugLineNum = 742;BA.debugLine="Do Until PreviousPosition = sv.VerticalScrollPosi";
while (!(_previousposition==_sv.getVerticalScrollPosition())) {
 //BA.debugLineNum = 743;BA.debugLine="PreviousPosition = sv.VerticalScrollPosition";
_previousposition = _sv.getVerticalScrollPosition();
 //BA.debugLineNum = 744;BA.debugLine="sv.VerticalScrollPosition = NewPosition";
...
_contentbottom = (int) (_pnl.getTop()+_pnl.getHeight());
 //BA.debugLineNum = 966;BA.debugLine="If ContentBottom > sv.VerticalScrollPosition +";
...
__c.DoEvents();
 //BA.debugLineNum = 970;BA.debugLine="NewPosition = sv.VerticalScrollPosition + Min";
...
_draganddrop.setTop((int) (__c.Min(__c.Max(0,_draganddrop.getTop()+_y-_lasty),_sv.getPanel().getHeight()-_draganddrop.getHeight())));
 //BA.debugLineNum = 1063;BA.debugLine="If DragAndDrop.Top < sv.VerticalScrollPosition Th";
if (_draganddrop.getTop()<_sv.getVerticalScrollPosition()) { 
_sv.setVerticalScrollPosition(_draganddrop.getTop());};
 //BA.debugLineNum = 1064;BA.debugLine="If DragAndDrop.Top + DragAndDrop.Height > sv.Vert";
if (_draganddrop.getTop()+_draganddrop.getHeight()>_sv.getVerticalScrollPosition()+(double)(Double.parseDouble(_getheight()))) { 
 //BA.debugLineNum = 1065;BA.debugLine="sv.VerticalScrollPosition = DragAndDrop.Top + Dr";
...
int _i = 0;
bloodlife.system.clschecklist._typsortdata _sortdata = null;
int _firsttosort = 0;
int _lasttosort = 0;
...
_sortdata = new bloodlife.system.clschecklist._typsortdata();
...
_sortdata = (bloodlife.system.clschecklist._typsortdata)(_sortlist.Get((int) (_i-_firstposition)));
...
_draganddropshadow.Initialize(ba,"");
 //BA.debugLineNum = 1034;BA.debugLine="DragAndDropShadow.Color = Colors.ARGB(128, 128,";
