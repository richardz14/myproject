...
public class clsexplorer extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example.clsexplorer");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.example.clsexplorer.class).invoke(this, new Object[] {null});
        else
...
public b4a.example.clsexplorer._typresult _selection = null;
...
public b4a.example.clschecklist _lstfichiers = null;
...
_selection = new b4a.example.clsexplorer._typresult();
...
_lstfichiers = new b4a.example.clschecklist();
...
public b4a.example.clsexplorer._typresult  _explorer() throws Exception{
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
int _marginbord = 0;
int _margin = 0;
...
public b4a.example.clsexplorer._typresult  _explorer2(boolean _darktheme) throws Exception{
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
int _marginbord = 0;
int _margin = 0;
int _margincartouche = 0;
...
public b4a.example.clsexplorer._typresult  _explorermulti() throws Exception{
...
public b4a.example.clsexplorer._typresult  _explorermulti2(boolean _darktheme) throws Exception{
