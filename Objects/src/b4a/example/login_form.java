...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 51;BA.debugLine="Activity.LoadLayout(\"login_form\")";
mostCurrent._activity.LoadLayout("login_form",mostCurrent.activityBA);
 //BA.debugLineNum = 53;BA.debugLine="Activity.Title = \"LOG IN\"";
mostCurrent._activity.setTitle((Object)("LOG IN"));
 //BA.debugLineNum = 54;BA.debugLine="calcs.Initialize";
mostCurrent._calcs._initialize(processBA);
 //BA.debugLineNum = 55;BA.debugLine="h_email.Initialize(\"email_get\",Me)";
mostCurrent._h_email._initialize(processBA,"email_get",login_form.getObject());
 //BA.debugLineNum = 56;BA.debugLine="h_pass.Initialize(\"pass_get\",Me)";
mostCurrent._h_pass._initialize(processBA,"pass_get",login_form.getObject());
 //BA.debugLineNum = 57;BA.debugLine="h_fullname.Initialize(\"full_name_get\",Me)";
mostCurrent._h_fullname._initialize(processBA,"full_name_get",login_form.getObject());
 //BA.debugLineNum = 58;BA.debugLine="user_id.Initialize(\"user_id_get\",Me)";
mostCurrent._user_id._initialize(processBA,"user_id_get",login_form.getObject());
 //BA.debugLineNum = 59;BA.debugLine="nick_name.Initialize(\"nick_name_get\",Me)";
mostCurrent._nick_name._initialize(processBA,"nick_name_get",login_form.getObject());
 //BA.debugLineNum = 60;BA.debugLine="forgot_email_job.Initialize(\"forgot_email_get\",M";
mostCurrent._forgot_email_job._initialize(processBA,"forgot_email_get",login_form.getObject());
 //BA.debugLineNum = 61;BA.debugLine="forgot_nick_job.Initialize(\"forgot_nick_get\",Me)";
mostCurrent._forgot_nick_job._initialize(processBA,"forgot_nick_get",login_form.getObject());
 //BA.debugLineNum = 62;BA.debugLine="forgot_recover_job.Initialize(\"forgot_recover_jo";
mostCurrent._forgot_recover_job._initialize(processBA,"forgot_recover_job",login_form.getObject());
 //BA.debugLineNum = 64;BA.debugLine="all_settings_layout";
_all_settings_layout();
 //BA.debugLineNum = 65;BA.debugLine="email_forgot.Initialize(\"\")";
mostCurrent._email_forgot.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 66;BA.debugLine="nickN_forgot.Initialize(\"\")";
mostCurrent._nickn_forgot.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 67;BA.debugLine="newPass.Initialize(\"\")";
mostCurrent._newpass.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 68;BA.debugLine="renewPass.Initialize(\"\")";
mostCurrent._renewpass.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 70;BA.debugLine="database_init";
_database_init();
 //BA.debugLineNum = 71;BA.debugLine="sqlLite.Initialize(File.DirInternal,\"mydb.db\",Tru";
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 82;BA.debugLine="Dim set_cursor As Cursor";
_set_cursor = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 83;BA.debugLine="set_cursor = sqlLite.ExecQuery(\"select * from dat";
_set_cursor.setObject((android.database.Cursor)(_sqllite.ExecQuery("select * from data where `id`=1;")));
 //BA.debugLineNum = 84;BA.debugLine="For i = 0 To set_cursor.RowCount - 1";
{
final int step4 = 1;
final int limit4 = (int) (_set_cursor.getRowCount()-1);
for (_i = (int) (0) ; (step4 > 0 && _i <= limit4) || (step4 < 0 && _i >= limit4); _i = ((int)(0 + _i + step4)) ) {
 //BA.debugLineNum = 85;BA.debugLine="set_cursor.Position = i";
_set_cursor.setPosition(_i);
 //BA.debugLineNum = 86;BA.debugLine="If set_cursor.GetString(\"isStart\") == 1 Th";
if ((_set_cursor.GetString("isStart")).equals(BA.NumberToString(1))) { 
 //BA.debugLineNum = 87;BA.debugLine="Dim choose As Int";
_choose = 0;
 //BA.debugLineNum = 88;BA.debugLine="choose = Msgbox2(\"would you like to exit";
_choose = anywheresoftware.b4a.keywords.Common.Msgbox2("would you like to exit this application?","C O N F I R M A T I O N","YES","","NO",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA);
 //BA.debugLineNum = 89;BA.debugLine="If choose == DialogResponse.POSITIVE Then";
...
int[] _col = null;
 //BA.debugLineNum = 230;BA.debugLine="Public Sub all_settings_layout";
 //BA.debugLineNum = 231;BA.debugLine="Activity.SetBackgroundImage(LoadBitmap(File.DirAs";
mostCurrent._activity.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"bg.jpg").getObject()));
 //BA.debugLineNum = 232;BA.debugLine="ban_picture.SetBackgroundImage(LoadBitmap(File.Di";
mostCurrent._ban_picture.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"banner01.jpg").getObject()));
 //BA.debugLineNum = 233;BA.debugLine="log_in_button.SetBackgroundImage(LoadBitmap(File.";
mostCurrent._log_in_button.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"LOG_IN.png").getObject()));
 //BA.debugLineNum = 236;BA.debugLine="ban_tools.Color = Colors.Transparent";
mostCurrent._ban_tools.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 237;BA.debugLine="ban_create.SetBackgroundImage(LoadBitmap(File.Dir";
...
mostCurrent._ban_tools.setTop((int) (mostCurrent._ban_panel.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))));
 //BA.debugLineNum = 270;BA.debugLine="ban_create.Top = ban_tools.Top + ban_tools.Heigh";
...
mostCurrent._label_forgot.setTop((int) (mostCurrent._text_password.getTop()+mostCurrent._text_password.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (3))));
 //BA.debugLineNum = 276;BA.debugLine="log_in_button.Top = label_forgot.Top + label_for";
mostCurrent._log_in_button.setTop((int) (mostCurrent._label_forgot.getTop()+mostCurrent._label_forgot.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (17))));
 //BA.debugLineNum = 277;BA.debugLine="Dim sums As Double";
_sums = 0;
 //BA.debugLineNum = 278;BA.debugLine="sums= ban_create.Height/2";
_sums = mostCurrent._ban_create.getHeight()/(double)2;
 //BA.debugLineNum = 279;BA.debugLine="new_acc_button.Top = sums - (sums/2)";
mostCurrent._new_acc_button.setTop((int) (_sums-(_sums/(double)2)));
 //BA.debugLineNum = 281;BA.debugLine="Dim left_sums,left As Double";
_left_sums = 0;
_left = 0;
 //BA.debugLineNum = 282;BA.debugLine="left_sums = (Activity.Width/2)";
_left_sums = (mostCurrent._activity.getWidth()/(double)2);
 //BA.debugLineNum = 283;BA.debugLine="left =  left_sums - (left_sums/2)";
_left = _left_sums-(_left_sums/(double)2);
 //BA.debugLineNum = 284;BA.debugLine="ban_panel.left = 0";
mostCurrent._ban_panel.setLeft((int) (0));
 //BA.debugLineNum = 285;BA.debugLine="ban_picture.left = ban_panel.left";
mostCurrent._ban_picture.setLeft(mostCurrent._ban_panel.getLeft());
 //BA.debugLineNum = 286;BA.debugLine="ban_create.left = 0";
mostCurrent._ban_create.setLeft((int) (0));
 //BA.debugLineNum = 287;BA.debugLine="ban_tools.left = 0";
mostCurrent._ban_tools.setLeft((int) (0));
 //BA.debugLineNum = 288;BA.debugLine="label_email.left = 5%x'left/2";
mostCurrent._label_email.setLeft(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA));
 //BA.debugLineNum = 289;BA.debugLine="label_password.left = 5%x'left/2";
mostCurrent._label_password.setLeft(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA));
 //BA.debugLineNum = 290;BA.debugLine="text_email.left =  label_email.left + label_emai";
mostCurrent._text_email.setLeft((int) (mostCurrent._label_email.getLeft()+mostCurrent._label_email.getWidth()));
 //BA.debugLineNum = 291;BA.debugLine="text_password.left = label_password.left + label";
mostCurrent._text_password.setLeft((int) (mostCurrent._label_password.getLeft()+mostCurrent._label_email.getWidth()));
 //BA.debugLineNum = 292;BA.debugLine="label_forgot.left = text_password.left '+ (text_";
mostCurrent._label_forgot.setLeft(mostCurrent._text_password.getLeft());
 //BA.debugLineNum = 293;BA.debugLine="log_in_button.left = text_password.left + 10dip";
...
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"mydb.db")==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 75;BA.debugLine="File.Copy(File.DirAssets,\"mydb.db\",File.DirIntern";
...
public static String  _forgot_can_btn_click() throws Exception{
 //BA.debugLineNum = 387;BA.debugLine="Sub forgot_can_btn_click";
 //BA.debugLineNum = 388;BA.debugLine="forgot_pass_pnl.RemoveView";
mostCurrent._forgot_pass_pnl.RemoveView();
 //BA.debugLineNum = 389;BA.debugLine="End Sub";
return "";
}
public static String  _forgot_pass_pnl_click() throws Exception{
 //BA.debugLineNum = 390;BA.debugLine="Sub forgot_pass_pnl_click";
...
String _url_email = "";
String _nickname = "";
 //BA.debugLineNum = 310;BA.debugLine="Sub forgot_recover_btn_click";
 //BA.debugLineNum = 311;BA.debugLine="booleanforgotcount = 0";
_booleanforgotcount = (int) (0);
 //BA.debugLineNum = 312;BA.debugLine="nickName_for = \"\"";
mostCurrent._nickname_for = "";
 //BA.debugLineNum = 313;BA.debugLine="email_for = \"\"";
mostCurrent._email_for = "";
 //BA.debugLineNum = 314;BA.debugLine="If email_forgot.Text == \"\" Or nickN_forgot.Text =";
if ((mostCurrent._email_forgot.getText()).equals("") || (mostCurrent._nickn_forgot.getText()).equals("") || (mostCurrent._newpass.getText()).equals("") || (mostCurrent._renewpass.getText()).equals("")) { 
 //BA.debugLineNum = 315;BA.debugLine="Msgbox(\"Error: Empty fields. Needed to fill all";
anywheresoftware.b4a.keywords.Common.Msgbox("Error: Empty fields. Needed to fill all required fields to recover your account!","C O N F I R M A T I O N",mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 317;BA.debugLine="If newPass.Text.Length <= 5 Then";
if (mostCurrent._newpass.getText().length()<=5) { 
 //BA.debugLineNum = 318;BA.debugLine="Msgbox(\"Error: Password lenght must be 6 letter";
anywheresoftware.b4a.keywords.Common.Msgbox("Error: Password lenght must be 6 letter and above!","C O N F I R M A T I O N",mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 320;BA.debugLine="Msgbox(\"Error: Password did not match!\",\"C O N F";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogShow2(mostCurrent.activityBA,"please wait.!!",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 323;BA.debugLine="log_click = False";
_log_click = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 324;BA.debugLine="Dim url_back As calculations";
_url_back = new b4a.example.calculations();
 //BA.debugLineNum = 325;BA.debugLine="Dim url_email,nickname As String";
_url_email = "";
_nickname = "";
 //BA.debugLineNum = 326;BA.debugLine="url_back.Initialize";
_url_back._initialize(processBA);
 //BA.debugLineNum = 327;BA.debugLine="url_email = url_back.php_email_url(\"/bloodlifeP";
_url_email = _url_back._php_email_url("/bloodlifePHP/index.php");
 //BA.debugLineNum = 328;BA.debugLine="nickname = url_back.php_email_url(\"/bloodlifePH";
_nickname = _url_back._php_email_url("/bloodlifePHP/search_blood_nickN.php");
 //BA.debugLineNum = 329;BA.debugLine="forgot_email_job.Download2(url_email,Array As S";
mostCurrent._forgot_email_job._download2(_url_email,new String[]{"email","SELECT email FROM `bloodlife_db`.`person_info` where `email`='"+mostCurrent._email_forgot.getText()+"';"});
 //BA.debugLineNum = 330;BA.debugLine="forgot_nick_job.Download2(nickname,Array As Str";
...
String _forgot_string = "";
 //BA.debugLineNum = 102;BA.debugLine="Public Sub JobDone(job As HttpJob)";
 //BA.debugLineNum = 103;BA.debugLine="If job.Success Then";
if (_job._success) { 
 //BA.debugLineNum = 104;BA.debugLine="Select job.JobName";
...
anywheresoftware.b4a.keywords.Common.Log(_job._getstring());
 //BA.debugLineNum = 107;BA.debugLine="Email = job.GetString.Trim";
mostCurrent._email = _job._getstring().trim();
 break; }
case 1: {
 //BA.debugLineNum = 109;BA.debugLine="Log(job.GetString)";
anywheresoftware.b4a.keywords.Common.Log(_job._getstring());
 //BA.debugLineNum = 110;BA.debugLine="pass = job.GetString.Trim";
mostCurrent._pass = _job._getstring().trim();
 break; }
case 2: {
 //BA.debugLineNum = 112;BA.debugLine="Log(job.GetString)";
anywheresoftware.b4a.keywords.Common.Log(_job._getstring());
 //BA.debugLineNum = 113;BA.debugLine="name_query = job.GetString.Trim";
_name_query = _job._getstring().trim();
 //BA.debugLineNum = 114;BA.debugLine="name = job.GetString.Trim";
mostCurrent._name = _job._getstring().trim();
 break; }
case 3: {
 //BA.debugLineNum = 116;BA.debugLine="Log(job.GetString)";
anywheresoftware.b4a.keywords.Common.Log(_job._getstring());
 //BA.debugLineNum = 117;BA.debugLine="id_query = job.GetString.Trim";
_id_query = _job._getstring().trim();
 break; }
case 4: {
 //BA.debugLineNum = 120;BA.debugLine="Log(job.GetString)";
anywheresoftware.b4a.keywords.Common.Log(_job._getstring());
 //BA.debugLineNum = 122;BA.debugLine="calcs.name = job.GetString.Trim";
mostCurrent._calcs._name = _job._getstring().trim();
 break; }
case 5: {
 //BA.debugLineNum = 124;BA.debugLine="email_for = job.GetString.Trim";
mostCurrent._email_for = _job._getstring().trim();
 break; }
case 6: {
 //BA.debugLineNum = 126;BA.debugLine="nickName_for = job.GetString.Trim";
mostCurrent._nickname_for = _job._getstring().trim();
 break; }
}
;
 //BA.debugLineNum = 129;BA.debugLine="booleanforgotcount = booleanforgotcount + 1";
_booleanforgotcount = (int) (_booleanforgotcount+1);
 //BA.debugLineNum = 130;BA.debugLine="booleanCount = booleanCount+1";
_booleancount = (int) (_booleancount+1);
 //BA.debugLineNum = 132;BA.debugLine="If log_click == True Then";
if (_log_click==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 133;BA.debugLine="If booleanCount = 4 Then '''''''' 1st statement";
if (_booleancount==4) { 
 //BA.debugLineNum = 134;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 135;BA.debugLine="If text_email.Text == \"\" Or text_password.Text";
if ((mostCurrent._text_email.getText()).equals("") || (mostCurrent._text_password.getText()).equals("")) { 
 //BA.debugLineNum = 136;BA.debugLine="Msgbox(\"Error empty field.!\",\"C O N F I R M";
anywheresoftware.b4a.keywords.Common.Msgbox("Error empty field.!","C O N F I R M A T I O N",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 138;BA.debugLine="If text_email.Text.CompareTo(Email) == 0 And t";
if (mostCurrent._text_email.getText().compareTo(mostCurrent._email)==0 && mostCurrent._text_password.getText().compareTo(mostCurrent._pass)==0) { 
 //BA.debugLineNum = 142;BA.debugLine="Dim dialogR As Int";
_dialogr = 0;
 //BA.debugLineNum = 143;BA.debugLine="dialogR = Msgbox2(\"Welcome \"&name,\"C O N F I";
_dialogr = anywheresoftware.b4a.keywords.Common.Msgbox2("Welcome "+mostCurrent._name,"C O N F I R M A T I O N","OK","","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA);
 //BA.debugLineNum = 144;BA.debugLine="booleanCount = 0";
_booleancount = (int) (0);
 //BA.debugLineNum = 145;BA.debugLine="If  dialogR == DialogResponse.POSITIVE Then";
if (_dialogr==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 146;BA.debugLine="text_password.Text = \"\"";
mostCurrent._text_password.setText((Object)(""));
 //BA.debugLineNum = 147;BA.debugLine="text_email.text = \"\"";
mostCurrent._text_email.setText((Object)(""));
 //BA.debugLineNum = 148;BA.debugLine="is_log_in = True";
_is_log_in = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 149;BA.debugLine="StartActivity(\"menu_form\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("menu_form"));
 }else {
 };
 }else {
 //BA.debugLineNum = 153;BA.debugLine="Msgbox(\"Error email address or password.!\",\"";
anywheresoftware.b4a.keywords.Common.Msgbox("Error email address or password.!","C O N F I R M A T I O N",mostCurrent.activityBA);
 //BA.debugLineNum = 154;BA.debugLine="text_password.Text = \"\"";
mostCurrent._text_password.setText((Object)(""));
 //BA.debugLineNum = 155;BA.debugLine="booleanCount = 0";
_booleancount = (int) (0);
 };
 };
 }else {
 ...
 //BA.debugLineNum = 164;BA.debugLine="If log_click == False Then";
if (_log_click==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 165;BA.debugLine="If booleanforgotcount == 1 Then";
if (_booleanforgotcount==1) { 
 //BA.debugLineNum = 166;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 167;BA.debugLine="If email_for.CompareTo(email_forgot.Text) == 0";
if (mostCurrent._email_for.compareTo(mostCurrent._email_forgot.getText())==0 && mostCurrent._nickname_for.compareTo(mostCurrent._nickn_forgot.getText())==0) { 
 //BA.debugLineNum = 169;BA.debugLine="Dim url_back As calculations";
_url_back = new b4a.example.calculations();
 //BA.debugLineNum = 170;BA.debugLine="Dim forgot_string As String";
_forgot_string = "";
 //BA.debugLineNum = 171;BA.debugLine="url_back.Initialize";
_url_back._initialize(processBA);
 //BA.debugLineNum = 172;BA.debugLine="forgot_string = url_back.php_email_url(\"/blood";
_forgot_string = _url_back._php_email_url("/bloodlifePHP/forgot_pass.php");
 //BA.debugLineNum = 173;BA.debugLine="forgot_recover_job.Download2(forgot_string,Arr";
mostCurrent._forgot_recover_job._download2(_forgot_string,new String[]{"recover","UPDATE `bloodlife_db`.`person_info` SET `password`=ENCODE('"+mostCurrent._newpass.getText()+"','goroy') WHERE  `email`='"+mostCurrent._email_for+"' and `nick_name`='"+mostCurrent._nickname_for+"';"});
 //BA.debugLineNum = 174;BA.debugLine="ToastMessageShow(\"Successfully Recovered Accou";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("Successfully Recovered Account!",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 175;BA.debugLine="forgot_pass_pnl.RemoveView";
mostCurrent._forgot_pass_pnl.RemoveView();
 }else {
 //BA.debugLineNum = 177;BA.debugLine="Msgbox(\"Error: Information not existed!\",\"C O N";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 184;BA.debugLine="If booleanCount = 4 Then";
if (_booleancount==4) { 
 //BA.debugLineNum = 185;BA.debugLine="Msgbox(\"Error: Error connecting to server, try a";
anywheresoftware.b4a.keywords.Common.Msgbox("Error: Error connecting to server, try again laiter.!","C O N F I R M A T I O N",mostCurrent.activityBA);
 //BA.debugLineNum = 186;BA.debugLine="booleanCount = 0";
_booleancount = (int) (0);
 }else {
 //BA.debugLineNum = 188;BA.debugLine="booleanCount = 4";
_booleancount = (int) (4);
 };
 //BA.debugLineNum = 190;BA.debugLine="If booleanforgotcount = 1 Then";
if (_booleanforgotcount==1) { 
 //BA.debugLineNum = 191;BA.debugLine="Msgbox(\"Error: Error connecting to server, try";
anywheresoftware.b4a.keywords.Common.Msgbox("Error: Error connecting to server, try again laiter.!","C O N F I R M A T I O N",mostCurrent.activityBA);
 //BA.debugLineNum = 192;BA.debugLine="booleanforgotcount = 0";
_booleanforgotcount = (int) (0);
 }else {
 //BA.debugLineNum = 194;BA.debugLine="booleanforgotcount = 1";
...
int[] _colorg = null;
 //BA.debugLineNum = 335;BA.debugLine="Sub label_forgot_Click";
 //BA.debugLineNum = 337;BA.debugLine="Dim pnl As Panel";
_pnl = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 338;BA.debugLine="Dim edit_ok_btn,edit_can_btn As Button";
_edit_ok_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
_edit_can_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 339;BA.debugLine="Dim title_lbl As Label";
_title_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 340;BA.debugLine="title_lbl.Initialize(\"\")";
_title_lbl.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 341;BA.debugLine="edit_ok_btn.Initialize(\"forgot_recover_btn\")";
_edit_ok_btn.Initialize(mostCurrent.activityBA,"forgot_recover_btn");
 //BA.debugLineNum = 342;BA.debugLine="edit_can_btn.Initialize(\"forgot_can_btn\")";
_edit_can_btn.Initialize(mostCurrent.activityBA,"forgot_can_btn");
 //BA.debugLineNum = 343;BA.debugLine="Dim V_btn,C_btn As GradientDrawable";
...
_pnl.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"modal_bg.png").getObject()));
 //BA.debugLineNum = 359;BA.debugLine="title_lbl.Text = \"RECOVERING ACCOUNT\"";
_title_lbl.setText((Object)("RECOVERING ACCOUNT"));
 //BA.debugLineNum = 360;BA.debugLine="title_lbl.Gravity = Gravity.CENTER";
_title_lbl.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 362;BA.debugLine="email_forgot.Initialize(\"\")";
mostCurrent._email_forgot.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 363;BA.debugLine="nickN_forgot.Initialize(\"\")";
mostCurrent._nickn_forgot.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 364;BA.debugLine="newPass.Initialize(\"\")";
mostCurrent._newpass.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 365;BA.debugLine="renewPass.Initialize(\"\")";
mostCurrent._renewpass.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 366;BA.debugLine="email_forgot.Hint = \"Enter your Email Address\"";
mostCurrent._email_forgot.setHint("Enter your Email Address");
 //BA.debugLineNum = 367;BA.debugLine="nickN_forgot.Hint = \"Enter your Nick Name\"";
mostCurrent._nickn_forgot.setHint("Enter your Nick Name");
 //BA.debugLineNum = 368;BA.debugLine="newPass.Hint = \"Enter your New Password\"";
mostCurrent._newpass.setHint("Enter your New Password");
 //BA.debugLineNum = 369;BA.debugLine="renewPass.Hint = \"Retype New Password\"";
mostCurrent._renewpass.setHint("Retype New Password");
 //BA.debugLineNum = 370;BA.debugLine="newPass.PasswordMode = True";
mostCurrent._newpass.setPasswordMode(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 371;BA.debugLine="renewPass.PasswordMode = True";
mostCurrent._renewpass.setPasswordMode(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 372;BA.debugLine="pnl.AddView(title_lbl,2%x,2%y,68%x,8%y)";
_pnl.AddView((android.view.View)(_title_lbl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 373;BA.debugLine="pnl.AddView(email_forgot,2%x,title_lbl.Top + titl";
_pnl.AddView((android.view.View)(mostCurrent._email_forgot.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),(int) (_title_lbl.getTop()+_title_lbl.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA));
 //BA.debugLineNum = 374;BA.debugLine="pnl.AddView(nickN_forgot,2%x,email_forgot.Top + e";
_pnl.AddView((android.view.View)(mostCurrent._nickn_forgot.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),(int) (mostCurrent._email_forgot.getTop()+mostCurrent._email_forgot.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA));
 //BA.debugLineNum = 375;BA.debugLine="pnl.AddView(newPass,2%x,nickN_forgot.Top + nickN_";
_pnl.AddView((android.view.View)(mostCurrent._newpass.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),(int) (mostCurrent._nickn_forgot.getTop()+mostCurrent._nickn_forgot.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA));
 //BA.debugLineNum = 376;BA.debugLine="pnl.AddView(renewPass,2%x,newPass.Top + newPass.H";
_pnl.AddView((android.view.View)(mostCurrent._renewpass.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA),(int) (mostCurrent._newpass.getTop()+mostCurrent._newpass.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (68),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (7),mostCurrent.activityBA));
 //BA.debugLineNum = 378;BA.debugLine="pnl.AddView(edit_ok_btn,8%x,renewPass.Top+renewPa";
_pnl.AddView((android.view.View)(_edit_ok_btn.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (8),mostCurrent.activityBA),(int) (mostCurrent._renewpass.getTop()+mostCurrent._renewpass.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (28),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 379;BA.debugLine="pnl.AddView(edit_can_btn,edit_ok_btn.Left+edit_ok";
_pnl.AddView((android.view.View)(_edit_can_btn.getObject()),(int) (_edit_ok_btn.getLeft()+_edit_ok_btn.getWidth()+anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (2),mostCurrent.activityBA)),(int) (mostCurrent._renewpass.getTop()+mostCurrent._renewpass.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (28),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 381;BA.debugLine="forgot_pass_pnl.AddView(pnl,13%x,(((Activity.Heig";
mostCurrent._forgot_pass_pnl.AddView((android.view.View)(_pnl.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (13),mostCurrent.activityBA),(int) ((((mostCurrent._activity.getHeight()/(double)2)/(double)2)/(double)2)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (74),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (58),mostCurrent.activityBA));
 //BA.debugLineNum = 382;BA.debugLine="forgot_pass_pnl.BringToFront";
mostCurrent._forgot_pass_pnl.BringToFront();
 //BA.debugLineNum = 385;BA.debugLine="Activity.AddView(forgot_pass_pnl,0,0,100%x,100%y)";
...
String _id = "";
String _nickname = "";
 //BA.debugLineNum = 199;BA.debugLine="Sub log_in_button_click";
 //BA.debugLineNum = 200;BA.debugLine="ProgressDialogShow2(\"please wait.!!\",False)";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow2(mostCurrent.activityBA,"please wait.!!",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 201;BA.debugLine="Email = \"\"";
mostCurrent._email = "";
 //BA.debugLineNum = 202;BA.debugLine="pass = \"\"";
mostCurrent._pass = "";
 //BA.debugLineNum = 203;BA.debugLine="log_click = True";
_log_click = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 204;BA.debugLine="booleanCount = 0";
_booleancount = (int) (0);
 //BA.debugLineNum = 205;BA.debugLine="Dim url_back As calculations";
_url_back = new b4a.example.calculations();
 //BA.debugLineNum = 206;BA.debugLine="Dim url_email,url_pass,full_name,id,nickname As S";
_url_email = "";
_url_pass = "";
_full_name = "";
_id = "";
_nickname = "";
 //BA.debugLineNum = 207;BA.debugLine="url_back.Initialize";
_url_back._initialize(processBA);
 //BA.debugLineNum = 208;BA.debugLine="url_email = url_back.php_email_url(\"/bloodlifePHP";
_url_email = _url_back._php_email_url("/bloodlifePHP/index.php");
 //BA.debugLineNum = 209;BA.debugLine="url_pass = url_back.php_email_url(\"/bloodlifePHP/";
_url_pass = _url_back._php_email_url("/bloodlifePHP/index1.php");
 //BA.debugLineNum = 210;BA.debugLine="full_name = url_back.php_email_url(\"/bloodlifePHP";
_full_name = _url_back._php_email_url("/bloodlifePHP/search_blood_fullN.php");
 //BA.debugLineNum = 211;BA.debugLine="id = url_back.php_email_url(\"/bloodlifePHP/search";
_id = _url_back._php_email_url("/bloodlifePHP/search_blood_id.php");
 //BA.debugLineNum = 212;BA.debugLine="nickname = url_back.php_email_url(\"/bloodlifePHP/";
_nickname = _url_back._php_email_url("/bloodlifePHP/search_blood_nickN.php");
 //BA.debugLineNum = 214;BA.debugLine="h_fullname.Download2(full_name,Array As String(\"f";
mostCurrent._h_fullname._download2(_full_name,new String[]{"full_name","SELECT full_name FROM `bloodlife_db`.`person_info` where `email`='"+mostCurrent._text_email.getText()+"';"});
 //BA.debugLineNum = 215;BA.debugLine="user_id.Download2(id,Array As String(\"id\",\"SELECT";
mostCurrent._user_id._download2(_id,new String[]{"id","SELECT id FROM `bloodlife_db`.`person_info` where `email`='"+mostCurrent._text_email.getText()+"';"});
 //BA.debugLineNum = 216;BA.debugLine="nick_name.Download2(nickname,Array As String(\"nic";
mostCurrent._nick_name._download2(_nickname,new String[]{"nick","SELECT nick_name FROM `bloodlife_db`.`person_info` where `email`='"+mostCurrent._text_email.getText()+"';"});
 //BA.debugLineNum = 218;BA.debugLine="h_email.Download2(url_email,Array As String(\"emai";
mostCurrent._h_email._download2(_url_email,new String[]{"email","SELECT email FROM `bloodlife_db`.`person_info` where `email`='"+mostCurrent._text_email.getText()+"';"});
 //BA.debugLineNum = 219;BA.debugLine="h_pass.Download2(url_pass,Array As String(\"pass\",";
...
public static String  _new_acc_button_click() throws Exception{
 //BA.debugLineNum = 307;BA.debugLine="Sub new_acc_button_Click";
 //BA.debugLineNum = 308;BA.debugLine="StartActivity (\"create_account\")";
